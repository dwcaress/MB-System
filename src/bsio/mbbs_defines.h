...
#define BS_MSCNAVEDIT                                                                                                            \
	(0x4)                     /* navigation edits via                                                                            \
                 mosaic GUI */
...
#define PNG_XYZ                                                                                                                  \
	(0x1)             /* bathymetry is x/y/z instead                                                                             \
	         of x/z only */
#define PNG_ABI (0x2) /* auxiliary beam info present */
#define PNG_BTYSSFLAGSABSENT                                                                                                     \
	(0x4)                     /* indicates that input file does                                                                  \
...
#define PNG_MSCHIDE                                                                                                              \
	(0x20) /* ping should not be displayed                                                                                       \
  in a mosaic */
...
#define PNG_BYTEALIGNSZ                                                                                                          \
	(8) /* byte alignment constraint for                                                                                         \
