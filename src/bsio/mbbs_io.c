...
int mbbs_rdbsfhdr(BSFile *bsf, XDR *xdrs)
/*
...
int mbbs_wrbsfhdr(BSFile *bsf, XDR *xdrs)
/*
   User-callable routine.
...
int mbbs_freebsfmem(BSFile *bsf) {
	if (bsf == (BSFile *)0)
		return BS_BADARG;
...
int mbbs_rdpnghdr(Ping *png, XDR *xdrs, int version)
/*
   User-callable routine.
...
int mbbs_wrpnghdr(Ping *png, XDR *xdrs)
/*
   User-callable routine.
...
int mbbs_rdpngdata(Ping *png, MemType *data, XDR *xdrs)
/*
   User-callable routine.
...
int mbbs_wrpngdata(Ping *png, MemType *data, XDR *xdrs)
/*
   User-callable routine.
...
int mbbs_rdpngpddata(Ping *png, PingData *pddata, XDR *xdrs)
/*
   User-callable routine.
...
int mbbs_wrpngpddata(Ping *png, PingData *pddata, XDR *xdrs)
/*
   User-callable routine.
   Writes sample data to the XDR stream pointed to by xdrs.
   Returns BS_SUCCESS or BS_WRITE.
...
int mbbs_rdpng(Ping *png, MemType **data, XDR *xdrs, int version)
/*
   User-callable routine.
...
int mbbs_wrpng(Ping *png, MemType *data, XDR *xdrs)
/*
   User-callable routine.
...
int mbbs_seekpng(int count, XDR *xdrs, int version)
/*
   User-callable routine.
...
*/
{
	...
	for (i = 0; i < count; i++) {
		...
		/* sensor data */
		n = png.png_compass.sns_nsamps + png.png_depth.sns_nsamps + png.png_pitch.sns_nsamps + png.png_roll.sns_nsamps;
		for (j = 0; j < n; j++) {
			if (!xdr_float(xdrs, &f))
				return BS_READ;
			bs_iobytecnt += 4;
...
int mbbs_seekpngdata(Ping *png, XDR *xdrs)
/*
   User-callable routine.
...
int mbbs_copypng(int count, XDR *xdris, XDR *xdros, int version)
/*
   User-callable routine.
...
int mbbs_xdrbsfhdr(BSFile *bsf, XDR *xdrs)
/*
   Internal routine.
...
*/
{
	...
	if (xdrs->x_op == XDR_ENCODE) {
		if (((long)png->png_tm.tv_sec < INT32_MIN) || ((long)png->png_tm.tv_sec > INT32_MAX))
			return 0;
		...
		if ((sizeof png->png_tm.tv_usec > 4) &&
		    (((long)png->png_tm.tv_usec < INT32_MIN) || ((long)png->png_tm.tv_usec > INT32_MAX)))
			return 0;
...
int mbbs_xdrside(PingSide *ps, XDR *xdrs, int version, unsigned long *bytecnt)
/*
   Internal routine.
...
int mbbs_xdrpngdata(Ping *png, MemType *data, XDR *xdrs)
/*
   Internal routine.
*/
{
...
int mbbs_xdrpngpddata(Ping *png, PingData *pddata, XDR *xdrs)
/*
   Internal routine.
*/
{
...
int mbbs_xdrstring(XDR *xdrs, char **cpp, unsigned long *bytecnt)
/*
   User-callable routine.
