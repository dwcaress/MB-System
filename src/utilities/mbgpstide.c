 ...
 *    $Id: mbgpstide.c 2331 2018-04-10 17:49:20Z caress $
 *
 *    Copyright (c) 2018
...
int main(int argc, char **argv) {
	static char rcs_id[] = "$Id: mbgpstide.c 2331 2018-04-10 17:49:20Z caress $";
	static char program_name[] = "mbgpstide";
	static char help_message[] =
	    "MBgpstide generates tide files from the GPS altitude data in the input files.";
	static char usage_message[] =
	    "mbgpstide [-Atideformat -Dinterval -Fformat -Idatalist -M -Ooutput -Roffset -S -Tgeoid -Usource -V]";
	extern char *optarg;
	int option_index;
	int errflg = 0;
	int c;
