/*--------------------------------------------------------------------
 *    The MB-system:	mbmerge.c	3.00	2/20/93
 *
 *    $Id: mbmerge.c,v 3.1 1993-06-01 21:26:40 caress Exp $
 *
 *    Copyright (c) 1993 by 
...
{
	/* id variables */
	static char rcs_id[] = "$Id: mbmerge.c,v 3.1 1993-06-01 21:26:40 caress Exp $";
