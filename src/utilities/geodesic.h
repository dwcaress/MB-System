...
struct geod_geodesicline {
	...
	double f;    /**< the flattening */
	/**< @cond SKIP */
	double b, c2, f1, salp0, calp0, k2, salp1, calp1, ssig1, csig1, dn1, stau1, ctau1, somg1, comg1, A1m1, A2m1, A3c, B11, B21,
	    B31, A4, B41;
 ...
 * direct problem).
 **********************************************************************/
void geod_lineinit(struct geod_geodesicline *l, const struct geod_geodesic *g, double lat1, double lon1, double azi1,
                   unsigned caps);
 ...
 * Example, determine the point 10000 km NE of JFK:
 ...
 @endcode
 **********************************************************************/
void geod_direct(const struct geod_geodesic *g, double lat1, double lon1, double azi1, double s12, double *plat2, double *plon2,
                 double *pazi2);
 ...
 * Example, determine the distance between JFK and Singapore Changi Airport:
 ...
 @endcode
 **********************************************************************/
void geod_inverse(const struct geod_geodesic *g, double lat1, double lon1, double lat2, double lon2, double *ps12, double *pazi1,
                  double *pazi2);
 ...
 **********************************************************************/
double geod_geninverse(const struct geod_geodesic *g, double lat1, double lon1, double lat2, double lon2, double *ps12,
                       double *pazi1, double *pazi2, double *pm12, double *pM12, double *pM21, double *pS12);
