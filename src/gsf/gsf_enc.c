...
static int      EncodeResonTSeriesImagerySpecific(unsigned char *sptr, gsfSensorImagery *sdata);
...
static int
EncodeResonTSeriesImagerySpecific(unsigned char *sptr, gsfSensorImagery *sdata)
{
    unsigned char  *p = sptr;
    gsfuShort       stemp;
