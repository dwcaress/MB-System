...
void write_html(const Bathymetry& bathymetry, const Geometry& geometry, const Options& options,
  ...
  html_file << "    <link rel='stylesheet' type='text/css' href=' https://cdn.jsdelivr.net/gh/x3dom/x3dom-dev/dist/x3dom.css'></link>\n";
  html_file << "    <script type='text/javascript' src='https://cdn.jsdelivr.net/gh/x3dom/x3dom-dev/dist/x3dom-full.js'></script>\n";
  html_file << "    <style>\n";
