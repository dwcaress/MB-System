...
private: // methods
  ...
  static void get_variable_double_array(int netcdf_id, const char* name, double* out,
                                        size_t length);
  static void get_variable_float_array(int netcdf_id, const char* name, float* out, size_t* start,
                                       size_t* length);
