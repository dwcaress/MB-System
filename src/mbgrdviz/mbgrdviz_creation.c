/*--------------------------------------------------------------------
 *    The MB-system:	mbgrdviz_creation.c	          10/9/2002
 *
...
Widget CreatemainWindow_mbgrdviz(Widget parent) {
	...
	ac++;
	mainWindow_mbgrdviz = XmCreateMainWindow(parent, (char *)"mainWindow_mbgrdviz", args, ac);
	...
	XtSetArg(args[ac], XmNwidth, 260);
	ac++;
	XtSetArg(args[ac], XmNheight, 181);
	ac++;
	bulletinBoard_mbgrdviz = XmCreateBulletinBoard(mainWindow_mbgrdviz, (char *)"bulletinBoard_mbgrdviz", args, ac);
	...
	ac++;
	menuBar_mbgrdviz = XmCreateMenuBar(mainWindow_mbgrdviz, (char *)"menuBar_mbgrdviz", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(menuBar_mbgrdviz, (char *)"File", XmRXmString, 0, &argok);
		...
		XtSetArg(
		    args[ac], XmNfontList,
		    BX_CONVERT(menuBar_mbgrdviz, (char *)"-*-" SANS "-bold-r-*-*-*-140-75-75-*-*-iso8859-1", XmRFontList, 0, &argok));
		if (argok)
			ac++;
		cascadeButton_file = XmCreateCascadeButton(menuBar_mbgrdviz, (char *)"cascadeButton_file", args, ac);
	...
	ac = 0;
	XtSetArg(args[ac], XmNx, 113);
	ac++;
	XtSetArg(args[ac], XmNy, 292);
	ac++;
	XtSetArg(args[ac], XmNwidth, 142);
	ac++;
	XtSetArg(args[ac], XmNheight, 224);
	ac++;
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(pulldownMenu_file, (char *)"Open Primary Grid", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(
		...
		if (argok)
			ac++;
		pushButton_file_openprimary = XmCreatePushButton(pulldownMenu_file, (char *)"pushButton_file_openprimary", args, ac);
	...
	ac = 0;
	separator = XmCreateSeparator(pulldownMenu_file, (char *)"separator", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(pulldownMenu_file, (char *)"Open Site", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(
		...
		if (argok)
			ac++;
		pushButton_opensite = XmCreatePushButton(pulldownMenu_file, (char *)"pushButton_opensite", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(pulldownMenu_file, (char *)"Open Route", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(
		...
		if (argok)
			ac++;
		pushButton_openroute = XmCreatePushButton(pulldownMenu_file, (char *)"pushButton_openroute", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(pulldownMenu_file, (char *)"Open Navigation", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(
		...
		if (argok)
			ac++;
		pushButton_opennav = XmCreatePushButton(pulldownMenu_file, (char *)"pushButton_opennav", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(pulldownMenu_file, (char *)"Open Swath", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(
		...
		if (argok)
			ac++;
		pushButton_openswath = XmCreatePushButton(pulldownMenu_file, (char *)"pushButton_openswath", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(pulldownMenu_file, (char *)"Open Vector", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(
		...
		if (argok)
			ac++;
		pushButton_openvector = XmCreatePushButton(pulldownMenu_file, (char *)"pushButton_openvector", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(pulldownMenu_file, (char *)"Save Site", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(
		...
		if (argok)
			ac++;
		pushButton_savesite = XmCreatePushButton(pulldownMenu_file, (char *)"pushButton_savesite", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(pulldownMenu_file, (char *)"Save Route", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(
		...
		if (argok)
			ac++;
		pushButton_saveroute = XmCreatePushButton(pulldownMenu_file, (char *)"pushButton_saveroute", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(menuBar_mbgrdviz, (char *)"Help", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNx, 208);
		ac++;
		XtSetArg(args[ac], XmNy, 5);
		ac++;
		XtSetArg(args[ac], XmNwidth, 47);
		ac++;
		XtSetArg(args[ac], XmNheight, 24);
		ac++;
		XtSetArg(
		...
		if (argok)
			ac++;
		cascadeButton_help = XmCreateCascadeButton(menuBar_mbgrdviz, (char *)"cascadeButton_help", args, ac);
	...
	ac++;
	pulldownMenu_help = XmCreatePulldownMenu(XtParent(cascadeButton_help), (char *)"pulldownMenu_help", args, ac);

	ac = 0;
	{
		XmString tmp0;

		tmp0 = (XmString)BX_CONVERT(pulldownMenu_help, (char *)"About", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(
		    args[ac], XmNfontList,
		    BX_CONVERT(pulldownMenu_help, (char *)"-*-" SANS "-bold-r-*-*-*-140-75-75-*-*-iso8859-1", XmRFontList, 0, &argok));
		if (argok)
			ac++;
		pushButton_help_about = XmCreatePushButton(pulldownMenu_help, (char *)"pushButton_help_about", args, ac);
	...
	ac = 0;
	XtSetArg(args[ac], XmNsubMenuId, pulldownMenu_help);
	ac++;
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(menuBar_mbgrdviz, (char *)"Realtime", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNsensitive, False);
		ac++;
		XtSetArg(args[ac], XmNx, 46);
		ac++;
		XtSetArg(args[ac], XmNy, 5);
		ac++;
		...
		if (argok)
			ac++;
		cascadeButton_realtime = XmCreateCascadeButton(menuBar_mbgrdviz, (char *)"cascadeButton_realtime", args, ac);
	...
	XtSetArg(args[ac], XmNy, 0);
	ac++;
	XtSetArg(args[ac], XmNwidth, 68);
	ac++;
	XtSetArg(args[ac], XmNheight, 124);
	ac++;
	pulldownMenu_realtime = XmCreatePulldownMenu(XtParent(cascadeButton_realtime), (char *)"pulldownMenu_realtime", args, ac);

	ac = 0;
	{
		XmString tmp0;

		tmp0 = (XmString)BX_CONVERT(pulldownMenu_realtime, (char *)"Setup", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNsensitive, False);
		...
		XtSetArg(args[ac], XmNfontList,
		         BX_CONVERT(pulldownMenu_realtime, (char *)"-*-" SANS "-bold-r-*-*-*-140-75-75-*-*-iso8859-1", XmRFontList, 0,
		                    &argok));
		if (argok)
			ac++;
		pushButton_realtime_setup = XmCreatePushButton(pulldownMenu_realtime, (char *)"pushButton_realtime_setup", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(pulldownMenu_realtime, (char *)"Start", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNsensitive, False);
		...
		if (argok)
			ac++;
		pushButton_realtime_start = XmCreatePushButton(pulldownMenu_realtime, (char *)"pushButton_realtime_start", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(pulldownMenu_realtime, (char *)"Stop", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNsensitive, False);
		...
		if (argok)
			ac++;
		pushButton_realtime_stop = XmCreatePushButton(pulldownMenu_realtime, (char *)"pushButton_realtime_stop", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(pulldownMenu_realtime, (char *)"Pause", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNsensitive, False);
		...
		if (argok)
			ac++;
		pushButton_realtime_pause = XmCreatePushButton(pulldownMenu_realtime, (char *)"pushButton_realtime_pause", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(pulldownMenu_realtime, (char *)"Resume", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNsensitive, False);
		...
		if (argok)
			ac++;
		pushButton_realtime_resume = XmCreatePushButton(pulldownMenu_realtime, (char *)"pushButton_realtime_resume", args, ac);
	...
	ac = 0;
	XtSetArg(args[ac], XmNsubMenuId, pulldownMenu_realtime);
	ac++;
	XtSetValues(cascadeButton_realtime, args, ac);

	ac = 0;
	XtSetArg(args[ac], XmNtitle, "About MBgrdviz...");
	ac++;
	...
	ac++;
	dialogShell_about = XmCreateDialogShell(mainWindow_mbgrdviz, (char *)"dialogShell_about", args, ac);
	...
	XtSetArg(args[ac], XmNheight, 531);
	ac++;
	bulletinBoard_about = XtCreateWidget((char *)"bulletinBoard_about", xmBulletinBoardWidgetClass, dialogShell_about, args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_about,
		                            (char *)"::#TimesMedium14:t\"MB-System Release 5.0.8\"#TimesMedium14\"February 2, 2006\"",
		                            XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(
		    bulletinBoard_about, (char *)"::#TimesBold14:t\"Created By:\"#TimesBold14\"David W. Caress   and   Dale N. Chayes \"",
		    XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		...
		ac++;
		label_about_authors = XmCreateLabel(bulletinBoard_about, (char *)"label_about_authors", args, ac);
	...
	ac = 0;
	{
		...
		ac++;
		label_about_MBARI = XmCreateLabel(bulletinBoard_about, (char *)"label_about_MBARI", args, ac);
	...
	ac = 0;
	{
		...
		XtSetArg(args[ac], XmNheight, 80);
		ac++;
		label_about_LDEO = XmCreateLabel(bulletinBoard_about, (char *)"label_about_LDEO", args, ac);
	...
	ac++;
	separator3 = XmCreateSeparator(bulletinBoard_about, (char *)"separator3", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(
		    bulletinBoard_about,
		    (char *)"::#TimesBold24\"MBgrdviz\":t\"\"#TimesBold18:t\"Simple 3D Visualization \"#TimesBold18\"of GMT Grids\"",
		    XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		...
		ac++;
		label_about_title = XmCreateLabel(bulletinBoard_about, (char *)"label_about_title", args, ac);
	...
	ac = 0;
	{
		...
		XtSetArg(
		    args[ac], XmNfontList,
		    BX_CONVERT(bulletinBoard_about, (char *)"-*-" SANS "-bold-r-*-*-*-140-75-75-*-*-iso8859-1", XmRFontList, 0, &argok));
		if (argok)
			ac++;
	...
	ac++;
	XtSetArg(args[ac], XmNwidth, 334);
	ac++;
	XtSetArg(args[ac], XmNheight, 505);
	ac++;
	XtSetArg(args[ac], XmNdeleteResponse, XmDO_NOTHING);
	ac++;
	dialogShell_open = XmCreateDialogShell(mainWindow_mbgrdviz, (char *)"dialogShell_open", args, ac);

	ac = 0;
	{
		XmString tmp0;

		tmp0 = (XmString)BX_CONVERT(dialogShell_open, (char *)"*grd", XmRXmString, 0, &argok);
		...
		XtSetArg(args[ac], XmNx, 0);
		ac++;
		XtSetArg(args[ac], XmNy, 1084);
		ac++;
		XtSetArg(args[ac], XmNwidth, 334);
		ac++;
		XtSetArg(args[ac], XmNheight, 505);
		ac++;
		fileSelectionBox = XtCreateWidget((char *)"fileSelectionBox", xmFileSelectionBoxWidgetClass, dialogShell_open, args, ac);
	...
	XtSetArg(args[ac], XmNdeleteResponse, XmDO_NOTHING);
	ac++;
	dialogShell_arearoute = XmCreateDialogShell(mainWindow_mbgrdviz, (char *)"dialogShell_arearoute", args, ac);

	ac = 0;
	{
		XmString tmp0;

		tmp0 = (XmString)BX_CONVERT(dialogShell_arearoute, (char *)"Generate Survey Route for Selected Area...", XmRXmString, 0,
		                            &argok);
		...
		ac++;
		XtSetArg(args[ac], XmNy, 991);
		ac++;
		XtSetArg(args[ac], XmNwidth, 481);
		ac++;
		XtSetArg(args[ac], XmNheight, 691);
		ac++;
		bulletinBoard_arearoute =
		    XtCreateWidget((char *)"bulletinBoard_arearoute", xmBulletinBoardWidgetClass, dialogShell_arearoute, args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_arearoute, (char *)"Interleaving:", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		...
		ac++;
		XtSetArg(args[ac], XmNfontList,
		         BX_CONVERT(bulletinBoard_arearoute, (char *)"-*-" SANS "-bold-r-*-*-*-140-75-75-*-*-iso8859-1", XmRFontList, 0,
		                    &argok));
		if (argok)
			ac++;
		label_arearoute_interleaving = XmCreateLabel(bulletinBoard_arearoute, (char *)"label_arearoute_interleaving", args, ac);
	...
	ac = 0;
	XtSetArg(args[ac], XmNarrowLayout, XmARROWS_END);
	ac++;
	XtSetArg(args[ac], XmNlayoutDirection, XmLEFT_TO_RIGHT);
	ac++;
	XtSetArg(args[ac], XmNx, 10);
	ac++;
	...
	XtSetArg(args[ac], XmNheight, 50);
	ac++;
	spinBox_arearoute_interleaving = XmCreateSpinBox(bulletinBoard_arearoute, (char *)"spinBox_arearoute_interleaving", args, ac);
	...
	ac = 0;
	XtSetArg(args[ac], XmNcursorPositionVisible, False);
	ac++;
	...
	ac++;
	XtSetArg(args[ac], XmNfontList,
	         BX_CONVERT(spinBox_arearoute_interleaving, (char *)"-*-" SANS "-bold-r-*-*-*-140-75-75-*-*-iso8859-1", XmRFontList,
	                    0, &argok));
	if (argok)
		ac++;
	spinText_arearoute_interleaving =
	    XmCreateTextField(spinBox_arearoute_interleaving, (char *)"spinText_arearoute_interleaving", args, ac);
	XtManageChild(spinText_arearoute_interleaving);

	ac = 0;
	XtSetArg(args[ac], XmNx, 10);
	ac++;
	XtSetArg(args[ac], XmNy, 590);
	ac++;
	XtSetArg(args[ac], XmNwidth, 200);
	ac++;
	XtSetArg(args[ac], XmNheight, 40);
	...
	XtSetArg(
	    args[ac], XmNfontList,
	    BX_CONVERT(bulletinBoard_arearoute, (char *)"-*-" SANS "-bold-r-*-*-*-140-75-75-*-*-iso8859-1", XmRFontList, 0, &argok));
	if (argok)
		ac++;
	textField_arearoute_name = XmCreateTextField(bulletinBoard_arearoute, (char *)"textField_arearoute_name", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_arearoute, (char *)"Route Name:", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING);
		...
		if (argok)
			ac++;
		label_arearoute_name = XmCreateLabel(bulletinBoard_arearoute, (char *)"label_arearoute_name", args, ac);
	...
	XtSetArg(args[ac], XmNheight, 40);
	ac++;
	spinBox_arearoute_color = XmCreateSpinBox(bulletinBoard_arearoute, (char *)"spinBox_arearoute_color", args, ac);
	...
	XtSetArg(
	    args[ac], XmNfontList,
	    BX_CONVERT(spinBox_arearoute_color, (char *)"-*-" SANS "-bold-r-*-*-*-140-75-75-*-*-iso8859-1", XmRFontList, 0, &argok));
	if (argok)
		ac++;
	spinText_arearoute_color = XmCreateTextField(spinBox_arearoute_color, (char *)"spinText_arearoute_color", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_arearoute, (char *)"Route Color:", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING);
		...
		if (argok)
			ac++;
		label_arearoute_color = XmCreateLabel(bulletinBoard_arearoute, (char *)"label_arearoute_color", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_arearoute, (char *)"Cross Lines:", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING);
		...
		if (argok)
			ac++;
		label_arearoute_crosslines = XmCreateLabel(bulletinBoard_arearoute, (char *)"label_arearoute_crosslines", args, ac);
	...
	XtSetArg(args[ac], XmNheight, 40);
	ac++;
	spinBox_arearoute_crosslines = XmCreateSpinBox(bulletinBoard_arearoute, (char *)"spinBox_arearoute_crosslines", args, ac);
	...
	ac++;
	XtSetArg(args[ac], XmNfontList,
	         BX_CONVERT(spinBox_arearoute_crosslines, (char *)"-*-" SANS "-bold-r-*-*-*-140-75-75-*-*-iso8859-1", XmRFontList, 0,
	                    &argok));
	if (argok)
		ac++;
	spinText_arearoute_crosslines =
	    XmCreateTextField(spinBox_arearoute_crosslines, (char *)"spinText_arearoute_crosslines", args, ac);
	XtManageChild(spinText_arearoute_crosslines);
	XtAddCallback(spinText_arearoute_crosslines, XmNvalueChangedCallback, do_mbgrdviz_arearoute_linespacing_increment,
	              (XtPointer)0);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_arearoute, (char *)"Sonar Depth (m):", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING);
		...
		if (argok)
			ac++;
		label_arearoute_depth = XmCreateLabel(bulletinBoard_arearoute, (char *)"label_arearoute_depth", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_arearoute, (char *)"Sonar Altitude (m):", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING);
		...
		if (argok)
			ac++;
		label_arearoute_altitude = XmCreateLabel(bulletinBoard_arearoute, (char *)"label_arearoute_altitude", args, ac);
	...
	XtSetArg(args[ac], XmNheight, 50);
	ac++;
	spinBox_arearoute_altitude = XmCreateSpinBox(bulletinBoard_arearoute, (char *)"spinBox_arearoute_altitude", args, ac);
	...
	ac++;
	XtSetArg(args[ac], XmNfontList,
	         BX_CONVERT(spinBox_arearoute_altitude, (char *)"-*-" SANS "-bold-r-*-*-*-140-75-75-*-*-iso8859-1", XmRFontList, 0,
	                    &argok));
	if (argok)
		ac++;
	spinText_arearoute_altitude = XmCreateTextField(spinBox_arearoute_altitude, (char *)"spinText_arearoute_altitude", args, ac);
	...
	XtSetArg(args[ac], XmNheight, 50);
	ac++;
	spinBox_arearoute_depth = XmCreateSpinBox(bulletinBoard_arearoute, (char *)"spinBox_arearoute_depth", args, ac);
	...
	XtSetArg(
	    args[ac], XmNfontList,
	    BX_CONVERT(spinBox_arearoute_depth, (char *)"-*-" SANS "-bold-r-*-*-*-140-75-75-*-*-iso8859-1", XmRFontList, 0, &argok));
	if (argok)
		ac++;
	spinText_arearoute_depth = XmCreateTextField(spinBox_arearoute_depth, (char *)"spinText_arearoute_depth", args, ac);
	...
	XtSetArg(args[ac], XmNheight, 40);
	ac++;
	spinBox_arearoute_direction = XmCreateSpinBox(bulletinBoard_arearoute, (char *)"spinBox_arearoute_direction", args, ac);
	...
	ac++;
	XtSetArg(args[ac], XmNfontList,
	         BX_CONVERT(spinBox_arearoute_direction, (char *)"-*-" SANS "-bold-r-*-*-*-140-75-75-*-*-iso8859-1", XmRFontList, 0,
	                    &argok));
	if (argok)
		ac++;
	spinText_arearoute_direction =
	    XmCreateTextField(spinBox_arearoute_direction, (char *)"spinText_arearoute_direction", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_arearoute, (char *)"Start Corner:", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING);
		...
		if (argok)
			ac++;
		label_arearoute_direction = XmCreateLabel(bulletinBoard_arearoute, (char *)"label_arearoute_direction", args, ac);
	...
	XtSetArg(args[ac], XmNheight, 50);
	ac++;
	spinBox_arearoute_swathwidth = XmCreateSpinBox(bulletinBoard_arearoute, (char *)"spinBox_arearoute_swathwidth", args, ac);
	...
	ac++;
	XtSetArg(args[ac], XmNfontList,
	         BX_CONVERT(spinBox_arearoute_swathwidth, (char *)"-*-" SANS "-bold-r-*-*-*-140-75-75-*-*-iso8859-1", XmRFontList, 0,
	                    &argok));
	if (argok)
		ac++;
	spinText_arearoute_swathwidth =
	    XmCreateTextField(spinBox_arearoute_swathwidth, (char *)"spinText_arearoute_swathwidth", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_arearoute, (char *)"Swath Width (degrees):", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING);
		ac++;
		XtSetArg(args[ac], XmNmappedWhenManaged, True);
		ac++;
		XtSetArg(args[ac], XmNx, 240);
		ac++;
		XtSetArg(args[ac], XmNy, 320);
		...
		if (argok)
			ac++;
		label_arearoute_swathwidth = XmCreateLabel(bulletinBoard_arearoute, (char *)"label_arearoute_swathwidth", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_arearoute, (char *)"Platform Type:", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING);
		...
		if (argok)
			ac++;
		label_arearoute_platform = XmCreateLabel(bulletinBoard_arearoute, (char *)"label_arearoute_platform", args, ac);
	...
	XtSetArg(args[ac], XmNheight, 50);
	ac++;
	spinBox_arearoute_platform = XmCreateSpinBox(bulletinBoard_arearoute, (char *)"spinBox_arearoute_platform", args, ac);
	...
	ac++;
	XtSetArg(args[ac], XmNfontList,
	         BX_CONVERT(spinBox_arearoute_platform, (char *)"-*-" SANS "-bold-r-*-*-*-140-75-75-*-*-iso8859-1", XmRFontList, 0,
	                    &argok));
	if (argok)
		ac++;
	spinText_arearoute_platform = XmCreateTextField(spinBox_arearoute_platform, (char *)"spinText_arearoute_platform", args, ac);
	...
	XtSetArg(args[ac], XmNheight, 50);
	ac++;
	spinBox_arearoute_linespacing = XmCreateSpinBox(bulletinBoard_arearoute, (char *)"spinBox_arearoute_linespacing", args, ac);
	...
	ac++;
	XtSetArg(args[ac], XmNfontList,
	         BX_CONVERT(spinBox_arearoute_linespacing, (char *)"-*-" SANS "-bold-r-*-*-*-140-75-75-*-*-iso8859-1", XmRFontList, 0,
	                    &argok));
	if (argok)
		ac++;
	spinText_arearoute_linespacing =
	    XmCreateTextField(spinBox_arearoute_linespacing, (char *)"spinText_arearoute_linespacing", args, ac);
	XtManageChild(spinText_arearoute_linespacing);
	XtAddCallback(spinText_arearoute_linespacing, XmNvalueChangedCallback, do_mbgrdviz_arearoute_linespacing_increment,
	              (XtPointer)0);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_arearoute, (char *)"Crosslines Before/After Survey:", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING);
		...
		if (argok)
			ac++;
		label_arearoute_crosslinesfirstlast =
		    XmCreateLabel(bulletinBoard_arearoute, (char *)"label_arearoute_crosslinesfirstlast", args, ac);
	...
	XtSetArg(args[ac], XmNheight, 50);
	ac++;
	spinBox_arearoute_crosslinesfirstlast =
	    XmCreateSpinBox(bulletinBoard_arearoute, (char *)"spinBox_arearoute_crosslinesfirstlast", args, ac);
	XtManageChild(spinBox_arearoute_crosslinesfirstlast);
	XtAddCallback(spinBox_arearoute_crosslinesfirstlast, XmNvalueChangedCallback, do_mbgrdviz_arearoute_parameterchange,
	              (XtPointer)0);
	...
	if (argok)
		ac++;
	spinText_arearoute_crosslinesfirstlast =
	    XmCreateTextField(spinBox_arearoute_crosslinesfirstlast, (char *)"spinText_arearoute_crosslinesfirstlast", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_arearoute, (char *)"Current Area Info:", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		...
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING);
		ac++;
		XtSetArg(args[ac], XmNbackground, BX_CONVERT(bulletinBoard_arearoute, (char *)"White", XmRPixel, 0, &argok));
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNrecomputeSize, False);
		ac++;
		...
		if (argok)
			ac++;
		label_arearoute_info = XmCreateLabel(bulletinBoard_arearoute, (char *)"label_arearoute_info", args, ac);
	...
	XtSetArg(args[ac], XmNheight, 50);
	ac++;
	spinBox_arearoute_linecontrol = XmCreateSpinBox(bulletinBoard_arearoute, (char *)"spinBox_arearoute_linecontrol", args, ac);
	...
	ac++;
	XtSetArg(args[ac], XmNfontList,
	         BX_CONVERT(spinBox_arearoute_linecontrol, (char *)"-*-" SANS "-bold-r-*-*-*-140-75-75-*-*-iso8859-1", XmRFontList, 0,
	                    &argok));
	if (argok)
		ac++;
	spinText_arearoute_linecontrol =
	    XmCreateTextField(spinBox_arearoute_linecontrol, (char *)"spinText_arearoute_linecontrol", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_arearoute, (char *)"Line Spacing Mode:", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING);
		...
		if (argok)
			ac++;
		label_arearoute_linecontrol = XmCreateLabel(bulletinBoard_arearoute, (char *)"label_arearoute_linecontrol", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_arearoute, (char *)"Line Spacing (m):", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING);
		...
		if (argok)
			ac++;
		label_arearoute_linespacing = XmCreateLabel(bulletinBoard_arearoute, (char *)"label_arearoute_linespacing", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_arearoute, (char *)"Generate Route", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNx, 90);
		ac++;
		XtSetArg(args[ac], XmNy, 640);
		ac++;
		XtSetArg(args[ac], XmNwidth, 120);
		ac++;
		XtSetArg(args[ac], XmNheight, 40);
		...
		if (argok)
			ac++;
		pushButton_arearoute_ok = XmCreatePushButton(bulletinBoard_arearoute, (char *)"pushButton_arearoute_ok", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_arearoute, (char *)"Dismiss", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		...
		if (argok)
			ac++;
		pushButton_arearoute_dismiss =
		    XmCreatePushButton(bulletinBoard_arearoute, (char *)"pushButton_arearoute_dismiss", args, ac);
	...
	ac = 0;
	XtSetArg(args[ac], XmNtitle, "Realtime Setup");
	ac++;
	XtSetArg(args[ac], XmNwidth, 497);
	ac++;
	XtSetArg(args[ac], XmNheight, 540);
	ac++;
	XtSetArg(args[ac], XmNdeleteResponse, XmDO_NOTHING);
	ac++;
	dialogShell_realtimesetup = XmCreateDialogShell(mainWindow_mbgrdviz, (char *)"dialogShell_realtimesetup", args, ac);
	...
	XtSetArg(args[ac], XmNresizePolicy, XmRESIZE_GROW);
	ac++;
	XtSetArg(args[ac], XmNx, 1032);
	ac++;
	XtSetArg(args[ac], XmNy, 1067);
	ac++;
	XtSetArg(args[ac], XmNwidth, 497);
	ac++;
	XtSetArg(args[ac], XmNheight, 540);
	ac++;
	form_realtime_setup = XtCreateWidget((char *)"form_realtime_setup", xmFormWidgetClass, dialogShell_realtimesetup, args, ac);
	...
	ac = 0;
	{
		...
		tmp0 =
		    (XmString)BX_CONVERT(form_realtime_setup, (char *)":::t\"Test Status: No realtime data available\"\"Path: Unknown\"",
		                         XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		...
		XtSetArg(
		    args[ac], XmNfontList,
		    BX_CONVERT(form_realtime_setup, (char *)"-*-" SANS "-bold-r-*-*-*-140-75-75-*-*-iso8859-1", XmRFontList, 0, &argok));
		if (argok)
			ac++;
		label_realtimesetup_teststatus = XmCreateLabel(form_realtime_setup, (char *)"label_realtimesetup_teststatus", args, ac);
	...
	ac++;
	XtSetArg(args[ac], XmNy, 92);
	ac++;
	XtSetArg(args[ac], XmNwidth, 237);
	ac++;
	XtSetArg(args[ac], XmNheight, 65);
	ac++;
	XtSetArg(args[ac], XmNisHomogeneous, False);
	ac++;
	radioBox_realtimesetup_pathmode = XmCreateRadioBox(form_realtime_setup, (char *)"radioBox_realtimesetup_pathmode", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(radioBox_realtimesetup_pathmode, (char *)"Most Recent File in Directory", XmRXmString, 0,
		                            &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		...
		if (argok)
			ac++;
		toggleButton_realtimesetup_recent =
		    XmCreateToggleButton(radioBox_realtimesetup_pathmode, (char *)"toggleButton_realtimesetup_recent", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(radioBox_realtimesetup_pathmode, (char *)"Use Pointer File", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING);
		...
		if (argok)
			ac++;
		toggleButton_realtimesetup_pointer =
		    XmCreateToggleButton(radioBox_realtimesetup_pathmode, (char *)"toggleButton_realtimesetup_pointer", args, ac);
	...
	XtSetArg(args[ac], XmNheight, 30);
	ac++;
	toggleButton = XmCreateToggleButton(form_realtime_setup, (char *)"toggleButton", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(form_realtime_setup, (char *)"Dismiss", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNx, 200);
		ac++;
		XtSetArg(args[ac], XmNy, 471);
		ac++;
		XtSetArg(args[ac], XmNwidth, 100);
		ac++;
		...
		if (argok)
			ac++;
		pushButton_realtimesetup_dismiss =
		    XmCreatePushButton(form_realtime_setup, (char *)"pushButton_realtimesetup_dismiss", args, ac);
	...
	XtSetArg(args[ac], XmNx, 10);
	ac++;
	XtSetArg(args[ac], XmNy, 442);
	ac++;
	XtSetArg(args[ac], XmNwidth, 476);
	ac++;
	XtSetArg(args[ac], XmNheight, 20);
	ac++;
	separator6 = XmCreateSeparator(form_realtime_setup, (char *)"separator6", args, ac);
	XtManageChild(separator6);

	ac = 0;
	XtSetArg(args[ac], XmNx, 10);
	ac++;
	XtSetArg(args[ac], XmNy, 392);
	ac++;
	XtSetArg(args[ac], XmNwidth, 480);
	ac++;
	XtSetArg(args[ac], XmNheight, 50);
	ac++;
	spinBox_realtimesetup_icon = XmCreateSpinBox(form_realtime_setup, (char *)"spinBox_realtimesetup_icon", args, ac);
	...
	ac++;
	XtSetArg(args[ac], XmNfontList,
	         BX_CONVERT(spinBox_realtimesetup_icon, (char *)"-*-" SANS "-bold-r-*-*-*-140-75-75-*-*-iso8859-1", XmRFontList, 0,
	                    &argok));
	if (argok)
		ac++;
	spinText_realtimesetup_icon = XmCreateTextField(spinBox_realtimesetup_icon, (char *)"spinText_realtimesetup_icon", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(form_realtime_setup, (char *)"Realtime Display Icon:", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNx, 10);
		ac++;
		XtSetArg(args[ac], XmNy, 362);
		ac++;
		XtSetArg(args[ac], XmNwidth, 480);
		ac++;
		XtSetArg(args[ac], XmNheight, 30);
		...
		if (argok)
			ac++;
		label_realtime_setup_icon = XmCreateLabel(form_realtime_setup, (char *)"label_realtime_setup_icon", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(form_realtime_setup, (char *)"Browse", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNx, 10);
		...
		if (argok)
			ac++;
		pushButton_realtimesetup_pathbrowse =
		    XmCreatePushButton(form_realtime_setup, (char *)"pushButton_realtimesetup_pathbrowse", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(form_realtime_setup, (char *)"Test", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		...
		if (argok)
			ac++;
		pushButton_realtimesetup_pathtest =
		    XmCreatePushButton(form_realtime_setup, (char *)"pushButton_realtimesetup_pathtest", args, ac);
	...
	XtSetArg(args[ac], XmNx, 10);
	ac++;
	XtSetArg(args[ac], XmNy, 342);
	ac++;
	XtSetArg(args[ac], XmNwidth, 476);
	ac++;
	XtSetArg(args[ac], XmNheight, 20);
	ac++;
	separator5 = XmCreateSeparator(form_realtime_setup, (char *)"separator5", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(form_realtime_setup, (char *)"Data read before update", XmRXmString, 0, &argok);
		...
		if (argok)
			ac++;
		scale_realtimesetup_update = XmCreateScale(form_realtime_setup, (char *)"scale_realtimesetup_update", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(form_realtime_setup, (char *)"Display Update Rate:", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_CENTER);
		ac++;
		XtSetArg(args[ac], XmNx, 10);
		ac++;
		XtSetArg(args[ac], XmNy, 242);
		ac++;
		XtSetArg(args[ac], XmNwidth, 476);
		ac++;
		XtSetArg(args[ac], XmNheight, 30);
		...
		if (argok)
			ac++;
		label_realtimesetup_update = XmCreateLabel(form_realtime_setup, (char *)"label_realtimesetup_update", args, ac);
	...
	XtSetArg(args[ac], XmNx, 10);
	ac++;
	XtSetArg(args[ac], XmNy, 222);
	ac++;
	XtSetArg(args[ac], XmNwidth, 476);
	ac++;
	XtSetArg(args[ac], XmNheight, 20);
	ac++;
	separator4 = XmCreateSeparator(form_realtime_setup, (char *)"separator4", args, ac);
	...
	if (argok)
		ac++;
	textField_realtimesetup_path = XmCreateTextField(form_realtime_setup, (char *)"textField_realtimesetup_path", args, ac);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(form_realtime_setup, (char *)"Realtime Nav Source Path:", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_CENTER);
		...
		if (argok)
			ac++;
		label_realtimesetup_path = XmCreateLabel(form_realtime_setup, (char *)"label_realtimesetup_path", args, ac);
	...
	ac++;
	XtSetArg(args[ac], XmNtopOffset, 72);
	ac++;
	XtSetArg(args[ac], XmNtopWidget, textField_realtimesetup_path);
	ac++;
	...
	ac++;
	XtSetArg(args[ac], XmNtopOffset, 2);
	ac++;
	XtSetArg(args[ac], XmNleftWidget, pushButton_realtimesetup_pathtest);
	ac++;
	XtSetArg(args[ac], XmNtopWidget, textField_realtimesetup_path);
	ac++;
	...
	ac++;
	XtSetArg(args[ac], XmNrightOffset, 197);
	ac++;
	XtSetArg(args[ac], XmNtopOffset, 9);
	ac++;
	XtSetArg(args[ac], XmNtopWidget, separator6);
	ac++;
	...
	ac++;
	XtSetArg(args[ac], XmNtopWidget, spinBox_realtimesetup_icon);
	ac++;
	...
	XtSetArg(args[ac], XmNtopOffset, 0);
	ac++;
	XtSetArg(args[ac], XmNtopWidget, label_realtime_setup_icon);
	ac++;
	...
	ac++;
	XtSetArg(args[ac], XmNtopOffset, 100);
	ac++;
	...
	XtSetArg(args[ac], XmNtopOffset, 100);
	ac++;
	XtSetArg(args[ac], XmNleftWidget, pushButton_realtimesetup_pathbrowse);
	ac++;
	...
	ac++;
	XtSetArg(args[ac], XmNtopOffset, 7);
	ac++;
	XtSetArg(args[ac], XmNtopWidget, scale_realtimesetup_update);
	ac++;
	...
	XtSetArg(args[ac], XmNtopOffset, 0);
	ac++;
	XtSetArg(args[ac], XmNtopWidget, label_realtimesetup_update);
	ac++;
	...
	XtSetArg(args[ac], XmNtopOffset, 0);
	ac++;
	XtSetArg(args[ac], XmNtopWidget, label_realtimesetup_teststatus);
	ac++;
	...
	XtSetArg(args[ac], XmNleftOffset, 10);
	ac++;
	XtSetArg(args[ac], XmNrightOffset, 16);
	ac++;
	...
	ac = 0;
	XtSetArg(args[ac], XmNposition, 1);
	ac++;
	XtSetArg(args[ac], XmNminimumValue, 1);
	ac++;
	XtSetArg(args[ac], XmNspinBoxChildType, XmNUMERIC);
	ac++;
	XtSetArg(args[ac], XmNnumValues, 0);
	ac++;
	XtSetArg(args[ac], XmNpositionType, XmPOSITION_VALUE);
	ac++;
	...
	ac = 0;
	XtSetArg(args[ac], XmNposition, 0);
	ac++;
	XtSetArg(args[ac], XmNminimumValue, 0);
	ac++;
	XtSetArg(args[ac], XmNmaximumValue, 50);
	ac++;
	XtSetArg(args[ac], XmNspinBoxChildType, XmNUMERIC);
	ac++;
	...
	ac = 0;
	XtSetArg(args[ac], XmNposition, 200);
	ac++;
	XtSetArg(args[ac], XmNminimumValue, 1);
	ac++;
	XtSetArg(args[ac], XmNmaximumValue, 10000);
	ac++;
	XtSetArg(args[ac], XmNspinBoxChildType, XmNUMERIC);
	ac++;
	...
	ac = 0;
	XtSetArg(args[ac], XmNincrementValue, 5);
	ac++;
	XtSetArg(args[ac], XmNposition, 120);
	ac++;
	XtSetArg(args[ac], XmNminimumValue, 5);
	ac++;
	XtSetArg(args[ac], XmNmaximumValue, 175);
	ac++;
	XtSetArg(args[ac], XmNspinBoxChildType, XmNUMERIC);
	ac++;
	...
	ac = 0;
	XtSetArg(args[ac], XmNmenuHelpWidget, cascadeButton_help);
	ac++;
