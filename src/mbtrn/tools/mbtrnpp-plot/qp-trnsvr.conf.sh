...
# Configuration for trnsvr log data plots
...
QU_TRNSVR_PROFILE_PTITLE=${QU_PTITLE:-"TRNSVR operation profile"}
QU_TRNSVR_PROFILE_STITLE=${QU_STITLE:-"\n${QU_DATA_SET_ID}"}
export QU_TRNSVR_PROFILE_OIMG_NAME="trnsvr-prof"
QU_OFILE_NAME="trnsvr-prof"

QU_TRNSVR_CLI_PTITLE=${QU_PTITLE:-"TRNSVR client activity"}
QU_TRNSVR_CLI_STITLE=${QU_STITLE:-"\n${QU_DATA_SET_ID}"}
export QU_TRNSVR_CLI_OIMG_NAME="trnsvr-cli"
QU_OFILE_NAME="trnsvr-cli"

# Define job names to use in the configuration
declare -a QU_KEYS=( "trnsvr-prof" "trnsvr-cli" "comb-all" )
...
QU_KEY=${QU_KEYS[0]}
QP_OFILE_NAME["$QU_KEY"]="${QU_TRNSVR_PROFILE_OIMG_NAME}"
QP_PTITLE["$QU_KEY"]="${QU_TRNSVR_PROFILE_PTITLE}${QU_TRNSVR_PROFILE_STITLE}"
...
QP_PLOT_SPECS["$QU_KEY"]="${QU_TRNSVR_XT_UDCON_CSV},${QU_BLUE},1,,1,8,x1y2,udcon(y2)"
QP_PLOT_SPECS["$QU_KEY"]+="+${QU_TRNSVR_XT_CHKHB_CSV},${QU_ORANGE},1,,1,8,x1y2,chkhb(y2)"
QP_PLOT_SPECS["$QU_KEY"]+="+${QU_TRNSVR_XT_READ_CSV},${QU_YELLOW},1,,1,8,x1y1,read"
QP_PLOT_SPECS["$QU_KEY"]+="+${QU_TRNSVR_XT_HANDLE_CSV},${QU_PURPLE},1,,1,8,x1y2,handle(y2)"
QP_PLOT_SPECS["$QU_KEY"]+="+${QU_TRNSVR_XT_REQRES_CSV},${QU_GREEN},1,,1,8,x1y1,reqres"
QP_PLOT_SPECS["$QU_KEY"]+="+${QU_TRNSVR_XT_PUB_CSV},${QU_LTBLUE},1,,1,8,x1y2,pub(y2)"

QU_KEY=${QU_KEYS[1]}
QP_OFILE_NAME["$QU_KEY"]="${QU_TRNSVR_CLI_OIMG_NAME}"
QP_PTITLE["$QU_KEY"]="${QU_TRNSVR_CLI_PTITLE}${QU_TRNSVR_CLI_STITLE}"
QP_TFMT["$QU_KEY"]=${QU_ITIME}
QP_XTFMT["$QU_KEY"]=${QU_OTIME}
QP_ISTIME["$QU_KEY"]="Y"
QP_YFMT["$QU_KEY"]="%g" #${QU_OTIME}
...
QP_EXPR["$QU_KEY"]="Y"
QP_SPECDEL["$QU_KEY"]="|"
QP_PLOT_SPECS["$QU_KEY"]="${QU_TRNSVR_CLICON_CSV},${QU_BLUE},1,,1,(\$5 + 0.0),,con"
QP_PLOT_SPECS["$QU_KEY"]+="|${QU_TRNSVR_CLIDIS_CSV},${QU_ORANGE},1,,1,(\$5 + 0.01),,dis"
QP_PLOT_SPECS["$QU_KEY"]+="|${QU_TRNSVR_CLILL_CSV},${QU_GREEN},1,,1,(\$5 + 0.02),,llen"
