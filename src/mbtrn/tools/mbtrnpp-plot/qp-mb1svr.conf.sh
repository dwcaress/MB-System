...
# Configuration for mb1svr log data plots
...
QU_MB1SVR_PROFILE_PTITLE=${QU_PTITLE:-"MB1SVR operation profile"}
QU_MB1SVR_PROFILE_STITLE=${QU_STITLE:-"\n${QU_DATA_SET_ID}"}
export QU_MB1SVR_PROFILE_OIMG_NAME="mb1svr-prof"
QU_OFILE_NAME="mb1svr-prof"

QU_MB1SVR_CLI_PTITLE=${QU_PTITLE:-"MB1SVR client activity"}
QU_MB1SVR_CLI_STITLE=${QU_STITLE:-"\n${QU_DATA_SET_ID}"}
export QU_MB1SVR_CLI_OIMG_NAME="mb1svr-cli"
QU_OFILE_NAME="mb1svr-cli"

# Define job names to use in the configuration
declare -a QU_KEYS=( "mb1svr-prof" "mb1svr-cli" "comb-all" )
...
QU_KEY=${QU_KEYS[0]}
QP_OFILE_NAME["$QU_KEY"]="${QU_MB1SVR_PROFILE_OIMG_NAME}"
QP_PTITLE["$QU_KEY"]="${QU_MB1SVR_PROFILE_PTITLE}${QU_MB1SVR_PROFILE_STITLE}"
...
QP_PLOT_SPECS["$QU_KEY"]="${QU_MB1SVR_XT_UDCON_CSV},${QU_BLUE},1,,1,8,x1y2,udcon(y2)"
QP_PLOT_SPECS["$QU_KEY"]+="+${QU_MB1SVR_XT_CHKHB_CSV},${QU_ORANGE},1,,1,8,x1y2,chkhb(y2)"
QP_PLOT_SPECS["$QU_KEY"]+="+${QU_MB1SVR_XT_READ_CSV},${QU_YELLOW},1,,1,8,x1y1,read"
QP_PLOT_SPECS["$QU_KEY"]+="+${QU_MB1SVR_XT_HANDLE_CSV},${QU_PURPLE},1,,1,8,x1y2,handle(y2)"
QP_PLOT_SPECS["$QU_KEY"]+="+${QU_MB1SVR_XT_REQRES_CSV},${QU_GREEN},1,,1,8,x1y1,reqres"
QP_PLOT_SPECS["$QU_KEY"]+="+${QU_MB1SVR_XT_PUB_CSV},${QU_LTBLUE},1,,1,8,x1y2,pub(y2)"

QU_KEY=${QU_KEYS[1]}
QP_OFILE_NAME["$QU_KEY"]="${QU_MB1SVR_CLI_OIMG_NAME}"
QP_PTITLE["$QU_KEY"]="${QU_MB1SVR_CLI_PTITLE}${QU_MB1SVR_CLI_STITLE}"
QP_TFMT["$QU_KEY"]=${QU_ITIME}
QP_XTFMT["$QU_KEY"]=${QU_OTIME}
QP_ISTIME["$QU_KEY"]="Y"
QP_YFMT["$QU_KEY"]="%g" #${QU_OTIME}
...
QP_EXPR["$QU_KEY"]="Y"
QP_SPECDEL["$QU_KEY"]="|"
QP_PLOT_SPECS["$QU_KEY"]="${QU_MB1SVR_CLICON_CSV},${QU_BLUE},1,,1,(\$5 + 0.00),,con"
QP_PLOT_SPECS["$QU_KEY"]+="|${QU_MB1SVR_CLIDIS_CSV},${QU_ORANGE},1,,1,(\$5 + 0.01),,dis"
QP_PLOT_SPECS["$QU_KEY"]+="|${QU_MB1SVR_CLILL_CSV},${QU_GREEN},1,,1,(\$5 + 0.02),,llen"
