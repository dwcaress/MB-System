 ...
 * Date:  July 10, 2026
 *
 * Derived from source file xdr_win32.c distributed as part of the Atlas SURF format
...
void xdr_destroy(XDR* xdrs) {
 /* xdrstdio streams own no resources of their own -- the underlying
    FILE* remains owned and closed by the caller */
 (void)xdrs;
}
