...
// ═════════════════════════════════════════════════════════════════════════════
//  Data shared between the programmable-filter callback and the rest of main()
// ═════════════════════════════════════════════════════════════════════════════
struct CallbackData
{
  ...
  double                 elevMin;
  double                 elevMax;
  double                 slopeGamma;    // >1 → only very steep areas darken
  double                 minBrightness; // floor (0–1); prevents pure-black cliffs
};
...
static void SlopeColorExecute(void* userData)
{
  ...
  if (!elevPD)
    {
      std::cerr << "[SlopeColorExecute] ERROR: primary input is not vtkPolyData\n";
      return;
    }
  ...
  if (!normalsPD)
    {
      std::cerr << "[SlopeColorExecute] ERROR: normals output is null\n";
      return;
    }
