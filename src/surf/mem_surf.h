...
XdrSurf mem_ReadSixStructure(char *filename, SurfDataInfo *toSurfDataInfo);

// This function doesn't destroy the internal data-structures
XdrSurf mem_WriteSixStructure(char *filename, SurfDataInfo *toSurfDataInfo);
XdrSurf mem_ReadSdaStructure(char *filename, SurfDataInfo *toSurfDataInfo);

// This function doesn't destroy the internal data-structures
XdrSurf mem_WriteSdaStructure(char *filename, SurfDataInfo *toSurfDataInfo);
...
XdrSurf checkAndLoadSurfDescriptor(
    SurfDescriptor *toSurfDescriptor, SurfDataInfo *toSurfDataInfo);
XdrSurf checkAndUpdateSurfDescriptor(
    SurfDescriptor *toSurfDescriptor, SurfDataInfo *toSurfDataInfo);
