...
#define TRNDL_TRNLCMINPUT_NOTIFYSEM 10

#define TRNDL_UTILS_MBSFCOMP 5
#define TRNDL_UTILS_MBSFCOMP_H 8

#define TRNDL_UTILS_DVLSFCOMP 5
#define TRNDL_UTILS_DVLSFCOMP_H 6

#define TRNDL_PLUGMBMINIROV 5
#define TRNDL_PLUGMBMINIROV_H 8

#define TRNDL_PLUGIDTLASS 10
#define TRNDL_PLUGIDTLASS_H 8
