...
public:
    ...
    static void show_help()
    {
        ...
        "    Context handlers may support one or more:\n"
        "      rbcsv:<PATH> : timestamped sensor framw bathymetry w/"
        "                     navigation, attitude, vel (if used)      CSV\n"
        "      mbcsv:<PATH> : timestamped body frame beam ranges w/"
        "                     navigation, attitude, vel (if used)      CSV\n"
        "      mbbin:<PATH> : MB1 soundings                            MB1\n"
        "      mecsv:<PATH> : mbtrnpp TRN estimates (from udpms)       CSV\n"
        "      tecsv:<PATH> : TRN server estimates (from trncli)       CSV\n"
        "\n"
        "      csv:<PATH>\n"
        ...
        "\n"
        "  # MAP  : key value maps (extra parameters) optional\n"
