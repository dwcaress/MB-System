...
extern "C" void transform_mblass(trn::bath_info **bi, trn::att_info **ai, mbgeo **geo, mb1_t *r_snd);
extern "C" int cb_proto_mblass(void *pargs);

extern "C" void transform_xmb1(trn::mb1_info **bi, trn::att_info **ai, mbgeo **geo, mb1_t *r_snd);
extern "C" int cb_proto_xmb1(void *pargs);

extern "C" int transform_idtlass(trn::bath_info **bi, trn::att_info **ai, beam_geometry **geo, mb1_t *r_snd);
extern "C" int cb_proto_idtlass(void *pargs);

extern "C" int transform_mbminirov(trn::bath_info **bi, trn::att_info **ai, beam_geometry **geo, mb1_t *r_snd);
extern "C" int cb_proto_mbminirov(void *pargs);
...
public:
    ...
    static void register_callbacks(LcmTrnPP &xpp)
    {
