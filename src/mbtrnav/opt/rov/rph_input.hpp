...
//////////////////////////////////////////////////////////////////////////////
#ifndef RPH_INPUT_HPP  // include guard
#define RPH_INPUT_HPP
...
#include "senlcm/rph_t.hpp"
#include "att_input.hpp"

namespace trn
{
class rph_input : public att_input
{
public:

    rph_input(const std::string& name = "UNKNOWN", uint32_t depth=0)
