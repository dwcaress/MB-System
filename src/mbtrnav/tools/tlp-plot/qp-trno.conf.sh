...
QP_PLOT_SPECS["$QU_KEY"]+="+${QU_TRNO_CSV},${QU_MAGENTA},6,,1,(sqrt(\$10*\$10\+\$11*\$11\+\$12*\$12)<=5?0:1/0),x1y1,CONV"
...
QP_PLOT_SPECS["$QU_KEY"]+="|${QU_TRNO_CSV},${QU_MAGENTA},2,,1,(sqrt(\$10*\$10+\$11*\$11+\$12*\$12)<=5?\$3:1/0),,mmse.N (conv)"
...
QP_PLOT_SPECS["$QU_KEY"]+="|${QU_TRNO_CSV},${QU_MAGENTA},2,,1,(sqrt(\$10*\$10+\$11*\$11+\$12*\$12)<=5?\$4:1/0),,mmse.E (conv)"
...
QP_PLOT_SPECS["$QU_KEY"]+="|${QU_TRNO_CSV},${QU_MAGENTA},2,,1,(sqrt(\$10*\$10+\$11*\$11+\$12*\$12)<=5?\$5:1/0),,mmse.Z (conv)"
...
QP_PLOT_SPECS["$QU_KEY"]+="|${QU_TRNO_CSV},${QU_MAGENTA},3,,1,(sqrt(\$10*\$10+\$11*\$11+\$12*\$12)<=5?\$4:1/0),,mmse.pos (conv)"
