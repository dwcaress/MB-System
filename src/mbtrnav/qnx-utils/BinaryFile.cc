...
/*
  ...
  if (fwrite((void *)&value, sizeof(char), 1, _file) < 1) {
    snprintf(errorBuf, sizeof(errorBuf), "BinaryFile::set(CharData) - %s", strerror(errno));
...
/*
  ...
  if (fwrite((void *)&value, sizeof(short), 1, _file) < 1) {
    snprintf(errorBuf, sizeof(errorBuf), "BinaryFile::set(ShortData) - %s", strerror(errno));
    throw Exception(errorBuf);
  }
*/
}
...
/*
  ...
  if (fwrite((void *)&value, sizeof(int), 1, _file) < 1) {
    snprintf(errorBuf, sizeof(errorBuf), "BinaryFile::set(IntegerData) - %s", strerror(errno));
    throw Exception(errorBuf);
  }
*/
}
...
/*
  ...
  if (fwrite((void *)&value, sizeof(float), 1, _file) < 1) {
    snprintf(errorBuf, sizeof(errorBuf), "BinaryFile::set(FloatData) - %s", strerror(errno));
    throw Exception(errorBuf);
  }
*/
}
...
/*
  ...
  if (fwrite((void *)&value, sizeof(double), 1, _file) < 1) {
    snprintf(errorBuf, sizeof(errorBuf), "BinaryFile::set(DoubleData) - %s", strerror(errno));
    throw Exception(errorBuf);
  }
*/
}
...
void BinaryFile::set(StringData *stringData)
{
  ...
  if (fwrite((void *)value, strlen(value), 1, _file) < 1 ||
    ...
    snprintf(errorBuf, sizeof(errorBuf), "BinaryFile::set(StringData) - %s", strerror(errno));
    throw Exception(errorBuf);
  }
}
...
void BinaryFile::get(CharData *charData)
{
  ...
  if (fread((void *)&value, sizeof(char), 1, _file) < 1) {
    if (feof(_file)) {
      ...
      snprintf(errorBuf, sizeof(errorBuf), "BinaryFile::get(CharData) - %s", strerror(errno));
      throw Exception(errorBuf);
    }
  }
  else
...
void BinaryFile::get(ShortData *shortData)
{
  ...
  if (fread((void *)&value, sizeof(short), 1, _file) < 1) {
    if (feof(_file)) {
      ...
      snprintf(errorBuf, sizeof(errorBuf), "BinaryFile::get(ShortData) - %s", strerror(errno));
      throw Exception(errorBuf);
    }
  }
  else
...
void BinaryFile::get(IntegerData *integerData)
{
  ...
  if (fread((void *)&value, sizeof(int), 1, _file) < 1) {
    if (feof(_file)) {
      ...
      snprintf(errorBuf, sizeof(errorBuf), "BinaryFile::get(IntegerData) - %s", strerror(errno));
      throw Exception(errorBuf);
    }
  }
  else
...
void BinaryFile::get(FloatData *floatData)
{
  ...
  if (fread((void *)&value, sizeof(float), 1, _file) < 1) {
    if (feof(_file)) {
      ...
      snprintf(errorBuf, sizeof(errorBuf), "BinaryFile::get(FloatData) - %s", strerror(errno));
      throw Exception(errorBuf);
    }
  }
  else
...
void BinaryFile::get(DoubleData *doubleData)
{
  ...
  if (fread((void *)&value, sizeof(double), 1, _file) < 1) {
    if (feof(_file)) {
      ...
      snprintf(errorBuf, sizeof(errorBuf), "BinaryFile::get(DoubleData) - %s", strerror(errno));
      throw Exception(errorBuf);
    }
  }
  else
...
void BinaryFile::get(StringData *stringData)
{
  ...
  while (nCopiedBytes < sizeof(string) - 1) {
    ...
    if ((c = getc(_file)) == -1) {
      ...
      snprintf(errorBuf, sizeof(errorBuf), "BinaryFile::get(StringData) - EOF");
      throw Exception(errorBuf);
    }
  ...
  if (!stringFinished) {
    ...
    snprintf(errorBuf, sizeof(errorBuf), "BinaryFile::get(StringData) - too many bytes");
    throw Exception(errorBuf);
  }
