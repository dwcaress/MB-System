 ...
 *	$Id: mbr_hsldeoih.c,v 5.5 2003-04-17 21:05:23 caress Exp $
 *
...
{
	static char res_id[]="$Id: mbr_hsldeoih.c,v 5.5 2003-04-17 21:05:23 caress Exp $";
...
/*--------------------------------------------------------------------*/
int mbr_hsldeoih_wr_data(int verbose, void *mbio_ptr, char *data_ptr, int *error)
{
