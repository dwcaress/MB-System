 ...
 *	$Id: mbr_hsldeoih.c,v 5.0 2000-12-01 22:48:41 caress Exp $
 *
...
int mbr_info_hsldeoih(int verbose, 
			...
			int *error)
{
	static char res_id[]="$Id: mbr_hsldeoih.c,v 5.0 2000-12-01 22:48:41 caress Exp $";
	...
	*format_alloc = &mbr_alm_hsldeoih;
	*format_free = &mbr_dem_hsldeoih; 
	*store_alloc = &mbsys_hsds_alloc; 
	*store_free = &mbsys_hsds_deall; 
	*read_ping = &mbr_rt_hsldeoih; 
	*write_ping = &mbr_wt_hsldeoih; 
