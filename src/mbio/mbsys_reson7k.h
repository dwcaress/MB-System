...
#define BLUEFIN_MAX_FRAMES                                                                                                       \
	25 /* Maximum number of Bluefin                                                                                              \
...
typedef struct s7kr_v2detectionsetup_struct {
	...
	float uncertainty
	    [MBSYS_RESON7K_MAX_BEAMS]; /* Detection uncertainty represented as an error normalized to the detection point */
