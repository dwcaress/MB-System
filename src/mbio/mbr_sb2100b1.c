			...
			int *error)
{
	...
	*format_alloc = &mbr_alm_sb2100b1;
	*format_free = &mbr_dem_sb2100b1; 
	*store_alloc = &mbsys_sb2100_alloc; 
	*store_free = &mbsys_sb2100_deall; 
	*read_ping = &mbr_rt_sb2100b1; 
	*write_ping = &mbr_wt_sb2100b1; 
	*extract = &mbsys_sb2100_extract; 
