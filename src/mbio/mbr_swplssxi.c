...
#include "../../include/mbsys_swathplus.h"
...
/* #define MBF_SWPLSSXI_DEBUG2 1 */

/* essential function prototypes */
int mbr_register_swplssxi(int verbose, void *mbio_ptr,
		int *error);
...
int mbr_swplssxi_wr_data(int verbose, void *mbio_ptr, void *store_ptr, int *error);
...
int mbr_register_swplssxi(int verbose, void *mbio_ptr, int *error)
{
	...
	status = mbr_info_swplssxi(verbose,
			&mb_io_ptr->system,
...
int mbr_wt_swplssxi(int verbose, void *mbio_ptr, void *store_ptr, int *error)
{
	...
	status = mbr_swplssxi_wr_data(verbose,mbio_ptr,store_ptr,error);
...
int mbr_swplssxi_wr_data(int verbose, void *mbio_ptr, void *store_ptr, int *error)
{
	char	*function_name = "mbr_swplssxi_wr_data";
	int	status = MB_SUCCESS;
	struct mb_io_struct *mb_io_ptr;
	struct mbsys_swathplus_struct *store;
	FILE	*mbfp;
