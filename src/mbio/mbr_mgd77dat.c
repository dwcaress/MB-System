 ...
 *	$Id: mbr_mgd77dat.c,v 5.2 2001-03-22 20:50:02 caress Exp $
 *
...
int mbr_register_mgd77dat(int verbose, char *mbio_ptr, 
		int *error);
...
/*--------------------------------------------------------------------*/
int mbr_register_mgd77dat(int verbose, char *mbio_ptr, int *error)
{
	static char res_id[]="$Id: mbr_mgd77dat.c,v 5.2 2001-03-22 20:50:02 caress Exp $";
