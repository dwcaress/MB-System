	...
	*error = MB_ERROR_NO_ERROR;
	...
	while (status == MB_SUCCESS && !done) {
		...
		/* read rest of sidescan packet */
			...
			if (read_len == 242) {
				int index = 0;
				mb_get_binary_short(true, &line[index], (short int *)&(pingheader->Year));
				index += 2;
				...
				index++;
				mb_get_binary_short(true, &line[index], (short int *)&(pingheader->JulianDay));
				index += 2;
				mb_get_binary_short(true, &line[index], (short int *)&(pingheader->CurrentLineID));
				index += 2;
				mb_get_binary_short(true, &line[index], (short int *)&(pingheader->EventNumber));
				index += 2;
				mb_get_binary_int(true, &line[index], (int *)&(pingheader->PingNumber));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->SoundVelocity));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->OceanTide));
				index += 4;
				mb_get_binary_int(true, &line[index], (int *)&(pingheader->Reserved2));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->ConductivityFreq));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->TemperatureFreq));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->PressureFreq));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->PressureTemp));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->Conductivity));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->WaterTemperature));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->Pressure));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->ComputedSoundVelocity));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->MagX));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->MagY));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->MagZ));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->AuxVal1));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->AuxVal2));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->AuxVal3));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->AuxVal4));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->AuxVal5));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->AuxVal6));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->SpeedLog));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->Turbidity));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->ShipSpeed));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->ShipGyro));
				index += 4;
				mb_get_binary_double(true, &line[index], &(pingheader->ShipYcoordinate));
				index += 8;
				mb_get_binary_double(true, &line[index], &(pingheader->ShipXcoordinate));
				index += 8;
				mb_get_binary_short(true, &line[index], (short int *)&(pingheader->ShipAltitude));
				index += 2;
				mb_get_binary_short(true, &line[index], (short int *)&(pingheader->ShipDepth));
				index += 2;
				...
				index++;
				mb_get_binary_float(true, &line[index], &(pingheader->SensorSpeed));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->KP));
				index += 4;
				mb_get_binary_double(true, &line[index], &(pingheader->SensorYcoordinate));
				index += 8;
				mb_get_binary_double(true, &line[index], &(pingheader->SensorXcoordinate));
				index += 8;
				mb_get_binary_short(true, &line[index], &(pingheader->Reserved6));
				index += 2;
				mb_get_binary_short(true, &line[index], &(pingheader->RangeToSensor));
				index += 2;
				mb_get_binary_short(true, &line[index], &(pingheader->BearingToSensor));
				index += 2;
				mb_get_binary_short(true, &line[index], &(pingheader->CableOut));
				index += 2;
				mb_get_binary_float(true, &line[index], &(pingheader->Layback));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->CableTension));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->SensorDepth));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->SensorPrimaryAltitude));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->SensorAuxAltitude));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->SensorPitch));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->SensorRoll));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->SensorHeading));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->Heave));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->Yaw));
				index += 4;
				mb_get_binary_int(true, &line[index], &(pingheader->AttitudeTimeTag));
				index += 4;
				mb_get_binary_float(true, &line[index], &(pingheader->DOT));
				index += 4;
				for (int i = 0; i < 20; i++) {
