/*--------------------------------------------------------------------
 *    The MB-system:	mbf_sbsiomrg.h	3.00	1/20/93
 *	$Id: mbf_sbsiomrg.h,v 3.0 1993-05-14 22:53:48 sohara Exp $
 *
 *    Copyright (c) 1993 by 
 ...
 * to store multibeam data read from the  MBF_SBSIOMRG format (MBIO id 1).  
 *
 * Author:	D. W. Caress
