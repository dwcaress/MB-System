 ...
 *	$Id: mbr_sb2000sb.c,v 5.1 2001-01-22 07:43:34 caress Exp $
 *
...
int mbr_info_sb2000sb(int verbose, 
			...
			int *error)
{
	static char res_id[]="$Id: mbr_sb2000sb.c,v 5.1 2001-01-22 07:43:34 caress Exp $";
	...
	*format_alloc = &mbr_alm_sb2000sb;
	*format_free = &mbr_dem_sb2000sb; 
	*store_alloc = &mbsys_sb2000_alloc; 
	*store_free = &mbsys_sb2000_deall; 
	*read_ping = &mbr_rt_sb2000sb; 
	*write_ping = &mbr_wt_sb2000sb; 
