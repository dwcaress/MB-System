...
int mbr_wasspenl_rd_genbathy(int verbose, char *buffer, void *store_ptr, int *error) {
	...
	/* extract the data */
	int index = 16;
	mb_get_binary_int(false, &buffer[index], &(genbathy->version));
	index += 4;
	mb_get_binary_double(false, &buffer[index], &(genbathy->msec));
	index += 8;
	genbathy->day = buffer[index];
	index++;
	genbathy->month = buffer[index];
	index++;
	mb_get_binary_short(false, &buffer[index], &(genbathy->year));
	index += 2;
	mb_get_binary_int(false, &buffer[index], &(genbathy->ping_number));
	index += 4;
	mb_get_binary_int(false, &buffer[index], &(genbathy->sonar_model));
	index += 4;
	mb_get_binary_long(false, &buffer[index], &(genbathy->transducer_serial_number));
	index += 8;
	mb_get_binary_int(false, &buffer[index], &(genbathy->number_beams));
	index += 4;
	mb_get_binary_int(false, &buffer[index], &(genbathy->modeflags));
	index += 4;
	mb_get_binary_float(false, &buffer[index], &(genbathy->sampling_frequency));
	index += 4;
	mb_get_binary_float(false, &buffer[index], &(genbathy->acoustic_frequency));
	index += 4;
	mb_get_binary_float(false, &buffer[index], &(genbathy->tx_power));
	index += 4;
	mb_get_binary_float(false, &buffer[index], &(genbathy->pulse_width));
	index += 4;
	mb_get_binary_float(false, &buffer[index], &(genbathy->absorption_loss));
	index += 4;
	mb_get_binary_float(false, &buffer[index], &(genbathy->spreading_loss));
	index += 4;
	mb_get_binary_int(false, &buffer[index], &(genbathy->sample_type));
	index += 4;
	mb_get_binary_float(false, &buffer[index], &(genbathy->sound_velocity));
	index += 4;
	for (int i = 0; i < genbathy->number_beams; i++) {
		mb_get_binary_float(false, &buffer[index], &(genbathy->detection_point[i]));
		index += 4;
		mb_get_binary_float(false, &buffer[index], &(genbathy->rx_angle[i]));
		index += 4;
		mb_get_binary_int(false, &buffer[index], &(genbathy->flags[i]));
		index += 4;
		mb_get_binary_float(false, &buffer[index], &(genbathy->backscatter[i]));
		index += 4;
	}
	mb_get_binary_int(false, &buffer[index], &(genbathy->checksum));
	index += 4;
...
int mbr_wasspenl_rd_corbathy(int verbose, char *buffer, void *store_ptr, int *error) {
	...
	/* extract the data */
	int index = 16;
	mb_get_binary_int(false, &buffer[index], &(corbathy->version));
	index += 4;
	mb_get_binary_double(false, &buffer[index], &(corbathy->msec));
	index += 8;
	mb_get_binary_int(false, &buffer[index], &(corbathy->num_beams));
	index += 4;
	mb_get_binary_int(false, &buffer[index], &(corbathy->ping_number));
	index += 4;
	mb_get_binary_double(false, &buffer[index], &(corbathy->latitude));
	index += 8;
	mb_get_binary_double(false, &buffer[index], &(corbathy->longitude));
	index += 8;
	mb_get_binary_float(false, &buffer[index], &(corbathy->bearing));
	index += 4;
	mb_get_binary_float(false, &buffer[index], &(corbathy->roll));
	index += 4;
	mb_get_binary_float(false, &buffer[index], &(corbathy->pitch));
	index += 4;
	mb_get_binary_float(false, &buffer[index], &(corbathy->heave));
	index += 4;
	mb_get_binary_int(false, &buffer[index], &(corbathy->sample_type));
	index += 4;
	for (int i = 0; i < 5; i++) {
		mb_get_binary_int(false, &buffer[index], &(corbathy->spare[i]));
		index += 4;
	}
	for (int i = 0; i < corbathy->num_beams; i++) {
		mb_get_binary_int(false, &buffer[index], &(corbathy->beam_index[i]));
		index += 4;
		mb_get_binary_float(false, &buffer[index], &(corbathy->x[i]));
		index += 4;
		mb_get_binary_float(false, &buffer[index], &(corbathy->y[i]));
		index += 4;
		mb_get_binary_float(false, &buffer[index], &(corbathy->z[i]));
		index += 4;
		mb_get_binary_float(false, &buffer[index], &(corbathy->beam_angle[i]));
		index += 4;
		mb_get_binary_float(false, &buffer[index], &(corbathy->backscatter[i]));
		index += 4;
		...
		index++;
		mb_get_binary_int(false, &buffer[index], &(corbathy->pad[i]));
		index += 4;
	}
	mb_get_binary_int(false, &buffer[index], &(corbathy->checksum));
	index += 4;
...
int mbr_wasspenl_rd_rawsonar(int verbose, char *buffer, void *store_ptr, int *error) {
	...
	/* extract the data */
	int index = 16;
	mb_get_binary_int(false, &buffer[index], &(rawsonar->version));
	index += 4;
	mb_get_binary_double(false, &buffer[index], &(rawsonar->msec));
	index += 8;
	mb_get_binary_int(false, &buffer[index], &(rawsonar->ping_number));
	index += 4;
	mb_get_binary_float(false, &buffer[index], &(rawsonar->sample_rate));
	index += 4;
	mb_get_binary_int(false, &buffer[index], &(rawsonar->n));
	index += 4;
	mb_get_binary_int(false, &buffer[index], &(rawsonar->m));
	index += 4;
	mb_get_binary_float(false, &buffer[index], &(rawsonar->tx_power));
	index += 4;
	mb_get_binary_float(false, &buffer[index], &(rawsonar->pulse_width));
	index += 4;
	mb_get_binary_int(false, &buffer[index], &(rawsonar->sample_type));
	index += 4;
	for (int i = 0; i < rawsonar->n; i++) {
		mb_get_binary_int(false, &buffer[index], &(rawsonar->spare[i]));
		index += 4;
	}
	for (int i = 0; i < rawsonar->n; i++) {
		mb_get_binary_int(false, &buffer[index], &(rawsonar->beam_index[i]));
		index += 4;
	}
	for (int i = 0; i < rawsonar->n; i++) {
		mb_get_binary_int(false, &buffer[index], &(rawsonar->detection_point[i]));
		index += 4;
	}
	for (int i = 0; i < rawsonar->n; i++) {
		mb_get_binary_float(false, &buffer[index], &(rawsonar->beam_angle[i]));
		index += 4;
	}
	...
	index += rawdata_len;
	mb_get_binary_int(false, &buffer[index], &(rawsonar->checksum));
	index += 4;
...
int mbr_wasspenl_rd_gen_sens(int verbose, char *buffer, void *store_ptr, int *error) {
	...
	/* extract the data */
	int index = 16;
	mb_get_binary_int(false, &buffer[index], &(gen_sens->version));
	index += 4;
	mb_get_binary_double(false, &buffer[index], &(gen_sens->msec));
	index += 8;
	mb_get_binary_int(false, &buffer[index], &(gen_sens->port_number));
	index += 4;
	...
	mb_get_binary_int(false, &buffer[index], &(gen_sens->checksum));
	index += 4;
...
int mbr_wasspenl_rd_nvupdate(int verbose, char *buffer, void *store_ptr, int *error) {
	...
	/* extract the data */
	int index = 16;
	mb_get_binary_int(false, &buffer[index], &(nvupdate->version));
	index += 4;
	mb_get_binary_double(false, &buffer[index], &(nvupdate->latitude));
	index += 8;
	mb_get_binary_double(false, &buffer[index], &(nvupdate->longitude));
	index += 8;
	mb_get_binary_float(false, &buffer[index], &(nvupdate->sog));
	index += 4;
	mb_get_binary_float(false, &buffer[index], &(nvupdate->cog));
	index += 4;
	mb_get_binary_float(false, &buffer[index], &(nvupdate->heading));
	index += 4;
	mb_get_binary_float(false, &buffer[index], &(nvupdate->roll));
	index += 4;
	mb_get_binary_float(false, &buffer[index], &(nvupdate->pitch));
	index += 4;
	mb_get_binary_float(false, &buffer[index], &(nvupdate->heave));
	index += 4;
	mb_get_binary_float(false, &buffer[index], &(nvupdate->nadir_depth));
	index += 4;
	mb_get_binary_int(false, &buffer[index], &(nvupdate->checksum));
	index += 4;
...
int mbr_wasspenl_rd_wcd_navi(int verbose, char *buffer, void *store_ptr, int *error) {
	...
	/* extract the data */
	int index = 16;
	mb_get_binary_int(false, &buffer[index], &(wcd_navi->version));
	index += 4;
	mb_get_binary_double(false, &buffer[index], &(wcd_navi->latitude));
	index += 8;
	mb_get_binary_double(false, &buffer[index], &(wcd_navi->longitude));
	index += 8;
	mb_get_binary_int(false, &buffer[index], &(wcd_navi->num_points));
	index += 4;
	mb_get_binary_float(false, &buffer[index], &(wcd_navi->bearing));
	index += 4;
	mb_get_binary_double(false, &buffer[index], &(wcd_navi->msec));
	index += 8;
	mb_get_binary_int(false, &buffer[index], &(wcd_navi->ping_number));
	index += 4;
	mb_get_binary_float(false, &buffer[index], &(wcd_navi->sample_rate));
	index += 4;
	int status = MB_SUCCESS;
	...
	for (int i = 0; i < wcd_navi->num_points; i++) {
		mb_get_binary_float(false, &buffer[index], &(wcd_navi->wcdata_x[i]));
		index += 4;
		mb_get_binary_float(false, &buffer[index], &(wcd_navi->wcdata_y[i]));
		index += 4;
		mb_get_binary_float(false, &buffer[index], &(wcd_navi->wcdata_mag[i]));
		index += 4;
	}
	mb_get_binary_int(false, &buffer[index], &(wcd_navi->checksum));
	index += 4;
...
int mbr_wasspenl_rd_sensprop(int verbose, char *buffer, void *store_ptr, int *error) {
	...
	/* extract the data */
	int index = 16;
	mb_get_binary_int(false, &buffer[index], &(sensprop->version));
	index += 4;
	mb_get_binary_int(false, &buffer[index], &(sensprop->flags));
	index += 4;
	mb_get_binary_float(false, &buffer[index], &(sensprop->sea_level_reference));
	index += 4;
	mb_get_binary_float(false, &buffer[index], &(sensprop->element_spacing));
	index += 4;
	for (int i = 0; i < 8; i++) {
		mb_get_binary_int(false, &buffer[index], &(sensprop->spare[i]));
		index += 4;
	}
	mb_get_binary_int(false, &buffer[index], &(sensprop->n));
	index += 4;
	...
	for (int i = 0; i < sensprop->n; i++) {
		mb_get_binary_int(false, &buffer[index], &(sensprop->sensors[i].sensor_type));
		index += 4;
		mb_get_binary_int(false, &buffer[index], &(sensprop->sensors[i].flags));
		index += 4;
		...
		index++;
		mb_get_binary_float(false, &buffer[index], &(sensprop->sensors[i].latency));
		index += 4;
		mb_get_binary_float(false, &buffer[index], &(sensprop->sensors[i].roll_bias));
		index += 4;
		mb_get_binary_float(false, &buffer[index], &(sensprop->sensors[i].pitch_bias));
		index += 4;
		mb_get_binary_float(false, &buffer[index], &(sensprop->sensors[i].yaw_bias));
		index += 4;
		mb_get_binary_float(false, &buffer[index], &(sensprop->sensors[i].offset_x));
		index += 4;
		mb_get_binary_float(false, &buffer[index], &(sensprop->sensors[i].offset_y));
		index += 4;
		mb_get_binary_float(false, &buffer[index], &(sensprop->sensors[i].offset_z));
		index += 4;
	}
	mb_get_binary_int(false, &buffer[index], &(sensprop->checksum));
	index += 4;
...
int mbr_wasspenl_rd_sys_prop(int verbose, char *buffer, void *store_ptr, int *error) {
	...
	/* extract the data */
	int index = 16;
	mb_get_binary_int(false, &buffer[index], &(sys_prop->version));
	index += 4;
	mb_get_binary_int(false, &buffer[index], &(sys_prop->product_type));
	index += 4;
	mb_get_binary_int(false, &buffer[index], &(sys_prop->protocol_version));
	index += 4;
	for (int i = 0; i < 4; i++) {
		mb_get_binary_int(false, &buffer[index], &(sys_prop->sw_version[i]));
		index += 4;
	}
	mb_get_binary_int(false, &buffer[index], &(sys_prop->fw_version));
	index += 4;
	mb_get_binary_int(false, &buffer[index], &(sys_prop->hw_version));
	index += 4;
	mb_get_binary_int(false, &buffer[index], &(sys_prop->transducer_sn));
	index += 4;
	mb_get_binary_int(false, &buffer[index], &(sys_prop->transceiver_sn));
	index += 4;
	for (int i = 0; i < 8; i++) {
		mb_get_binary_int(false, &buffer[index], &(sys_prop->spare[i]));
		index += 4;
	}
	mb_get_binary_int(false, &buffer[index], &(sys_prop->checksum));
	index += 4;
...
int mbr_wasspenl_rd_sys_cfg1(int verbose, char *buffer, void *store_ptr, int *error) {
	...
	int index = 4;
	unsigned int size;
	mb_get_binary_int(false, &buffer[index], &size);
...
int mbr_wasspenl_rd_mcomment(int verbose, char *buffer, void *store_ptr, int *error) {
	...
	/* extract the data */
	int index = 16;
	mb_get_binary_int(false, &buffer[index], &(mcomment->comment_length));
	index += 4;
...
int mbr_wasspenl_rd_data(int verbose, void *mbio_ptr, void *store_ptr, int *error) {
	...
	*error = MB_ERROR_NO_ERROR;
	...
	while (done == MB_NO) {
		...
		skip = 0;
		mb_get_binary_int(false, buffer, &syncvalue);
...
int mbr_wasspenl_wr_genbathy(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error) {
	...
	*size = 92 + 16 * genbathy->number_beams;
	...
	if (status == MB_SUCCESS) {
		...
		/* insert the data */
		index = 0;
		mb_put_binary_int(false, MBSYS_WASSP_SYNC, &buffer[index]);
		index += 4;
		mb_put_binary_int(false, *size, &buffer[index]);
		index += 4;
		strncpy(&buffer[index], "GENBATHY", 8);
		index += 8;
		mb_put_binary_int(false, genbathy->version, &buffer[index]);
		index += 4;
		mb_put_binary_double(false, genbathy->msec, &buffer[index]);
		index += 8;
		buffer[index] = genbathy->day;
		index++;
		buffer[index] = genbathy->month;
		index++;
		mb_put_binary_short(false, genbathy->year, &buffer[index]);
		index += 2;
		mb_put_binary_int(false, genbathy->ping_number, &buffer[index]);
		index += 4;
		mb_put_binary_int(false, genbathy->sonar_model, &buffer[index]);
		index += 4;
		mb_put_binary_long(false, genbathy->transducer_serial_number, &buffer[index]);
		index += 8;
		mb_put_binary_int(false, genbathy->number_beams, &buffer[index]);
		index += 4;
		mb_put_binary_int(false, genbathy->modeflags, &buffer[index]);
		index += 4;
		mb_put_binary_float(false, genbathy->sampling_frequency, &buffer[index]);
		index += 4;
		mb_put_binary_float(false, genbathy->acoustic_frequency, &buffer[index]);
		index += 4;
		mb_put_binary_float(false, genbathy->tx_power, &buffer[index]);
		index += 4;
		mb_put_binary_float(false, genbathy->pulse_width, &buffer[index]);
		index += 4;
		mb_put_binary_float(false, genbathy->absorption_loss, &buffer[index]);
		index += 4;
		mb_put_binary_float(false, genbathy->spreading_loss, &buffer[index]);
		index += 4;
		mb_put_binary_int(false, genbathy->sample_type, &buffer[index]);
		index += 4;
		mb_put_binary_float(false, genbathy->sound_velocity, &buffer[index]);
		index += 4;
		for (int i = 0; i < genbathy->number_beams; i++) {
			mb_put_binary_float(false, genbathy->detection_point[i], &buffer[index]);
			index += 4;
			mb_put_binary_float(false, genbathy->rx_angle[i], &buffer[index]);
			index += 4;
			mb_put_binary_int(false, genbathy->flags[i], &buffer[index]);
			index += 4;
			mb_put_binary_float(false, genbathy->backscatter[i], &buffer[index]);
			index += 4;
		}

		/* now add the checksum */
		mb_put_binary_int(false, genbathy->checksum, &buffer[index]);
		index += 4;
	}
...
int mbr_wasspenl_wr_corbathy(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error) {
	...
	*size = 100 + 32 * corbathy->num_beams;
	...
	if (status == MB_SUCCESS) {
		...
		index += 8;
		mb_put_binary_int(false, corbathy->version, &buffer[index]);
		index += 4;
		mb_put_binary_double(false, corbathy->msec, &buffer[index]);
		index += 8;
		mb_put_binary_int(false, corbathy->num_beams, &buffer[index]);
		index += 4;
		mb_put_binary_int(false, corbathy->ping_number, &buffer[index]);
		index += 4;
		mb_put_binary_double(false, corbathy->latitude, &buffer[index]);
		index += 8;
		mb_put_binary_double(false, corbathy->longitude, &buffer[index]);
		index += 8;
		mb_put_binary_float(false, corbathy->bearing, &buffer[index]);
		index += 4;
		mb_put_binary_float(false, corbathy->roll, &buffer[index]);
		index += 4;
		mb_put_binary_float(false, corbathy->pitch, &buffer[index]);
		index += 4;
		mb_put_binary_float(false, corbathy->heave, &buffer[index]);
		index += 4;
		mb_put_binary_int(false, corbathy->sample_type, &buffer[index]);
		index += 4;
		for (int i = 0; i < 5; i++) {
			mb_put_binary_int(false, corbathy->spare[i], &buffer[index]);
			index += 4;
		}
		for (int i = 0; i < corbathy->num_beams; i++) {
			mb_put_binary_int(false, corbathy->beam_index[i], &buffer[index]);
			index += 4;
			mb_put_binary_float(false, corbathy->x[i], &buffer[index]);
			index += 4;
			mb_put_binary_float(false, corbathy->y[i], &buffer[index]);
			index += 4;
			mb_put_binary_float(false, corbathy->z[i], &buffer[index]);
			index += 4;
			mb_put_binary_float(false, corbathy->beam_angle[i], &buffer[index]);
			index += 4;
			mb_put_binary_float(false, corbathy->backscatter[i], &buffer[index]);
			index += 4;
			...
			index++;
			mb_put_binary_int(false, corbathy->pad[i], &buffer[index]);
			index += 4;
		}

		/* now add the checksum */
		mb_put_binary_int(false, corbathy->checksum, &buffer[index]);
		index += 4;
	}
...
int mbr_wasspenl_wr_rawsonar(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error) {
	...
	*size = 60 + 12 * rawsonar->n + 2 * rawsonar->m * rawsonar->n;
	...
	if (status == MB_SUCCESS) {
		...
		index += 8;
		mb_put_binary_int(false, rawsonar->version, &buffer[index]);
		index += 4;
		mb_put_binary_double(false, rawsonar->msec, &buffer[index]);
		index += 8;
		mb_put_binary_int(false, rawsonar->ping_number, &buffer[index]);
		index += 4;
		mb_put_binary_float(false, rawsonar->sample_rate, &buffer[index]);
		index += 4;
		mb_put_binary_int(false, rawsonar->n, &buffer[index]);
		index += 4;
		mb_put_binary_int(false, rawsonar->m, &buffer[index]);
		index += 4;
		mb_put_binary_float(false, rawsonar->tx_power, &buffer[index]);
		index += 4;
		mb_put_binary_float(false, rawsonar->pulse_width, &buffer[index]);
		index += 4;
		mb_put_binary_int(false, rawsonar->sample_type, &buffer[index]);
		index += 4;
		for (int i = 0; i < rawsonar->n; i++) {
			mb_put_binary_int(false, rawsonar->spare[i], &buffer[index]);
			index += 4;
		}
		for (int i = 0; i < rawsonar->n; i++) {
			mb_put_binary_int(false, rawsonar->beam_index[i], &buffer[index]);
			index += 4;
		}
		for (int i = 0; i < rawsonar->n; i++) {
			mb_put_binary_int(false, rawsonar->detection_point[i], &buffer[index]);
			index += 4;
		}
		for (int i = 0; i < rawsonar->n; i++) {
			mb_put_binary_float(false, rawsonar->beam_angle[i], &buffer[index]);
			index += 4;
		}
		...
		/* now add the checksum */
		mb_put_binary_int(false, rawsonar->checksum, &buffer[index]);
		index += 4;
	}
...
int mbr_wasspenl_wr_gen_sens(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error) {
	...
	*size = 33 + gen_sens->message_length;
	...
	if (status == MB_SUCCESS) {
		...
		index += 8;
		mb_put_binary_int(false, gen_sens->version, &buffer[index]);
		index += 4;
		mb_put_binary_double(false, gen_sens->msec, &buffer[index]);
		index += 8;
		mb_put_binary_int(false, gen_sens->port_number, &buffer[index]);
		index += 4;
		...
		/* now add the checksum */
		mb_put_binary_int(false, gen_sens->checksum, &buffer[index]);
		index += 4;
	}
...
int mbr_wasspenl_wr_nvupdate(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error) {
	...
	*size = 68;
	...
	if (status == MB_SUCCESS) {
		...
		index += 8;
		mb_put_binary_int(false, nvupdate->version, &buffer[index]);
		index += 4;
		mb_put_binary_double(false, nvupdate->latitude, &buffer[index]);
		index += 8;
		mb_put_binary_double(false, nvupdate->longitude, &buffer[index]);
		index += 8;
		mb_put_binary_float(false, nvupdate->sog, &buffer[index]);
		index += 4;
		mb_put_binary_float(false, nvupdate->cog, &buffer[index]);
		index += 4;
		mb_put_binary_float(false, nvupdate->heading, &buffer[index]);
		index += 4;
		mb_put_binary_float(false, nvupdate->roll, &buffer[index]);
		index += 4;
		mb_put_binary_float(false, nvupdate->pitch, &buffer[index]);
		index += 4;
		mb_put_binary_float(false, nvupdate->heave, &buffer[index]);
		index += 4;
		mb_put_binary_float(false, nvupdate->nadir_depth, &buffer[index]);
		index += 4;

		/* now add the checksum */
		mb_put_binary_int(false, nvupdate->checksum, &buffer[index]);
		index += 4;
	}
...
int mbr_wasspenl_wr_wcd_navi(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error) {
	...
	*size = 64 + 12 * wcd_navi->num_points;
	...
	if (status == MB_SUCCESS) {
		...
		index += 8;
		mb_put_binary_int(false, wcd_navi->version, &buffer[index]);
		index += 4;
		mb_put_binary_double(false, wcd_navi->latitude, &buffer[index]);
		index += 8;
		mb_put_binary_double(false, wcd_navi->longitude, &buffer[index]);
		index += 8;
		mb_put_binary_int(false, wcd_navi->num_points, &buffer[index]);
		index += 4;
		mb_put_binary_float(false, wcd_navi->bearing, &buffer[index]);
		index += 4;
		mb_put_binary_double(false, wcd_navi->msec, &buffer[index]);
		index += 8;
		mb_put_binary_int(false, wcd_navi->ping_number, &buffer[index]);
		index += 4;
		mb_put_binary_float(false, wcd_navi->sample_rate, &buffer[index]);
		index += 4;
		for (int i = 0; i < wcd_navi->num_points; i++) {
			mb_put_binary_float(false, wcd_navi->wcdata_x[i], &buffer[index]);
			index += 4;
			mb_put_binary_float(false, wcd_navi->wcdata_y[i], &buffer[index]);
			index += 4;
			mb_put_binary_float(false, wcd_navi->wcdata_mag[i], &buffer[index]);
			index += 4;
		}

		/* now add the checksum */
		mb_put_binary_int(false, wcd_navi->checksum, &buffer[index]);
		index += 4;
	}
...
int mbr_wasspenl_wr_sensprop(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error) {
	...
	*size = 72 + 40 * sensprop->n;
	...
	if (status == MB_SUCCESS) {
		...
		index += 8;
		mb_put_binary_int(false, sensprop->version, &buffer[index]);
		index += 4;
		mb_put_binary_int(false, sensprop->flags, &buffer[index]);
		index += 4;
		mb_put_binary_float(false, sensprop->sea_level_reference, &buffer[index]);
		index += 4;
		mb_put_binary_float(false, sensprop->element_spacing, &buffer[index]);
		index += 4;
		for (int i = 0; i < 8; i++) {
			mb_put_binary_int(false, sensprop->spare[i], &buffer[index]);
			index += 4;
		}
		mb_put_binary_int(false, sensprop->n, &buffer[index]);
		index += 4;
		for (int i = 0; i < sensprop->n; i++) {
			mb_put_binary_int(false, sensprop->sensors[i].sensor_type, &buffer[index]);
			index += 4;
			mb_put_binary_int(false, sensprop->sensors[i].flags, &buffer[index]);
			index += 4;
			...
			index++;
			mb_put_binary_float(false, sensprop->sensors[i].latency, &buffer[index]);
			index += 4;
			mb_put_binary_float(false, sensprop->sensors[i].roll_bias, &buffer[index]);
			index += 4;
			mb_put_binary_float(false, sensprop->sensors[i].pitch_bias, &buffer[index]);
			index += 4;
			mb_put_binary_float(false, sensprop->sensors[i].yaw_bias, &buffer[index]);
			index += 4;
			mb_put_binary_float(false, sensprop->sensors[i].offset_x, &buffer[index]);
			index += 4;
			mb_put_binary_float(false, sensprop->sensors[i].offset_y, &buffer[index]);
			index += 4;
			mb_put_binary_float(false, sensprop->sensors[i].offset_z, &buffer[index]);
			index += 4;
		}

		/* now add the checksum */
		mb_put_binary_int(false, sensprop->checksum, &buffer[index]);
		index += 4;
	}
...
int mbr_wasspenl_wr_sys_prop(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error) {
	...
	*size = 96;
	...
	if (status == MB_SUCCESS) {
		...
		index += 8;
		mb_put_binary_int(false, sys_prop->version, &buffer[index]);
		index += 4;
		mb_put_binary_int(false, sys_prop->product_type, &buffer[index]);
		index += 4;
		mb_put_binary_int(false, sys_prop->protocol_version, &buffer[index]);
		index += 4;
		for (int i = 0; i < 4; i++) {
			mb_put_binary_int(false, sys_prop->sw_version[i], &buffer[index]);
			index += 4;
		}
		mb_put_binary_int(false, sys_prop->fw_version, &buffer[index]);
		index += 4;
		mb_put_binary_int(false, sys_prop->hw_version, &buffer[index]);
		index += 4;
		mb_put_binary_int(false, sys_prop->transducer_sn, &buffer[index]);
		index += 4;
		mb_put_binary_int(false, sys_prop->transceiver_sn, &buffer[index]);
		index += 4;
		for (int i = 0; i < 8; i++) {
			mb_put_binary_int(false, sys_prop->spare[i], &buffer[index]);
			index += 4;
		}

		/* now add the checksum */
		mb_put_binary_int(false, sys_prop->checksum, &buffer[index]);
		index += 4;
	}
...
int mbr_wasspenl_wr_mcomment(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error) {
	...
	*size = 24 + mcomment->comment_length;
	...
	if (status == MB_SUCCESS) {
		...
		index += 8;
		mb_put_binary_int(false, mcomment->comment_length, &buffer[index]);
		index += 4;
		memcpy(&buffer[index], mcomment->comment_message, (size_t)mcomment->comment_length);
		index += mcomment->comment_length;

		/* now add the checksum */
		mb_put_binary_int(false, mcomment->checksum, &buffer[index]);
		index += 4;
	}
