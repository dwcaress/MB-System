 ...
 *	$Id: mbsys_hsds.c,v 4.1 1994-04-11 23:34:41 caress Exp $
 *
...
int	*error;
{
 static char res_id[]="$Id: mbsys_hsds.c,v 4.1 1994-04-11 23:34:41 caress Exp $";
...
/*--------------------------------------------------------------------*/
int mbsys_hsds_ttimes(verbose,mbio_ptr,store_ptr,kind,
