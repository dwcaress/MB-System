 ...
 *	$Id: mbsys_hsds.c,v 4.16 2000-09-30 06:32:52 caress Exp $
 *
...
int	*error;
{
 static char res_id[]="$Id: mbsys_hsds.c,v 4.16 2000-09-30 06:32:52 caress Exp $";
...
/*--------------------------------------------------------------------*/
int mbsys_hsds_altitude(verbose,mbio_ptr,store_ptr,
