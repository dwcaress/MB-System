 ...
 *	$Id: mbr_mr1bldeo.c,v 5.1 2001-01-22 07:43:34 caress Exp $
 *
...
int mbr_info_mr1bldeo(int verbose, 
			...
			int (**copyrecord)(), 
			int *error);
int mbr_alm_mr1bldeo(int verbose, char *mbio_ptr, int *error);
int mbr_dem_mr1bldeo(int verbose, char *mbio_ptr, int *error);
int mbr_rt_mr1bldeo(int verbose, char *mbio_ptr, char *store_ptr, int *error);
int mbr_wt_mr1bldeo(int verbose, char *mbio_ptr, char *store_ptr, int *error);
...
int mbr_info_mr1bldeo(int verbose, 
			...
			int *error)
{
	static char res_id[]="$Id: mbr_mr1bldeo.c,v 5.1 2001-01-22 07:43:34 caress Exp $";
	...
	*format_alloc = &mbr_alm_mr1bldeo;
	*format_free = &mbr_dem_mr1bldeo; 
	*store_alloc = &mbsys_mr1b_alloc; 
	*store_free = &mbsys_mr1b_deall; 
	*read_ping = &mbr_rt_mr1bldeo; 
	*write_ping = &mbr_wt_mr1bldeo; 
	*extract = &mbsys_mr1b_extract; 
	*insert = &mbsys_mr1b_insert; 
	*extract_nav = &mbsys_mr1b_extract_nav; 
	*insert_nav = &mbsys_mr1b_insert_nav; 
	*extract_altitude = &mbsys_mr1b_extract_altitude; 
	*insert_altitude = NULL;
	*extract_svp = NULL; 
	*insert_svp = NULL;
	*ttimes = &mbsys_mr1b_ttimes; 
	*copyrecord = &mbsys_mr1b_copy; 
...
int mbr_alm_mr1bldeo(int verbose, char *mbio_ptr, int *error)
{
	...
	mbr_zero_mr1bldeo(verbose,data_ptr,error);
...
/*--------------------------------------------------------------------*/
int mbr_zero_mr1bldeo(int verbose, char *data_ptr, int *error)
{
	...
	data = (struct mbf_mr1bldeo_struct *) data_ptr;
...
int mbr_wt_mr1bldeo(int verbose, char *mbio_ptr, char *store_ptr, int *error)
{
	...
	status = mbr_mr1bldeo_wr_data(verbose,mbio_ptr,data_ptr,error);
...
/*--------------------------------------------------------------------*/
int mbr_mr1bldeo_rd_data(int verbose, char *mbio_ptr, int *error)
{
...
/*--------------------------------------------------------------------*/
int mbr_mr1bldeo_rd_hdr(int verbose, char *xdrs, 
...
/*--------------------------------------------------------------------*/
int mbr_mr1bldeo_rd_ping(int verbose, char *xdrs, 
...
/*--------------------------------------------------------------------*/
int mbr_mr1bldeo_wr_data(int verbose, char *mbio_ptr, char *data_ptr, int *error)
{
...
/*--------------------------------------------------------------------*/
int mbr_mr1bldeo_wr_hdr(int verbose, char *xdrs, 
...
/*--------------------------------------------------------------------*/
int mbr_mr1bldeo_wr_ping(int verbose, char *xdrs, char *data_ptr, int *error)
{
