 ...
 *	$Id: mbr_mr1bldeo.c,v 5.5 2003-04-17 21:05:23 caress Exp $
 *
...
int mbr_register_mr1bldeo(int verbose, void *mbio_ptr, 
		int *error);
...
{
	static char res_id[]="$Id: mbr_mr1bldeo.c,v 5.5 2003-04-17 21:05:23 caress Exp $";
...
/*--------------------------------------------------------------------*/
int mbr_mr1bldeo_wr_data(int verbose, void *mbio_ptr, char *data_ptr, int *error)
{
