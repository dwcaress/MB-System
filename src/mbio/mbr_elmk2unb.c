 ...
 *	$Id: mbr_elmk2unb.c,v 5.1 2001-01-22 07:43:34 caress Exp $
 *
...
int mbr_info_elmk2unb(int verbose, 
			...
			int *error)
{
	static char res_id[]="$Id: mbr_elmk2unb.c,v 5.1 2001-01-22 07:43:34 caress Exp $";
	...
	*extract_altitude = &mbsys_elacmk2_extract_altitude; 
	*insert_altitude = NULL; 
	*extract_svp = &mbsys_elacmk2_extract_svp; 
	*insert_svp = &mbsys_elacmk2_insert_svp; 
