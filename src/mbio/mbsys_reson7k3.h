...
#define R7KRECID_FileCatalogRecord 7300
...
#define R7KHDRSIZE_FileHeader 44
#define R7KRDTSIZE_FileHeader 272
#define R7KHDRSIZE_FileCatalogRecord 14
#define R7KRDTSIZE_FileCatalogRecord 48
...
} s7k3_filecatalogrecorddata;

/* Reson 7k File Catalog Record (Record 7300) */
typedef struct s7k3_FileCatalogRecord_struct {
  s7k3_header header;
...
int mbsys_reson7k3_preprocess(int verbose, void *mbio_ptr, void *store_ptr, void *platform_ptr, void *preprocess_pars_ptr,
                             int *error);
...
int mbsys_reson7k3_print_ReferencePoint(int verbosee, s7k3_ReferencePoint *ReferencePoint, int *error);
int mbsys_reson7k3_print_UncalibratedSensorOffset(int verbosee, s7k3_UncalibratedSensorOffset *UncalibratedSensorOffset, int *error);
int mbsys_reson7k3_print_CalibratedSensorOffset(int verbosee, s7k3_CalibratedSensorOffset *CalibratedSensorOffset, int *error);
int mbsys_reson7k3_print_Position(int verbosee, s7k3_Position *Position, int *error);
int mbsys_reson7k3_print_CustomAttitude(int verbosee, s7k3_CustomAttitude *CustomAttitude, int *error);
int mbsys_reson7k3_print_Tide(int verbosee, s7k3_Tide *Tide, int *error);
int mbsys_reson7k3_print_Altitude(int verbosee, s7k3_Altitude *Altitude, int *error);
int mbsys_reson7k3_print_MotionOverGround(int verbosee, s7k3_MotionOverGround *MotionOverGround, int *error);
int mbsys_reson7k3_print_Depth(int verbosee, s7k3_Depth *Depth, int *error);
int mbsys_reson7k3_print_SoundVelocityProfile(int verbosee, s7k3_SoundVelocityProfile *SoundVelocityProfile, int *error);
int mbsys_reson7k3_print_CTD(int verbosee, s7k3_CTD *CTD, int *error);
int mbsys_reson7k3_print_Geodesy(int verbosee, s7k3_Geodesy *Geodesy, int *error);
int mbsys_reson7k3_print_RollPitchHeave(int verbosee, s7k3_RollPitchHeave *RollPitchHeave, int *error);
int mbsys_reson7k3_print_Heading(int verbosee, s7k3_Heading *Heading, int *error);
int mbsys_reson7k3_print_SurveyLine(int verbosee, s7k3_SurveyLine *SurveyLine, int *error);
int mbsys_reson7k3_print_Navigation(int verbosee, s7k3_Navigation *Navigation, int *error);
int mbsys_reson7k3_print_Attitude(int verbosee, s7k3_Attitude *Attitude, int *error);
int mbsys_reson7k3_print_PanTilt(int verbosee, s7k3_PanTilt *PanTilt, int *error);
int mbsys_reson7k3_print_SonarInstallationIDs(int verbosee, s7k3_SonarInstallationIDs *SonarInstallationIDs, int *error);
int mbsys_reson7k3_print_Mystery(int verbosee, s7k3_Mystery *Mystery, int *error);
int mbsys_reson7k3_print_SonarPipeEnvironment(int verbosee, s7k3_SonarPipeEnvironment *SonarPipeEnvironment, int *error);
int mbsys_reson7k3_print_ContactOutput(int verbosee, s7k3_ContactOutput *ContactOutput, int *error);
int mbsys_reson7k3_print_ProcessedSideScan(int verbosee, s7k3_ProcessedSideScan *ProcessedSideScan, int *error);
int mbsys_reson7k3_print_SonarSettings(int verbosee, s7k3_SonarSettings *SonarSettings, int *error);
int mbsys_reson7k3_print_Configuration(int verbosee, s7k3_Configuration *Configuration, int *error);
int mbsys_reson7k3_print_MatchFilter(int verbosee, s7k3_MatchFilter *MatchFilter, int *error);
int mbsys_reson7k3_print_FirmwareHardwareConfiguration(int verbosee, s7k3_FirmwareHardwareConfiguration *FirmwareHardwareConfiguration, int *error);
int mbsys_reson7k3_print_BeamGeometry(int verbosee, s7k3_BeamGeometry *BeamGeometry, int *error);
int mbsys_reson7k3_print_Bathymetry(int verbosee, s7k3_Bathymetry *Bathymetry, int *error);
int mbsys_reson7k3_print_SideScan(int verbosee, s7k3_SideScan *SideScan, int *error);
int mbsys_reson7k3_print_WaterColumn(int verbosee, s7k3_WaterColumn *WaterColumn, int *error);
int mbsys_reson7k3_print_VerticalDepth(int verbosee, s7k3_VerticalDepth *VerticalDepth, int *error);
int mbsys_reson7k3_print_TVG(int verbosee, s7k3_TVG *TVG, int *error);
int mbsys_reson7k3_print_Image(int verbosee, s7k3_Image *Image, int *error);
int mbsys_reson7k3_print_PingMotion(int verbosee, s7k3_PingMotion *PingMotion, int *error);
int mbsys_reson7k3_print_AdaptiveGate(int verbosee, s7k3_AdaptiveGate *AdaptiveGate, int *error);
int mbsys_reson7k3_print_DetectionDataSetup(int verbosee, s7k3_DetectionDataSetup *DetectionDataSetup, int *error);
int mbsys_reson7k3_print_Beamformed(int verbosee, s7k3_Beamformed *Beamformed, int *error);
int mbsys_reson7k3_print_VernierProcessingDataRaw(int verbosee, s7k3_VernierProcessingDataRaw *VernierProcessingDataRaw, int *error);
int mbsys_reson7k3_print_BITE(int verbosee, s7k3_BITE *BITE, int *error);
int mbsys_reson7k3_print_SonarSourceVersion(int verbosee, s7k3_SonarSourceVersion *SonarSourceVersion, int *error);
int mbsys_reson7k3_print_WetEndVersion8k(int verbosee, s7k3_WetEndVersion8k *WetEndVersion8k, int *error);
int mbsys_reson7k3_print_RawDetection(int verbosee, s7k3_RawDetection *RawDetection, int *error);
int mbsys_reson7k3_print_Snippet(int verbosee, s7k3_Snippet *Snippet, int *error);
int mbsys_reson7k3_print_VernierProcessingDataFiltered(int verbosee, s7k3_VernierProcessingDataFiltered *VernierProcessingDataFiltered, int *error);
int mbsys_reson7k3_print_InstallationParameters(int verbosee, s7k3_InstallationParameters *InstallationParameters, int *error);
int mbsys_reson7k3_print_BITESummary(int verbosee, s7k3_BITESummary *BITESummary, int *error);
int mbsys_reson7k3_print_CompressedBeamformedMagnitude(int verbosee, s7k3_CompressedBeamformedMagnitude *CompressedBeamformedMagnitude, int *error);
int mbsys_reson7k3_print_CompressedWaterColumn(int verbosee, s7k3_CompressedWaterColumn *CompressedWaterColumn, int *error);
int mbsys_reson7k3_print_SegmentedRawDetection(int verbosee, s7k3_SegmentedRawDetection *SegmentedRawDetection, int *error);
int mbsys_reson7k3_print_CalibratedBeam(int verbosee, s7k3_CalibratedBeam *CalibratedBeam, int *error);
int mbsys_reson7k3_print_SystemEvents(int verbosee, s7k3_SystemEvents *SystemEvents, int *error);
int mbsys_reson7k3_print_SystemEventMessage(int verbosee, s7k3_SystemEventMessage *SystemEventMessage, int *error);
int mbsys_reson7k3_print_RDRRecordingStatus(int verbosee, s7k3_RDRRecordingStatus *RDRRecordingStatus, int *error);
int mbsys_reson7k3_print_Subscriptions(int verbosee, s7k3_Subscriptions *Subscriptions, int *error);
int mbsys_reson7k3_print_RDRStorageRecording(int verbosee, s7k3_RDRStorageRecording *RDRStorageRecording, int *error);
int mbsys_reson7k3_print_CalibrationStatus(int verbosee, s7k3_CalibrationStatus *CalibrationStatus, int *error);
int mbsys_reson7k3_print_CalibratedSideScan(int verbosee, s7k3_CalibratedSideScan *CalibratedSideScan, int *error);
int mbsys_reson7k3_print_SnippetBackscatteringStrength(int verbosee, s7k3_SnippetBackscatteringStrength *SnippetBackscatteringStrength, int *error);
int mbsys_reson7k3_print_MB2Status(int verbosee, s7k3_MB2Status *MB2Status, int *error);
int mbsys_reson7k3_print_FileHeader(int verbosee, s7k3_FileHeader *FileHeader, int *error);
int mbsys_reson7k3_print_FileCatalogRecord(int verbosee, s7k3_FileCatalogRecord *FileCatalogRecord, int *error);
int mbsys_reson7k3_print_TimeMessage(int verbosee, s7k3_TimeMessage *TimeMessage, int *error);
int mbsys_reson7k3_print_RemoteControl(int verbosee, s7k3_RemoteControl *RemoteControl, int *error);
int mbsys_reson7k3_print_RemoteControlAcknowledge(int verbosee, s7k3_RemoteControlAcknowledge *RemoteControlAcknowledge, int *error);
int mbsys_reson7k3_print_RemoteControlNotAcknowledge(int verbosee, s7k3_RemoteControlNotAcknowledge *RemoteControlNotAcknowledge, int *error);
int mbsys_reson7k3_print_RemoteControlSonarSettings(int verbosee, s7k3_RemoteControlSonarSettings *RemoteControlSonarSettings, int *error);
int mbsys_reson7k3_print_CommonSystemSettings(int verbosee, s7k3_CommonSystemSettings *CommonSystemSettings, int *error);
int mbsys_reson7k3_print_SVFiltering(int verbosee, s7k3_SVFiltering *SVFiltering, int *error);
int mbsys_reson7k3_print_SystemLockStatus(int verbosee, s7k3_SystemLockStatus *SystemLockStatus, int *error);
