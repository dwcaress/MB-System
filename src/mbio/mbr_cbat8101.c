 ...
 *	$Id: mbr_cbat8101.c,v 5.1 2001-01-22 07:43:34 caress Exp $
 *
...
int mbr_info_cbat8101(int verbose, 
			...
			int *error)
{
	static char res_id[]="$Id: mbr_cbat8101.c,v 5.1 2001-01-22 07:43:34 caress Exp $";
	...
	*format_alloc = &mbr_alm_cbat8101;
	*format_free = &mbr_dem_cbat8101; 
	*store_alloc = &mbsys_reson_alloc; 
	*store_free = &mbsys_reson_deall; 
	*read_ping = &mbr_rt_cbat8101; 
	*write_ping = &mbr_wt_cbat8101; 
	*extract = &mbsys_reson_extract; 
	*insert = &mbsys_reson_insert; 
	*extract_nav = &mbsys_reson_extract_nav; 
	*insert_nav = &mbsys_reson_insert_nav; 
	*extract_altitude = &mbsys_reson_extract_altitude; 
	*insert_altitude = NULL; 
	*extract_svp = &mbsys_reson_extract_svp; 
	*insert_svp = &mbsys_reson_insert_svp; 
	*ttimes = &mbsys_reson_ttimes; 
	*copyrecord = &mbsys_reson_copy; 
