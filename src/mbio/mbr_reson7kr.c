...
int mbr_reson7kr_chk_header(int verbose, void *mbio_ptr, char *buffer, int *recordid, int *deviceid, unsigned short *enumerator,
  ...
  /* get values to check */
  mb_get_binary_short(false, &buffer[0], &version);
  mb_get_binary_short(false, &buffer[2], &offset);
  mb_get_binary_int(false, &buffer[4], &sync);
  mb_get_binary_int(false, &buffer[8], size);
  mb_get_binary_int(false, &buffer[32], recordid);
  mb_get_binary_int(false, &buffer[36], deviceid);
  mb_get_binary_short(false, &buffer[40], &reserved);
  mb_get_binary_short(false, &buffer[42], enumerator);
...
int mbr_reson7kr_chk_pingnumber(int verbose, int recordid, char *buffer, int *ping_number) {
  ...
  if (recordid == R7KRECID_7kVolatileSonarSettings) {
    index = offset + 12;
    mb_get_binary_int(false, &buffer[index], ping_number);
    status = MB_SUCCESS;
  }
...
int mbr_reson7kr_rd_header(int verbose, char *buffer, int *index, s7k_header *header, int *error) {
  ...
  /* extract the header */
  mb_get_binary_short(false, &buffer[*index], &(header->Version));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(header->Offset));
  *index += 2;
  mb_get_binary_int(false, &buffer[*index], &(header->SyncPattern));
  *index += 4;
  mb_get_binary_int(false, &buffer[*index], &(header->Size));
  *index += 4;
  mb_get_binary_int(false, &buffer[*index], &(header->OffsetToOptionalData));
  *index += 4;
  mb_get_binary_int(false, &buffer[*index], &(header->OptionalDataIdentifier));
  *index += 4;
  mb_get_binary_short(false, &buffer[*index], &(header->s7kTime.Year));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(header->s7kTime.Day));
  *index += 2;
  mb_get_binary_float(false, &buffer[*index], &(header->s7kTime.Seconds));
  *index += 4;
  header->s7kTime.Hours = (mb_u_char)buffer[*index];
  (*index)++;
  header->s7kTime.Minutes = (mb_u_char)buffer[*index];
  (*index)++;
  mb_get_binary_short(false, &buffer[*index], &(header->Reserved));
  *index += 2;
  mb_get_binary_int(false, &buffer[*index], &(header->RecordType));
  *index += 4;
  mb_get_binary_int(false, &buffer[*index], &(header->DeviceId));
  *index += 4;

    if (header->Version == 2) {
        mb_get_binary_short(false, &buffer[*index], &(header->SystemEnumerator));
        *index += 2;
    mb_get_binary_int(false, &buffer[*index], &(header->DataSetNumber));
        *index += 4;
    mb_get_binary_int(false, &buffer[*index], &(header->RecordNumber));
        *index += 4;
    for (int i = 0; i < 8; i++) {
    ...
    for (int i = 0; i < 8; i++) {
      ...
      (*index)++;
        ...
        mb_get_binary_short(false, &buffer[*index], &(header->Flags));
        *index += 2;
        mb_get_binary_short(false, &buffer[*index], &(header->Reserved3));
        *index += 2;
        header->Reserved2 = 0;
        header->Reserved4 = 0;
        ...
        mb_get_binary_short(false, &buffer[*index], &(header->Reserved2));
        *index += 2;
        mb_get_binary_short(false, &buffer[*index], &(header->SystemEnumerator));
        *index += 2;
        mb_get_binary_int(false, &buffer[*index], &(header->RecordNumber));
        ...
        *index += 2;
        mb_get_binary_short(false, &buffer[*index], &(header->Reserved3));
        *index += 2;
    mb_get_binary_int(false, &buffer[*index], &(header->Reserved4));
    *index += 4;
    mb_get_binary_int(false, &buffer[*index], &(header->FragmentedTotal));
    *index += 4;
    mb_get_binary_int(false, &buffer[*index], &(header->FragmentNumber));
    *index += 4;
        for (int i = 0; i < 8; i++) {
            header->PreviousRecord[i] = 0;
            header->NextRecord[i] = 0;
...
int mbr_reson7kr_rd_reference(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  mb_get_binary_float(false, &buffer[index], &(reference->offset_x));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(reference->offset_y));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(reference->offset_z));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(reference->water_z));
  index += 4;
...
int mbr_reson7kr_rd_sensoruncal(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_float(false, &buffer[index], &(sensoruncal->offset_x));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(sensoruncal->offset_y));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(sensoruncal->offset_z));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(sensoruncal->offset_roll));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(sensoruncal->offset_pitch));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(sensoruncal->offset_yaw));
  index += 4;
...
int mbr_reson7kr_rd_sensorcal(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_float(false, &buffer[index], &(sensorcal->offset_x));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(sensorcal->offset_y));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(sensorcal->offset_z));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(sensorcal->offset_roll));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(sensorcal->offset_pitch));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(sensorcal->offset_yaw));
  index += 4;
...
int mbr_reson7kr_rd_position(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_int(false, &buffer[index], &(position->datum));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(position->latency));
  index += 4;
  mb_get_binary_double(false, &buffer[index], &(position->latitude));
  index += 8;
  mb_get_binary_double(false, &buffer[index], &(position->longitude));
  index += 8;
  mb_get_binary_double(false, &buffer[index], &(position->height));
  index += 8;
...
int mbr_reson7kr_rd_customattitude(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  index++;
  mb_get_binary_short(false, &buffer[index], &(customattitude->n));
  index += 2;
  mb_get_binary_float(false, &buffer[index], &(customattitude->frequency));
  index += 4;
  ...
  if (customattitude->bitfield & 1)
    for (int i = 0; i < customattitude->n; i++) {
      mb_get_binary_float(false, &buffer[index], &(customattitude->pitch[i]));
      index += 4;
    }
  if (customattitude->bitfield & 2)
    for (int i = 0; i < customattitude->n; i++) {
      mb_get_binary_float(false, &buffer[index], &(customattitude->roll[i]));
      index += 4;
    }
  if (customattitude->bitfield & 4)
    for (int i = 0; i < customattitude->n; i++) {
      mb_get_binary_float(false, &buffer[index], &(customattitude->heading[i]));
      index += 4;
    }
  if (customattitude->bitfield & 8)
    for (int i = 0; i < customattitude->n; i++) {
      mb_get_binary_float(false, &buffer[index], &(customattitude->heave[i]));
      index += 4;
    }
  if (customattitude->bitfield & 16)
    for (int i = 0; i < customattitude->n; i++) {
      mb_get_binary_float(false, &buffer[index], &(customattitude->pitchrate[i]));
      index += 4;
    }
  if (customattitude->bitfield & 32)
    for (int i = 0; i < customattitude->n; i++) {
      mb_get_binary_float(false, &buffer[index], &(customattitude->rollrate[i]));
      index += 4;
    }
  if (customattitude->bitfield & 64)
    for (int i = 0; i < customattitude->n; i++) {
      mb_get_binary_float(false, &buffer[index], &(customattitude->headingrate[i]));
      index += 4;
    }
  if (customattitude->bitfield & 128)
    for (int i = 0; i < customattitude->n; i++) {
      mb_get_binary_float(false, &buffer[index], &(customattitude->heaverate[i]));
      index += 4;
    }
...
int mbr_reson7kr_rd_tide(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_float(false, &buffer[index], &(tide->tide));
  index += 4;
  mb_get_binary_short(false, &buffer[index], &(tide->source));
  index += 2;
  tide->flags = buffer[index];
  index++;
  mb_get_binary_short(false, &buffer[index], &(tide->gauge));
  index += 2;
  mb_get_binary_int(false, &buffer[index], &(tide->datum));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(tide->latency));
  index += 4;
  mb_get_binary_double(false, &buffer[index], &(tide->latitude));
  index += 8;
  mb_get_binary_double(false, &buffer[index], &(tide->longitude));
  index += 8;
  mb_get_binary_double(false, &buffer[index], &(tide->height));
  index += 8;
...
int mbr_reson7kr_rd_altitude(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_float(false, &buffer[index], &(altitude->altitude));
  index += 4;
...
int mbr_reson7kr_rd_motion(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  index++;
  mb_get_binary_short(false, &buffer[index], &(motion->n));
  index += 2;
  mb_get_binary_float(false, &buffer[index], &(motion->frequency));
  index += 4;
  ...
  if (motion->bitfield & 1) {
    for (int i = 0; i < motion->n; i++) {
      mb_get_binary_float(false, &buffer[index], &(motion->x[i]));
      index += 4;
    }
    for (int i = 0; i < motion->n; i++) {
      mb_get_binary_float(false, &buffer[index], &(motion->y[i]));
      index += 4;
    }
    for (int i = 0; i < motion->n; i++) {
      mb_get_binary_float(false, &buffer[index], &(motion->z[i]));
      index += 4;
    }
  }
  if (motion->bitfield & 2) {
    for (int i = 0; i < motion->n; i++) {
      mb_get_binary_float(false, &buffer[index], &(motion->xa[i]));
      index += 4;
    }
    for (int i = 0; i < motion->n; i++) {
      mb_get_binary_float(false, &buffer[index], &(motion->ya[i]));
      index += 4;
    }
    for (int i = 0; i < motion->n; i++) {
      mb_get_binary_float(false, &buffer[index], &(motion->za[i]));
      index += 4;
    }
  }
...
int mbr_reson7kr_rd_depth(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  index++;
  mb_get_binary_short(false, &buffer[index], &(depth->reserved));
  index += 2;
  mb_get_binary_float(false, &buffer[index], &(depth->depth));
  index += 4;
...
int mbr_reson7kr_rd_svp(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  index++;
  mb_get_binary_short(false, &buffer[index], &(svp->reserved2));
  index += 2;
  mb_get_binary_double(false, &buffer[index], &(svp->latitude));
  index += 8;
  mb_get_binary_double(false, &buffer[index], &(svp->longitude));
  index += 8;
  mb_get_binary_int(false, &buffer[index], &(svp->n));
  index += 4;
  ...
  for (int i = 0; i < svp->n; i++) {
    mb_get_binary_float(false, &buffer[index], &(svp->depth[i]));
    index += 4;
    mb_get_binary_float(false, &buffer[index], &(svp->sound_velocity[i]));
    index += 4;
  }
...
int mbr_reson7kr_rd_ctd(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_float(false, &buffer[index], &(ctd->frequency));
  index += 4;
  ...
  index++;
  mb_get_binary_short(false, &buffer[index], &(ctd->reserved));
  index += 2;
  mb_get_binary_double(false, &buffer[index], &(ctd->latitude));
  index += 8;
  mb_get_binary_double(false, &buffer[index], &(ctd->longitude));
  index += 8;
  mb_get_binary_float(false, &buffer[index], &(ctd->sample_rate));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(ctd->n));
  index += 4;
  ...
  for (int i = 0; i < ctd->n; i++) {
    mb_get_binary_float(false, &buffer[index], &(ctd->conductivity_salinity[i]));
    index += 4;
    mb_get_binary_float(false, &buffer[index], &(ctd->temperature[i]));
    index += 4;
    mb_get_binary_float(false, &buffer[index], &(ctd->pressure_depth[i]));
    index += 4;
    mb_get_binary_float(false, &buffer[index], &(ctd->sound_velocity[i]));
    index += 4;
    mb_get_binary_float(false, &buffer[index], &(ctd->absorption[i]));
    index += 4;
  }
...
int mbr_reson7kr_rd_geodesy(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  mb_get_binary_double(false, &buffer[index], &(geodesy->semimajoraxis));
  index += 8;
  mb_get_binary_double(false, &buffer[index], &(geodesy->flattening));
  index += 8;
  for (int i = 0; i < 16; i++) {
  ...
  mb_get_binary_int(false, &buffer[index], &(geodesy->calculation_method));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(geodesy->number_parameters));
  index += 4;
  mb_get_binary_double(false, &buffer[index], &(geodesy->dx));
  index += 8;
  mb_get_binary_double(false, &buffer[index], &(geodesy->dy));
  index += 8;
  mb_get_binary_double(false, &buffer[index], &(geodesy->dz));
  index += 8;
  mb_get_binary_double(false, &buffer[index], &(geodesy->rx));
  index += 8;
  mb_get_binary_double(false, &buffer[index], &(geodesy->ry));
  index += 8;
  mb_get_binary_double(false, &buffer[index], &(geodesy->rz));
  index += 8;
  mb_get_binary_double(false, &buffer[index], &(geodesy->scale));
  index += 8;
  for (int i = 0; i < 35; i++) {
  ...
  index++;
  mb_get_binary_double(false, &buffer[index], &(geodesy->latitude_origin));
  index += 8;
  mb_get_binary_double(false, &buffer[index], &(geodesy->central_meriidan));
  index += 8;
  mb_get_binary_double(false, &buffer[index], &(geodesy->false_easting));
  index += 8;
  mb_get_binary_double(false, &buffer[index], &(geodesy->false_northing));
  index += 8;
  mb_get_binary_double(false, &buffer[index], &(geodesy->central_scale_factor));
  index += 8;
  mb_get_binary_int(false, &buffer[index], &(geodesy->custum_identifier));
  index += 4;
  for (int i = 0; i < 50; i++) {
...
int mbr_reson7kr_rd_rollpitchheave(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_float(false, &buffer[index], &(rollpitchheave->roll));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(rollpitchheave->pitch));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(rollpitchheave->heave));
  index += 4;
...
int mbr_reson7kr_rd_heading(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_float(false, &buffer[index], &(heading->heading));
  index += 4;
...
int mbr_reson7kr_rd_surveyline(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_short(false, &buffer[index], &(surveyline->n));
  index += 2;
  mb_get_binary_short(false, &buffer[index], &(surveyline->type));
  index += 2;
  mb_get_binary_float(false, &buffer[index], &(surveyline->turnradius));
  index += 4;
  for (int i = 0; i < 64; i++) {
  ...
  for (int i = 0; i < surveyline->n; i++) {
    mb_get_binary_double(false, &buffer[index], &(surveyline->latitude[i]));
    index += 8;
    mb_get_binary_double(false, &buffer[index], &(surveyline->longitude[i]));
    index += 8;
  }
...
int mbr_reson7kr_rd_navigation(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  index++;
  mb_get_binary_double(false, &buffer[index], &(navigation->latitude));
  index += 8;
  mb_get_binary_double(false, &buffer[index], &(navigation->longitude));
  index += 8;
  mb_get_binary_float(false, &buffer[index], &(navigation->position_accuracy));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(navigation->height));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(navigation->height_accuracy));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(navigation->speed));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(navigation->course));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(navigation->heading));
  index += 4;
...
int mbr_reson7kr_rd_attitude(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  for (int i = 0; i < attitude->n; i++) {
    mb_get_binary_short(false, &buffer[index], &(attitude->delta_time[i]));
    index += 2;
    mb_get_binary_float(false, &buffer[index], &(attitude->roll[i]));
    index += 4;
    mb_get_binary_float(false, &buffer[index], &(attitude->pitch[i]));
    index += 4;
    mb_get_binary_float(false, &buffer[index], &(attitude->heave[i]));
    index += 4;
    mb_get_binary_float(false, &buffer[index], &(attitude->heading[i]));
    index += 4;
  }
...
int mbr_reson7kr_rd_fsdwchannel(int verbose, int data_format, char *buffer, int *index, s7k_fsdwchannel *fsdwchannel,
  ...
  mb_get_binary_int(false, &buffer[*index], &(fsdwchannel->number_samples));
  *index += 4;
  mb_get_binary_int(false, &buffer[*index], &(fsdwchannel->start_time));
  *index += 4;
  mb_get_binary_int(false, &buffer[*index], &(fsdwchannel->sample_interval));
  *index += 4;
  mb_get_binary_float(false, &buffer[*index], &(fsdwchannel->range));
  *index += 4;
  mb_get_binary_float(false, &buffer[*index], &(fsdwchannel->voltage));
  *index += 4;
  for (int i = 0; i < 16; i++) {
  ...
  if (status == MB_SUCCESS) {
    if (fsdwchannel->bytespersample == 1) {
      ...
      for (int i = 0; i < fsdwchannel->number_samples; i++) {
        ...
        mb_get_binary_short(false, &(buffer[*index]), &(shortptr[i]));
        *index += 2;
      ...
      for (int i = 0; i < fsdwchannel->number_samples; i++) {
        /*srptr = (short *) &(buffer[*index]);
        urptr = (unsigned short *) &(buffer[*index]);*/
        mb_get_binary_short(false, &(buffer[*index]), &(shortptr[2 * i]));
        *index += 2;
        ...
        srptr = (short *) &(buffer[*index]);
        urptr = (unsigned short *) &(buffer[*index]);*/
        mb_get_binary_short(false, &(buffer[*index]), &(shortptr[2 * i + 1]));
        *index += 2;
...
int mbr_reson7kr_rd_fsdwssheader(int verbose, char *buffer, int *index, s7k_fsdwssheader *fsdwssheader, int *error) {
  ...
  mb_get_binary_short(false, &buffer[*index], &(fsdwssheader->subsystem));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwssheader->channelNum));
  *index += 2;
  mb_get_binary_int(false, &buffer[*index], &(fsdwssheader->pingNum));
  *index += 4;
  mb_get_binary_short(false, &buffer[*index], &(fsdwssheader->packetNum));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwssheader->trigSource));
  *index += 2;
  mb_get_binary_int(false, &buffer[*index], &(fsdwssheader->samples));
  *index += 4;
  mb_get_binary_int(false, &buffer[*index], &(fsdwssheader->sampleInterval));
  *index += 4;
  mb_get_binary_int(false, &buffer[*index], &(fsdwssheader->startDepth));
  *index += 4;
  mb_get_binary_short(false, &buffer[*index], &(fsdwssheader->weightingFactor));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwssheader->ADCGain));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwssheader->ADCMax));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwssheader->rangeSetting));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwssheader->pulseID));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwssheader->markNumber));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwssheader->dataFormat));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwssheader->reserved));
  *index += 2;
  mb_get_binary_int(false, &buffer[*index], &(fsdwssheader->millisecondsToday));
  *index += 4;
  mb_get_binary_short(false, &buffer[*index], &(fsdwssheader->year));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwssheader->day));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwssheader->hour));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwssheader->minute));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwssheader->second));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwssheader->heading));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwssheader->pitch));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwssheader->roll));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwssheader->heave));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwssheader->yaw));
  *index += 2;
  mb_get_binary_int(false, &buffer[*index], &(fsdwssheader->depth));
  *index += 4;
  mb_get_binary_short(false, &buffer[*index], &(fsdwssheader->temperature));
  *index += 2;
  for (int i = 0; i < 2; i++) {
    fsdwssheader->reserved2[i] = buffer[*index];
    (*index)++;
  }
  mb_get_binary_int(false, &buffer[*index], &(fsdwssheader->longitude));
  *index += 4;
  mb_get_binary_int(false, &buffer[*index], &(fsdwssheader->latitude));
  *index += 4;
...
int mbr_reson7kr_rd_fsdwsegyheader(int verbose, char *buffer, int *index, s7k_fsdwsegyheader *fsdwsegyheader, int *error) {
  ...
  mb_get_binary_int(false, &buffer[*index], &(fsdwsegyheader->sequenceNumber));
  *index += 4;
  mb_get_binary_int(false, &buffer[*index], &(fsdwsegyheader->startDepth));
  *index += 4;
  mb_get_binary_int(false, &buffer[*index], &(fsdwsegyheader->pingNum));
  *index += 4;
  mb_get_binary_int(false, &buffer[*index], &(fsdwsegyheader->channelNum));
  *index += 4;
  for (int i = 0; i < 6; i++) {
    mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->unused1[i]));
    *index += 2;
  }
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->traceIDCode));
  *index += 2;
  for (int i = 0; i < 2; i++) {
    mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->unused2[i]));
    *index += 2;
  }
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->dataFormat));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->NMEAantennaeR));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->NMEAantennaeO));
  *index += 2;
  for (int i = 0; i < 32; i++) {
    fsdwsegyheader->RS232[i] = buffer[*index];
    (*index)++;
  }
  mb_get_binary_int(false, &buffer[*index], &(fsdwsegyheader->sourceCoordX));
  *index += 4;
  mb_get_binary_int(false, &buffer[*index], &(fsdwsegyheader->sourceCoordY));
  *index += 4;
  mb_get_binary_int(false, &buffer[*index], &(fsdwsegyheader->groupCoordX));
  *index += 4;
  mb_get_binary_int(false, &buffer[*index], &(fsdwsegyheader->groupCoordY));
  *index += 4;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->coordUnits));
  *index += 2;
  for (int i = 0; i < 24; i++) {
    fsdwsegyheader->annotation[i] = buffer[*index];
    (*index)++;
  }
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->samples));
  *index += 2;
  mb_get_binary_int(false, &buffer[*index], &(fsdwsegyheader->sampleInterval));
  *index += 4;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->ADCGain));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->pulsePower));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->correlated));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->startFreq));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->endFreq));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->sweepLength));
  *index += 2;
  for (int i = 0; i < 4; i++) {
    mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->unused7[i]));
    *index += 2;
  }
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->aliasFreq));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->pulseID));
  *index += 2;
  for (int i = 0; i < 6; i++) {
    mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->unused8[i]));
    *index += 2;
  }
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->year));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->day));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->hour));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->minute));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->second));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->timeBasis));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->weightingFactor));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->unused9));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->heading));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->pitch));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->roll));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->temperature));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->heaveCompensation));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->trigSource));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->markNumber));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->NMEAHour));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->NMEAMinutes));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->NMEASeconds));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->NMEACourse));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->NMEASpeed));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->NMEADay));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->NMEAYear));
  *index += 2;
  mb_get_binary_int(false, &buffer[*index], &(fsdwsegyheader->millisecondsToday));
  *index += 4;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->ADCMax));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->calConst));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->vehicleID));
  *index += 2;
  for (int i = 0; i < 6; i++) {
    fsdwsegyheader->softwareVersion[i] = buffer[*index];
    (*index)++;
  }
  mb_get_binary_int(false, &buffer[*index], &(fsdwsegyheader->sphericalCorrection));
  *index += 4;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->packetNum));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->ADCDecimation));
  *index += 2;
  mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->decimation));
  *index += 2;
  for (int i = 0; i < 7; i++) {
    mb_get_binary_short(false, &buffer[*index], &(fsdwsegyheader->unuseda[i]));
    *index += 2;
  }
...
int mbr_reson7kr_rd_fsdwsslo(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_int(false, &buffer[index], &(fsdwsslo->msec_timestamp));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(fsdwsslo->ping_number));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(fsdwsslo->number_channels));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(fsdwsslo->total_bytes));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(fsdwsslo->data_format));
  index += 4;
  index += 12;
  for (int i = 0; i < 2; i++) {
...
int mbr_reson7kr_rd_fsdwsshi(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_int(false, &buffer[index], &(fsdwsshi->msec_timestamp));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(fsdwsshi->ping_number));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(fsdwsshi->number_channels));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(fsdwsshi->total_bytes));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(fsdwsshi->data_format));
  index += 4;
  index += 12;
  for (int i = 0; i < 2; i++) {
...
int mbr_reson7kr_rd_fsdwsb(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_int(false, &buffer[index], &(fsdwsb->msec_timestamp));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(fsdwsb->ping_number));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(fsdwsb->number_channels));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(fsdwsb->total_bytes));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(fsdwsb->data_format));
  index += 4;
  index += 12;
...
int mbr_reson7kr_rd_bluefin(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  index = header->Offset + 4;
  mb_get_binary_int(false, &buffer[index], &(bluefin->msec_timestamp));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(bluefin->number_frames));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(bluefin->frame_size));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(bluefin->data_format));
  index += 4;
  for (int i = 0; i < 16; i++) {
...
/* print out the results */
  ...
  if (bluefin->data_format == R7KRECID_BluefinNav) {
    for (int i = 0; i < bluefin->number_frames; i++) {
      mb_get_binary_int(false, &buffer[index], &(bluefin->nav[i].packet_size));
      index += 4;
      mb_get_binary_short(false, &buffer[index], &(bluefin->nav[i].version));
      index += 2;
      mb_get_binary_short(false, &buffer[index], &(bluefin->nav[i].offset));
      index += 2;
      mb_get_binary_int(false, &buffer[index], &(bluefin->nav[i].data_type));
      index += 4;
      mb_get_binary_int(false, &buffer[index], &(bluefin->nav[i].data_size));
      index += 4;
      mb_get_binary_short(false, &buffer[index], &(bluefin->nav[i].s7kTime.Year));
      index += 2;
      mb_get_binary_short(false, &buffer[index], &(bluefin->nav[i].s7kTime.Day));
      index += 2;
      mb_get_binary_float(false, &buffer[index], &(bluefin->nav[i].s7kTime.Seconds));
      index += 4;
      bluefin->nav[i].s7kTime.Hours = (mb_u_char)buffer[index];
      (index)++;
      bluefin->nav[i].s7kTime.Minutes = (mb_u_char)buffer[index];
      (index)++;
      mb_get_binary_int(false, &buffer[index], &(bluefin->nav[i].checksum));
      index += 4;
      mb_get_binary_short(false, &buffer[index], &(bluefin->nav[i].timedelay));
      index += 2;
      mb_get_binary_int(false, &buffer[index], &(bluefin->nav[i].quality));
      index += 4;
      mb_get_binary_double(false, &buffer[index], &(bluefin->nav[i].latitude));
      index += 8;
      mb_get_binary_double(false, &buffer[index], &(bluefin->nav[i].longitude));
      index += 8;
      mb_get_binary_float(false, &buffer[index], &(bluefin->nav[i].speed));
      index += 4;
      mb_get_binary_double(false, &buffer[index], &(bluefin->nav[i].depth));
      index += 8;
      mb_get_binary_double(false, &buffer[index], &(bluefin->nav[i].altitude));
      index += 8;
      mb_get_binary_float(false, &buffer[index], &(bluefin->nav[i].roll));
      index += 4;
      mb_get_binary_float(false, &buffer[index], &(bluefin->nav[i].pitch));
      index += 4;
      mb_get_binary_float(false, &buffer[index], &(bluefin->nav[i].yaw));
      index += 4;
      mb_get_binary_float(false, &buffer[index], &(bluefin->nav[i].northing_rate));
      index += 4;
      mb_get_binary_float(false, &buffer[index], &(bluefin->nav[i].easting_rate));
      index += 4;
      mb_get_binary_float(false, &buffer[index], &(bluefin->nav[i].depth_rate));
      index += 4;
      mb_get_binary_float(false, &buffer[index], &(bluefin->nav[i].altitude_rate));
      index += 4;
      mb_get_binary_float(false, &buffer[index], &(bluefin->nav[i].roll_rate));
      index += 4;
      mb_get_binary_float(false, &buffer[index], &(bluefin->nav[i].pitch_rate));
      index += 4;
      mb_get_binary_float(false, &buffer[index], &(bluefin->nav[i].yaw_rate));
      index += 4;
      mb_get_binary_double(false, &buffer[index], &(bluefin->nav[i].position_time));
      index += 8;
      mb_get_binary_double(false, &buffer[index], &(bluefin->nav[i].depth_time));
      index += 8;
/*
...
/* get the time  */
    ...
    for (int i = 0; i < bluefin->number_frames; i++) {
      mb_get_binary_int(false, &buffer[index], &(bluefin->environmental[i].packet_size));
      index += 4;
      mb_get_binary_short(false, &buffer[index], &(bluefin->environmental[i].version));
      index += 2;
      mb_get_binary_short(false, &buffer[index], &(bluefin->environmental[i].offset));
      index += 2;
      mb_get_binary_int(false, &buffer[index], &(bluefin->environmental[i].data_type));
      index += 4;
      mb_get_binary_int(false, &buffer[index], &(bluefin->environmental[i].data_size));
      index += 4;
      mb_get_binary_short(false, &buffer[index], &(bluefin->environmental[i].s7kTime.Year));
      index += 2;
      mb_get_binary_short(false, &buffer[index], &(bluefin->environmental[i].s7kTime.Day));
      index += 2;
      mb_get_binary_float(false, &buffer[index], &(bluefin->environmental[i].s7kTime.Seconds));
      index += 4;
      ...
      (index)++;
      mb_get_binary_int(false, &buffer[index], &(bluefin->environmental[i].checksum));
      index += 4;
      mb_get_binary_short(false, &buffer[index], &(bluefin->environmental[i].reserved1));
      index += 2;
      mb_get_binary_int(false, &buffer[index], &(bluefin->environmental[i].quality));
      index += 4;
      mb_get_binary_float(false, &buffer[index], &(bluefin->environmental[i].sound_speed));
      index += 4;
      mb_get_binary_float(false, &buffer[index], &(bluefin->environmental[i].conductivity));
      index += 4;
      mb_get_binary_float(false, &buffer[index], &(bluefin->environmental[i].temperature));
      index += 4;
      mb_get_binary_float(false, &buffer[index], &(bluefin->environmental[i].pressure));
      index += 4;
      mb_get_binary_float(false, &buffer[index], &(bluefin->environmental[i].salinity));
      index += 4;
      mb_get_binary_double(false, &buffer[index], &(bluefin->environmental[i].ctd_time));
      index += 8;
      mb_get_binary_double(false, &buffer[index], &(bluefin->environmental[i].temperature_time));
      index += 8;
      mb_get_binary_double(false, &buffer[index], &(bluefin->environmental[i].surface_pressure));
      index += 8;
      mb_get_binary_int(false, &buffer[index], &(bluefin->environmental[i].temperature_counts));
      index += 4;
      mb_get_binary_float(false, &buffer[index], &(bluefin->environmental[i].conductivity_frequency));
      index += 4;
      mb_get_binary_int(false, &buffer[index], &(bluefin->environmental[i].pressure_counts));
      index += 4;
      mb_get_binary_float(false, &buffer[index], &(bluefin->environmental[i].pressure_comp_voltage));
      index += 4;
      mb_get_binary_int(false, &buffer[index], &(bluefin->environmental[i].sensor_time_sec));
      index += 4;
      mb_get_binary_int(false, &buffer[index], &(bluefin->environmental[i].sensor_time_nsec));
      index += 4;
      mb_get_binary_short(false, &buffer[index], &(bluefin->environmental[i].sensor1));
      index += 2;
      mb_get_binary_short(false, &buffer[index], &(bluefin->environmental[i].sensor2));
      index += 2;
      mb_get_binary_short(false, &buffer[index], &(bluefin->environmental[i].sensor3));
      index += 2;
      mb_get_binary_short(false, &buffer[index], &(bluefin->environmental[i].sensor4));
      index += 2;
      mb_get_binary_short(false, &buffer[index], &(bluefin->environmental[i].sensor5));
      index += 2;
      mb_get_binary_short(false, &buffer[index], &(bluefin->environmental[i].sensor6));
      index += 2;
      mb_get_binary_short(false, &buffer[index], &(bluefin->environmental[i].sensor7));
      index += 2;
      mb_get_binary_short(false, &buffer[index], &(bluefin->environmental[i].sensor8));
      index += 2;
      for (int j = 0; j < 8; j++) {
...
int mbr_reson7kr_rd_processedsidescan(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_long(false, &buffer[index], &(processedsidescan->serial_number));
  index += 8;
  mb_get_binary_int(false, &buffer[index], &(processedsidescan->ping_number));
  index += 4;
  mb_get_binary_short(false, &buffer[index], &(processedsidescan->multi_ping));
  index += 2;
  mb_get_binary_short(false, &buffer[index], &(processedsidescan->recordversion));
  index += 2;
  mb_get_binary_int(false, &buffer[index], &(processedsidescan->ss_source));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(processedsidescan->number_pixels));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(processedsidescan->ss_type));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(processedsidescan->pixelwidth));
  index += 4;
  mb_get_binary_double(false, &buffer[index], &(processedsidescan->sonardepth));
  index += 8;
  mb_get_binary_double(false, &buffer[index], &(processedsidescan->altitude));
  index += 8;

  /* extract the data */
  for (int i = 0; i < processedsidescan->number_pixels; i++) {
    mb_get_binary_float(false, &buffer[index], &(processedsidescan->sidescan[i]));
    index += 4;
  }
  for (int i = 0; i < processedsidescan->number_pixels; i++) {
    mb_get_binary_float(false, &buffer[index], &(processedsidescan->alongtrack[i]));
    index += 4;
  }
...
int mbr_reson7kr_rd_volatilesonarsettings(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_long(false, &buffer[index], &(volatilesettings->serial_number));
  index += 8;
  mb_get_binary_int(false, &buffer[index], &(volatilesettings->ping_number));
  index += 4;
  mb_get_binary_short(false, &buffer[index], &(volatilesettings->multi_ping));
  index += 2;
  mb_get_binary_float(false, &buffer[index], &(volatilesettings->frequency));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(volatilesettings->sample_rate));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(volatilesettings->receiver_bandwidth));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(volatilesettings->pulse_width));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(volatilesettings->pulse_type));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(volatilesettings->pulse_envelope));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(volatilesettings->pulse_envelope_par));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(volatilesettings->pulse_reserved));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(volatilesettings->max_ping_rate));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(volatilesettings->ping_period));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(volatilesettings->range_selection));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(volatilesettings->power_selection));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(volatilesettings->gain_selection));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(volatilesettings->control_flags));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(volatilesettings->projector_magic_no));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(volatilesettings->steering_vertical));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(volatilesettings->steering_horizontal));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(volatilesettings->beamwidth_vertical));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(volatilesettings->beamwidth_horizontal));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(volatilesettings->focal_point));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(volatilesettings->projector_weighting));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(volatilesettings->projector_weighting_par));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(volatilesettings->transmit_flags));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(volatilesettings->hydrophone_magic_no));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(volatilesettings->receive_weighting));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(volatilesettings->receive_weighting_par));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(volatilesettings->receive_flags));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(volatilesettings->receive_width));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(volatilesettings->range_minimum));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(volatilesettings->range_maximum));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(volatilesettings->depth_minimum));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(volatilesettings->depth_maximum));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(volatilesettings->absorption));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(volatilesettings->sound_velocity));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(volatilesettings->spreading));
  index += 4;
  mb_get_binary_short(false, &buffer[index], &(volatilesettings->reserved));
  index += 2;
...
int mbr_reson7kr_rd_configuration(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_long(false, &buffer[index], &(configuration->serial_number));
  index += 8;
  mb_get_binary_int(false, &buffer[index], &(configuration->number_devices));
  index += 4;

  /* extract the data for each device */
  for (int i = 0; i < configuration->number_devices; i++) {
    device = &(configuration->device[i]);
    mb_get_binary_int(false, &buffer[index], &(device->magic_number));
    index += 4;
    for (int j = 0; j < 64; j++) {
      device->description[j] = buffer[index];
      index++;
    }
    mb_get_binary_long(false, &buffer[index], &(device->serial_number));
    index += 8;
    mb_get_binary_int(false, &buffer[index], &(device->info_length));
    index += 4;
...
int mbr_reson7kr_rd_matchfilter(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_long(false, &buffer[index], &(matchfilter->serial_number));
  index += 8;
  mb_get_binary_int(false, &buffer[index], &(matchfilter->ping_number));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(matchfilter->operation));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(matchfilter->start_frequency));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(matchfilter->end_frequency));
  index += 4;
...
int mbr_reson7kr_rd_v2firmwarehardwareconfiguration(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_int(false, &buffer[index], &(v2firmwarehardwareconfiguration->device_count));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(v2firmwarehardwareconfiguration->info_length));
  index += 4;
...
int mbr_reson7kr_rd_beamgeometry(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_long(false, &buffer[index], &(beamgeometry->serial_number));
  index += 8;
  mb_get_binary_int(false, &buffer[index], &(beamgeometry->number_beams));
  index += 4;

  /* extract the data */
  for (int i = 0; i < beamgeometry->number_beams; i++) {
    mb_get_binary_float(false, &buffer[index], &(beamgeometry->angle_alongtrack[i]));
    index += 4;
  }
  for (int i = 0; i < beamgeometry->number_beams; i++) {
    mb_get_binary_float(false, &buffer[index], &(beamgeometry->angle_acrosstrack[i]));
    index += 4;
  }
  for (int i = 0; i < beamgeometry->number_beams; i++) {
    mb_get_binary_float(false, &buffer[index], &(beamgeometry->beamwidth_alongtrack[i]));
    index += 4;
  }
  for (int i = 0; i < beamgeometry->number_beams; i++) {
    mb_get_binary_float(false, &buffer[index], &(beamgeometry->beamwidth_acrosstrack[i]));
    index += 4;
  }
...
int mbr_reson7kr_rd_calibration(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_long(false, &buffer[index], &(calibration->serial_number));
  index += 8;
  mb_get_binary_short(false, &buffer[index], &(calibration->number_channels));
  index += 2;

  /* extract the data */
  for (int i = 0; i < calibration->number_channels; i++) {
    mb_get_binary_float(false, &buffer[index], &(calibration->gain[i]));
    index += 4;
  }
  for (int i = 0; i < calibration->number_channels; i++) {
    mb_get_binary_float(false, &buffer[index], &(calibration->phase[i]));
    index += 4;
  }
...
int mbr_reson7kr_rd_bathymetry(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_long(false, &buffer[index], &(bathymetry->serial_number));
  index += 8;
  mb_get_binary_int(false, &buffer[index], &(bathymetry->ping_number));
  index += 4;
  mb_get_binary_short(false, &buffer[index], &(bathymetry->multi_ping));
  index += 2;
  mb_get_binary_int(false, &buffer[index], &(bathymetry->number_beams));
  index += 4;
  ...
  if (header->Version >= 5) {
    ...
    index++;
    mb_get_binary_float(false, &buffer[index], &(bathymetry->sound_velocity));
    index += 4;
  }
  else {
  ...
  for (int i = 0; i < bathymetry->number_beams; i++) {
    mb_get_binary_float(false, &buffer[index], &(bathymetry->range[i]));
    index += 4;
  }
  for (int i = 0; i < bathymetry->number_beams; i++) {
  ...
  for (int i = 0; i < bathymetry->number_beams; i++) {
    mb_get_binary_float(false, &buffer[index], &(bathymetry->intensity[i]));
    index += 4;
  }
  if ((header->OffsetToOptionalData == 0 && header->Size >= 92 + 17 * bathymetry->number_beams) ||
    ...
    for (int i = 0; i < bathymetry->number_beams; i++) {
      mb_get_binary_float(false, &buffer[index], &(bathymetry->min_depth_gate[i]));
      index += 4;
    }
    for (int i = 0; i < bathymetry->number_beams; i++) {
      mb_get_binary_float(false, &buffer[index], &(bathymetry->max_depth_gate[i]));
      index += 4;
    }
  }
  ...
  if (header->OffsetToOptionalData > 0) {
    ...
    mb_get_binary_float(false, &buffer[index], &(bathymetry->frequency));
    index += 4;
    mb_get_binary_double(false, &buffer[index], &(bathymetry->latitude));
    index += 8;
    mb_get_binary_double(false, &buffer[index], &(bathymetry->longitude));
    index += 8;
    mb_get_binary_float(false, &buffer[index], &(bathymetry->heading));
    index += 4;
    bathymetry->height_source = buffer[index];
    index++;
    mb_get_binary_float(false, &buffer[index], &(bathymetry->tide));
    index += 4;
    mb_get_binary_float(false, &buffer[index], &(bathymetry->roll));
    index += 4;
    mb_get_binary_float(false, &buffer[index], &(bathymetry->pitch));
    index += 4;
    mb_get_binary_float(false, &buffer[index], &(bathymetry->heave));
    index += 4;
    mb_get_binary_float(false, &buffer[index], &(bathymetry->vehicle_height));
    index += 4;
    for (int i = 0; i < bathymetry->number_beams; i++) {
      mb_get_binary_float(false, &buffer[index], &(bathymetry->depth[i]));
      index += 4;
      mb_get_binary_float(false, &buffer[index], &(bathymetry->alongtrack[i]));
      index += 4;
      mb_get_binary_float(false, &buffer[index], &(bathymetry->acrosstrack[i]));
      index += 4;
      mb_get_binary_float(false, &buffer[index], &(bathymetry->pointing_angle[i]));
      index += 4;
      mb_get_binary_float(false, &buffer[index], &(bathymetry->azimuth_angle[i]));
      index += 4;
    }
...
int mbr_reson7kr_rd_backscatter(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_long(false, &buffer[index], &(backscatter->serial_number));
  index += 8;
  mb_get_binary_int(false, &buffer[index], &(backscatter->ping_number));
  index += 4;
  mb_get_binary_short(false, &buffer[index], &(backscatter->multi_ping));
  index += 2;
  mb_get_binary_float(false, &buffer[index], &(backscatter->beam_position));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(backscatter->control_flags));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(backscatter->number_samples));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(backscatter->port_beamwidth_x));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(backscatter->port_beamwidth_y));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(backscatter->stbd_beamwidth_x));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(backscatter->stbd_beamwidth_y));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(backscatter->port_steering_x));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(backscatter->port_steering_y));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(backscatter->stbd_steering_x));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(backscatter->stbd_steering_y));
  index += 4;
  mb_get_binary_short(false, &buffer[index], &(backscatter->number_beams));
  index += 2;
  mb_get_binary_short(false, &buffer[index], &(backscatter->current_beam));
  index += 2;
  ...
  if (backscatter->sample_size == 1) {
    ...
    for (int i = 0; i < backscatter->number_samples; i++) {
      mb_get_binary_short(false, &buffer[index], &(short_ptr[i]));
      index += 2;
    }
    ...
    for (int i = 0; i < backscatter->number_samples; i++) {
      mb_get_binary_int(false, &buffer[index], &(int_ptr[i]));
      index += 4;
    }
  ...
  if (header->OffsetToOptionalData > 0) {
    ...
    mb_get_binary_float(false, &buffer[index], &(backscatter->frequency));
    index += 4;
    mb_get_binary_double(false, &buffer[index], &(backscatter->latitude));
    index += 8;
    mb_get_binary_double(false, &buffer[index], &(backscatter->longitude));
    index += 8;
    mb_get_binary_float(false, &buffer[index], &(backscatter->heading));
    index += 4;
    mb_get_binary_float(false, &buffer[index], &(backscatter->altitude));
    index += 4;
  }
  else {
...
int mbr_reson7kr_rd_beam(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_long(false, &buffer[index], &(beam->serial_number));
  index += 8;
  mb_get_binary_int(false, &buffer[index], &(beam->ping_number));
  index += 4;
  mb_get_binary_short(false, &buffer[index], &(beam->multi_ping));
  index += 2;
  mb_get_binary_short(false, &buffer[index], &(beam->number_beams));
  index += 2;
  mb_get_binary_short(false, &buffer[index], &(beam->reserved));
  index += 2;
  mb_get_binary_int(false, &buffer[index], &(beam->number_samples));
  index += 4;
  beam->record_subset_flag = buffer[index];
  index++;
  beam->row_column_flag = buffer[index];
  index++;
  mb_get_binary_short(false, &buffer[index], &(beam->sample_header_id));
  index += 2;
  mb_get_binary_int(false, &buffer[index], &(beam->sample_type));
  index += 4;
  ...
  for (int i = 0; i < beam->number_beams; i++) {
    ...
    mb_get_binary_short(false, &buffer[index], &(snippet->beam_number));
    index += 2;
    mb_get_binary_int(false, &buffer[index], &(snippet->begin_sample));
    index += 4;
    mb_get_binary_int(false, &buffer[index], &(snippet->end_sample));
    index += 4;
  }
    ...
    if (status == MB_SUCCESS) {
      ...
      for (int j = 0; j < nsamples; j++) {
        if (sample_type_amp == 1) {
          ...
          mb_get_binary_short(false, &buffer[index], &(ushortptr[j]));
          index += 2;
        }
        else if (sample_type_amp == 3) {
          uintptr = (unsigned int *)snippet->amplitude;
          mb_get_binary_int(false, &buffer[index], &(uintptr[j]));
          index += 4;
        }
        if (sample_type_phase == 1) {
        ...
        if (sample_type_iandq == 1) {
          ...
          mb_get_binary_short(false, &buffer[index], &(shortptramp[j]));
          index += 2;
          mb_get_binary_short(false, &buffer[index], &(shortptrphase[j]));
          index += 2;
        }
        else if (sample_type_iandq == 2) {
          intptramp = (int *)snippet->amplitude;
          intptrphase = (int *)snippet->phase;
          mb_get_binary_int(false, &buffer[index], &(intptramp[j]));
          index += 4;
          mb_get_binary_int(false, &buffer[index], &(intptrphase[j]));
          index += 4;
        }
      }
    }
...
int mbr_reson7kr_rd_verticaldepth(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_float(false, &buffer[index], &(verticaldepth->frequency));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(verticaldepth->ping_number));
  index += 4;
  mb_get_binary_short(false, &buffer[index], &(verticaldepth->multi_ping));
  index += 2;
  mb_get_binary_double(false, &buffer[index], &(verticaldepth->latitude));
  index += 8;
  mb_get_binary_double(false, &buffer[index], &(verticaldepth->longitude));
  index += 8;
  mb_get_binary_float(false, &buffer[index], &(verticaldepth->heading));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(verticaldepth->alongtrack));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(verticaldepth->acrosstrack));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(verticaldepth->vertical_depth));
  index += 4;
...
int mbr_reson7kr_rd_tvg(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_long(false, &buffer[index], &(tvg->serial_number));
  index += 8;
  mb_get_binary_int(false, &buffer[index], &(tvg->ping_number));
  index += 4;
  mb_get_binary_short(false, &buffer[index], &(tvg->multi_ping));
  index += 2;
  mb_get_binary_int(false, &buffer[index], &(tvg->n));
  index += 4;
  for (int i = 0; i < 8; i++) {
    mb_get_binary_int(false, &buffer[index], &(tvg->reserved[i]));
    index += 4;
  }
...
int mbr_reson7kr_rd_image(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_int(false, &buffer[index], &(image->ping_number));
  index += 4;
  mb_get_binary_short(false, &buffer[index], &(image->multi_ping));
  index += 2;
  mb_get_binary_int(false, &buffer[index], &(image->width));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(image->height));
  index += 4;
  mb_get_binary_short(false, &buffer[index], &(image->color_depth));
  index += 2;
  mb_get_binary_short(false, &buffer[index], &(image->width_height_flag));
  index += 2;
  mb_get_binary_short(false, &buffer[index], &(image->compression));
  index += 2;
  ...
  if (image->color_depth == 1) {
    ...
    for (int i = 0; i < image->width * image->height; i++) {
      mb_get_binary_short(false, &buffer[index], &(ushortptr[i]));
      index += 2;
    }
  }
    ...
    for (int i = 0; i < image->width * image->height; i++) {
      mb_get_binary_int(false, &buffer[index], &(uintptr[i]));
      index += 4;
    }
  }
...
int mbr_reson7kr_rd_v2pingmotion(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_long(false, &buffer[index], &(v2pingmotion->serial_number));
  index += 8;
  mb_get_binary_int(false, &buffer[index], &(v2pingmotion->ping_number));
  index += 4;
  mb_get_binary_short(false, &buffer[index], &(v2pingmotion->multi_ping));
  index += 2;
  mb_get_binary_int(false, &buffer[index], &(v2pingmotion->n));
  index += 4;
  mb_get_binary_short(false, &buffer[index], &(v2pingmotion->flags));
  index += 2;
  mb_get_binary_int(false, &buffer[index], &(v2pingmotion->error_flags));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(v2pingmotion->frequency));
  index += 4;
  if (v2pingmotion->flags & 1) {
    mb_get_binary_float(false, &buffer[index], &(v2pingmotion->pitch));
    index += 4;
  }
  ...
  if (v2pingmotion->flags & 2) {
    for (int i = 0; i < v2pingmotion->n; i++) {
      mb_get_binary_float(false, &buffer[index], &(v2pingmotion->roll[i]));
      index += 4;
    }
  }
  else {
  ...
  if (v2pingmotion->flags & 4) {
    for (int i = 0; i < v2pingmotion->n; i++) {
      mb_get_binary_float(false, &buffer[index], &(v2pingmotion->heading[i]));
      index += 4;
    }
  }
  else {
  ...
  if (v2pingmotion->flags & 8) {
    for (int i = 0; i < v2pingmotion->n; i++) {
      mb_get_binary_float(false, &buffer[index], &(v2pingmotion->heave[i]));
      index += 4;
    }
  }
  else {
...
int mbr_reson7kr_rd_v2detectionsetup(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_long(false, &buffer[index], &(v2detectionsetup->serial_number));
  index += 8;
  mb_get_binary_int(false, &buffer[index], &(v2detectionsetup->ping_number));
  index += 4;
  mb_get_binary_short(false, &buffer[index], &(v2detectionsetup->multi_ping));
  index += 2;
  mb_get_binary_int(false, &buffer[index], &(v2detectionsetup->number_beams));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(v2detectionsetup->data_field_size));
  index += 4;
  v2detectionsetup->detection_algorithm = buffer[index];
  index++;
  mb_get_binary_int(false, &buffer[index], &(v2detectionsetup->detection_flags));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(v2detectionsetup->minimum_depth));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(v2detectionsetup->maximum_depth));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(v2detectionsetup->minimum_range));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(v2detectionsetup->maximum_range));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(v2detectionsetup->minimum_nadir_search));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(v2detectionsetup->maximum_nadir_search));
  index += 4;
  v2detectionsetup->automatic_filter_window = buffer[index];
  index++;
  mb_get_binary_float(false, &buffer[index], &(v2detectionsetup->applied_roll));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(v2detectionsetup->depth_gate_tilt));
  index += 4;
  for (int i = 0; i < 14; i++) {
    mb_get_binary_float(false, &buffer[index], &(v2detectionsetup->reserved[i]));
    index += 4;
  }

  /* extract v2detectionsetup data */
  for (int i = 0; i < v2detectionsetup->number_beams; i++) {
    mb_get_binary_short(false, &buffer[index], &(v2detectionsetup->beam_descriptor[i]));
    index += 2;
    mb_get_binary_float(false, &buffer[index], &(v2detectionsetup->detection_point[i]));
    index += 4;
    mb_get_binary_int(false, &buffer[index], &(v2detectionsetup->flags[i]));
    index += 4;
    mb_get_binary_int(false, &buffer[index], &(v2detectionsetup->auto_limits_min_sample[i]));
    index += 4;
    mb_get_binary_int(false, &buffer[index], &(v2detectionsetup->auto_limits_max_sample[i]));
    index += 4;
    mb_get_binary_int(false, &buffer[index], &(v2detectionsetup->user_limits_min_sample[i]));
    index += 4;
    mb_get_binary_int(false, &buffer[index], &(v2detectionsetup->user_limits_max_sample[i]));
    index += 4;
    mb_get_binary_int(false, &buffer[index], &(v2detectionsetup->quality[i]));
    index += 4;
    if (v2detectionsetup->data_field_size >= R7KRDTSIZE_7kV2DetectionSetup + 4) {
      mb_get_binary_float(false, &buffer[index], &(v2detectionsetup->uncertainty[i]));
      index += 4;
    }
    else {
...
int mbr_reson7kr_rd_v2beamformed(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_long(false, &buffer[index], &(v2beamformed->serial_number));
  index += 8;
  mb_get_binary_int(false, &buffer[index], &(v2beamformed->ping_number));
  index += 4;
  mb_get_binary_short(false, &buffer[index], &(v2beamformed->multi_ping));
  index += 2;
  mb_get_binary_short(false, &buffer[index], &(v2beamformed->number_beams));
  index += 2;
  mb_get_binary_int(false, &buffer[index], &(v2beamformed->number_samples));
  index += 4;
  for (int i = 0; i < 32; i++) {
  ...
  for (int i = 0; i < v2beamformed->number_beams; i++) {
    ...
    for (int j = 0; j < v2beamformed->number_samples; j++) {
      mb_get_binary_short(false, &buffer[index], &(v2amplitudephase->amplitude[j]));
      index += 2;
      mb_get_binary_short(false, &buffer[index], &(v2amplitudephase->phase[j]));
      index += 2;
    }
...
int mbr_reson7kr_rd_v2bite(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_short(false, &buffer[index], &(v2bite->number_reports));
  index += 2;
  ...
  for (int i = 0; i < v2bite->number_reports; i++) {
    ...
    index++;
    mb_get_binary_float(false, &buffer[index], &(report->frequency));
    index += 4;
    mb_get_binary_short(false, &buffer[index], &(report->enumerator));
    index += 2;

    s7ktime = &(report->downlink_time);
    mb_get_binary_short(false, &buffer[index], &(s7ktime->Year));
    index += 2;
    mb_get_binary_short(false, &buffer[index], &(s7ktime->Day));
    index += 2;
    mb_get_binary_float(false, &buffer[index], &(s7ktime->Seconds));
    index += 4;
    ...
    index++;
    mb_get_binary_short(false, &buffer[index], &(report->number_bite));
    index += 2;
    for (int j = 0; j < 32; j++) {
    ...
    for (int j = 0; j < report->number_bite; j++) {
      ...
      mb_get_binary_short(false, &buffer[index], &(bitefield->reserved));
      index += 2;
      for (int k = 0; k < 64; k++) {
      ...
      index++;
      mb_get_binary_float(false, &buffer[index], &(bitefield->minimum));
      index += 4;
      mb_get_binary_float(false, &buffer[index], &(bitefield->maximum));
      index += 4;
      mb_get_binary_float(false, &buffer[index], &(bitefield->value));
      index += 4;
    }
  }
...
int mbr_reson7kr_rd_v2detection(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_long(false, &buffer[index], &(v2detection->serial_number));
  index += 8;
  mb_get_binary_int(false, &buffer[index], &(v2detection->ping_number));
  index += 4;
  mb_get_binary_short(false, &buffer[index], &(v2detection->multi_ping));
  index += 2;
  mb_get_binary_int(false, &buffer[index], &(v2detection->number_beams));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(v2detection->data_field_size));
  index += 4;
  mb_get_binary_long(false, &buffer[index], &(v2detection->corrections));
  index += 8;
  v2detection->detection_algorithm = buffer[index];
  index++;
  mb_get_binary_int(false, &buffer[index], &(v2detection->flags));
  index += 4;
  for (int i = 0; i < 64; i++) {
  ...
  for (int i = 0; i < v2detection->number_beams; i++) {
    mb_get_binary_float(false, &buffer[index], &(v2detection->range[i]));
    index += 4;
    mb_get_binary_float(false, &buffer[index], &(v2detection->angle_x[i]));
    index += 4;
    mb_get_binary_float(false, &buffer[index], &(v2detection->angle_y[i]));
    index += 4;
    mb_get_binary_float(false, &buffer[index], &(v2detection->range_error[i]));
    index += 4;
    mb_get_binary_float(false, &buffer[index], &(v2detection->angle_x_error[i]));
    index += 4;
    mb_get_binary_float(false, &buffer[index], &(v2detection->angle_y_error[i]));
    index += 4;
...
int mbr_reson7kr_rd_v2rawdetection(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_long(false, &buffer[index], &(v2rawdetection->serial_number));
  index += 8;
  mb_get_binary_int(false, &buffer[index], &(v2rawdetection->ping_number));
  index += 4;
  mb_get_binary_short(false, &buffer[index], &(v2rawdetection->multi_ping));
  index += 2;
  mb_get_binary_int(false, &buffer[index], &(v2rawdetection->number_beams));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(v2rawdetection->data_field_size));
  index += 4;
  v2rawdetection->detection_algorithm = buffer[index];
  index++;
  mb_get_binary_int(false, &buffer[index], &(v2rawdetection->detection_flags));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(v2rawdetection->sampling_rate));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(v2rawdetection->tx_angle));
  index += 4;
  for (int i = 0; i < 64; i++) {
  ...
  for (int i = 0; i < v2rawdetection->number_beams; i++) {
    mb_get_binary_short(false, &buffer[index], &(v2rawdetection->beam_descriptor[i]));
    index += 2;
    mb_get_binary_float(false, &buffer[index], &(v2rawdetection->detection_point[i]));
    index += 4;
    mb_get_binary_float(false, &buffer[index], &(v2rawdetection->rx_angle[i]));
    index += 4;
    mb_get_binary_int(false, &buffer[index], &(v2rawdetection->flags[i]));
    index += 4;
    mb_get_binary_int(false, &buffer[index], &(v2rawdetection->quality[i]));
    index += 4;
    mb_get_binary_float(false, &buffer[index], &(v2rawdetection->uncertainty[i]));
    index += 4;
...
int mbr_reson7kr_rd_v2snippet(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_long(false, &buffer[index], &(v2snippet->serial_number));
  index += 8;
  mb_get_binary_int(false, &buffer[index], &(v2snippet->ping_number));
  index += 4;
  mb_get_binary_short(false, &buffer[index], &(v2snippet->multi_ping));
  index += 2;
  mb_get_binary_short(false, &buffer[index], &(v2snippet->number_beams));
  index += 2;
  ...
  for (int i = 0; i < v2snippet->number_beams; i++) {
    ...
    mb_get_binary_short(false, &buffer[index], &(snippettimeseries->beam_number));
    index += 2;
    mb_get_binary_int(false, &buffer[index], &(snippettimeseries->begin_sample));
    index += 4;
    mb_get_binary_int(false, &buffer[index], &(snippettimeseries->detect_sample));
    index += 4;
    mb_get_binary_int(false, &buffer[index], &(snippettimeseries->end_sample));
    index += 4;
  ...
  if (status == MB_SUCCESS)
    for (int i = 0; i < v2snippet->number_beams; i++) {
      ...
      for (int j = 0; j < (snippettimeseries->end_sample - snippettimeseries->begin_sample + 1); j++) {
        mb_get_binary_short(false, &buffer[index], &(snippettimeseries->amplitude[j]));
        index += 2;
      }
    }
...
int mbr_reson7kr_rd_calibratedsnippet(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_long(false, &buffer[index], &(calibratedsnippet->serial_number));
  index += 8;
  mb_get_binary_int(false, &buffer[index], &(calibratedsnippet->ping_number));
  index += 4;
  mb_get_binary_short(false, &buffer[index], &(calibratedsnippet->multi_ping));
  index += 2;
  mb_get_binary_short(false, &buffer[index], &(calibratedsnippet->number_beams));
  index += 2;
  calibratedsnippet->error_flag = buffer[index];
  index++;
  mb_get_binary_int(false, &buffer[index], &(calibratedsnippet->control_flags));
  index += 4;
  for (int i = 0; i < 28; i++) {
  ...
  for (int i = 0; i < calibratedsnippet->number_beams; i++) {
    ...
    /* extract snippettimeseries data */
    mb_get_binary_short(false, &buffer[index], &(calibratedsnippettimeseries->beam_number));
    index += 2;
    mb_get_binary_int(false, &buffer[index], &(calibratedsnippettimeseries->begin_sample));
    index += 4;
    mb_get_binary_int(false, &buffer[index], &(calibratedsnippettimeseries->detect_sample));
    index += 4;
    mb_get_binary_int(false, &buffer[index], &(calibratedsnippettimeseries->end_sample));
    index += 4;
  ...
  if (status == MB_SUCCESS)
    for (int i = 0; i < calibratedsnippet->number_beams; i++) {
      ...
      for (int j = 0; j < (calibratedsnippettimeseries->end_sample - calibratedsnippettimeseries->begin_sample + 1); j++) {
        mb_get_binary_float(false, &buffer[index], &(calibratedsnippettimeseries->amplitude[j]));
        index += 4;
      }
    }
...
int mbr_reson7kr_rd_installation(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_float(false, &buffer[index], &(installation->frequency));
  index += 4;
  mb_get_binary_short(false, &buffer[index], &(installation->firmware_version_len));
  index += 2;
  for (int i = 0; i < 128; i++) {
    installation->firmware_version[i] = buffer[index];
    index++;
  }
  mb_get_binary_short(false, &buffer[index], &(installation->software_version_len));
  index += 2;
  for (int i = 0; i < 128; i++) {
    installation->software_version[i] = buffer[index];
    index++;
  }
  mb_get_binary_short(false, &buffer[index], &(installation->s7k_version_len));
  index += 2;
  for (int i = 0; i < 128; i++) {
    installation->s7k_version[i] = buffer[index];
    index++;
  }
  mb_get_binary_short(false, &buffer[index], &(installation->protocal_version_len));
  index += 2;
  for (int i = 0; i < 128; i++) {
    installation->protocal_version[i] = buffer[index];
    index++;
  }
  mb_get_binary_float(false, &buffer[index], &(installation->transmit_x));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(installation->transmit_y));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(installation->transmit_z));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(installation->transmit_roll));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(installation->transmit_pitch));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(installation->transmit_heading));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(installation->receive_x));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(installation->receive_y));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(installation->receive_z));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(installation->receive_roll));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(installation->receive_pitch));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(installation->receive_heading));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(installation->motion_x));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(installation->motion_y));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(installation->motion_z));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(installation->motion_roll));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(installation->motion_pitch));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(installation->motion_heading));
  index += 4;
  mb_get_binary_short(false, &buffer[index], &(installation->motion_time_delay));
  index += 2;
  mb_get_binary_float(false, &buffer[index], &(installation->position_x));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(installation->position_y));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(installation->position_z));
  index += 4;
  mb_get_binary_short(false, &buffer[index], &(installation->position_time_delay));
  index += 2;
  mb_get_binary_float(false, &buffer[index], &(installation->waterline_z));
  index += 4;
...
int mbr_reson7kr_rd_fileheader(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  mb_get_binary_short(false, &buffer[index], &(fileheader->version));
  index += 2;
  mb_get_binary_short(false, &buffer[index], &(fileheader->reserved));
  index += 2;
  for (int i = 0; i < 16; i++) {
    fileheader->session_identifier[i] = buffer[index];
    index++;
  }
  mb_get_binary_int(false, &buffer[index], &(fileheader->record_data_size));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(fileheader->number_subsystems));
  index += 4;
  for (int i = 0; i < 64; i++) {
  ...
  for (int i = 0; i < fileheader->number_subsystems; i++) {
    ...
    mb_get_binary_int(false, &buffer[index], &(subsystem->device_identifier));
    index += 4;
    if (header->Version == 2)
      mb_get_binary_short(false, &buffer[index], &(subsystem->system_enumerator));
    index += 2;
    mb_get_binary_short(false, &buffer[index], &(subsystem->system_enumerator));
    index += 2;
  }
...
int mbr_reson7kr_rd_systemeventmessage(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_long(false, &buffer[index], &(systemeventmessage->serial_number));
  index += 8;
  mb_get_binary_short(false, &buffer[index], &(systemeventmessage->event_id));
  index += 2;
  mb_get_binary_short(false, &buffer[index], &(systemeventmessage->message_length));
  index += 2;
  mb_get_binary_short(false, &buffer[index], &(systemeventmessage->event_identifier));
  index += 2;
...
int mbr_reson7kr_rd_remotecontrolsettings(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_long(false, &buffer[index], &(remotecontrolsettings->serial_number));
  index += 8;
  mb_get_binary_int(false, &buffer[index], &(remotecontrolsettings->ping_number));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(remotecontrolsettings->frequency));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(remotecontrolsettings->sample_rate));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(remotecontrolsettings->receiver_bandwidth));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(remotecontrolsettings->pulse_width));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(remotecontrolsettings->pulse_type));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(remotecontrolsettings->pulse_envelope));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(remotecontrolsettings->pulse_envelope_par));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(remotecontrolsettings->pulse_reserved));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(remotecontrolsettings->max_ping_rate));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(remotecontrolsettings->ping_period));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(remotecontrolsettings->range_selection));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(remotecontrolsettings->power_selection));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(remotecontrolsettings->gain_selection));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(remotecontrolsettings->control_flags));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(remotecontrolsettings->projector_magic_no));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(remotecontrolsettings->steering_vertical));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(remotecontrolsettings->steering_horizontal));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(remotecontrolsettings->beamwidth_vertical));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(remotecontrolsettings->beamwidth_horizontal));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(remotecontrolsettings->focal_point));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(remotecontrolsettings->projector_weighting));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(remotecontrolsettings->projector_weighting_par));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(remotecontrolsettings->transmit_flags));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(remotecontrolsettings->hydrophone_magic_no));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(remotecontrolsettings->receive_weighting));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(remotecontrolsettings->receive_weighting_par));
  index += 4;
  mb_get_binary_int(false, &buffer[index], &(remotecontrolsettings->receive_flags));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(remotecontrolsettings->range_minimum));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(remotecontrolsettings->range_maximum));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(remotecontrolsettings->depth_minimum));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(remotecontrolsettings->depth_maximum));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(remotecontrolsettings->absorption));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(remotecontrolsettings->sound_velocity));
  index += 4;
  mb_get_binary_float(false, &buffer[index], &(remotecontrolsettings->spreading));
  index += 4;
  mb_get_binary_short(false, &buffer[index], &(remotecontrolsettings->reserved));
  index += 2;
  if (header->Size >=
      MBSYS_RESON7K_RECORDHEADER_SIZE + MBSYS_RESON7K_RECORDTAIL_SIZE + R7KHDRSIZE_7kRemoteControlSonarSettings) {
    mb_get_binary_float(false, &buffer[index], &(remotecontrolsettings->tx_offset_x));
    index += 4;
    mb_get_binary_float(false, &buffer[index], &(remotecontrolsettings->tx_offset_y));
    index += 4;
    mb_get_binary_float(false, &buffer[index], &(remotecontrolsettings->tx_offset_z));
    index += 4;
    mb_get_binary_float(false, &buffer[index], &(remotecontrolsettings->head_tilt_x));
    index += 4;
    mb_get_binary_float(false, &buffer[index], &(remotecontrolsettings->head_tilt_y));
    index += 4;
    mb_get_binary_float(false, &buffer[index], &(remotecontrolsettings->head_tilt_z));
    index += 4;
    mb_get_binary_short(false, &buffer[index], &(remotecontrolsettings->ping_on_off));
    index += 2;
    remotecontrolsettings->data_sample_types = buffer[index];
    index++;
    remotecontrolsettings->projector_orientation = buffer[index];
    index++;
    mb_get_binary_short(false, &buffer[index], &(remotecontrolsettings->beam_angle_mode));
    index += 2;
    mb_get_binary_short(false, &buffer[index], &(remotecontrolsettings->r7kcenter_mode));
    index += 2;
    mb_get_binary_float(false, &buffer[index], &(remotecontrolsettings->gate_depth_min));
    index += 4;
    mb_get_binary_float(false, &buffer[index], &(remotecontrolsettings->gate_depth_max));
    index += 4;
    for (int i = 0; i < 35; i++) {
      mb_get_binary_short(false, &buffer[index], &(remotecontrolsettings->reserved2[i]));
      index += 2;
    }
  }
...
int mbr_reson7kr_rd_roll(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_float(false, &buffer[index], &(roll->roll));
  index += 4;
...
int mbr_reson7kr_rd_pitch(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_float(false, &buffer[index], &(pitch->pitch));
  index += 4;
...
int mbr_reson7kr_rd_soundvelocity(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_float(false, &buffer[index], &(soundvelocity->soundvelocity));
  index += 4;
...
int mbr_reson7kr_rd_absorptionloss(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_float(false, &buffer[index], &(absorptionloss->absorptionloss));
  index += 4;
...
int mbr_reson7kr_rd_spreadingloss(int verbose, char *buffer, void *store_ptr, int *error) {
  ...
  /* extract the data */
  index = header->Offset + 4;
  mb_get_binary_float(false, &buffer[index], &(spreadingloss->spreadingloss));
  index += 4;
...
/* print out the data to be output */
  ...
  *index += 4;
  mb_put_binary_int(false, header->OffsetToOptionalData, &buffer[*index]);
  *index += 4;
  ...
  *index += 4;
  mb_put_binary_short(false, header->Reserved2, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, header->SystemEnumerator, &buffer[*index]);
  *index += 2;
  mb_put_binary_int(false, header->RecordNumber, &buffer[*index]);
  *index += 4;
...
/* print out the data to be output */
  ...
  *size += R7KHDRSIZE_ReferencePoint;
  ...
  if (status == MB_SUCCESS) {
    ...
    /* insert the data */
    mb_put_binary_float(false, reference->offset_x, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, reference->offset_y, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, reference->offset_z, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, reference->water_z, &buffer[index]);
    index += 4;
...
/* print out the data to be output */
  ...
  *size += R7KHDRSIZE_UncalibratedSensorOffset;
  ...
  if (status == MB_SUCCESS) {
    ...
    /* insert the data */
    index = header->Offset + 4;
    mb_put_binary_float(false, sensoruncal->offset_x, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, sensoruncal->offset_y, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, sensoruncal->offset_z, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, sensoruncal->offset_roll, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, sensoruncal->offset_pitch, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, sensoruncal->offset_yaw, &buffer[index]);
    index += 4;
...
/* print out the data to be output */
  ...
  *size += R7KHDRSIZE_CalibratedSensorOffset;
  ...
  if (status == MB_SUCCESS) {
    ...
    /* insert the data */
    index = header->Offset + 4;
    mb_put_binary_float(false, sensorcal->offset_x, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, sensorcal->offset_y, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, sensorcal->offset_z, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, sensorcal->offset_roll, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, sensorcal->offset_pitch, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, sensorcal->offset_yaw, &buffer[index]);
    index += 4;
...
/* print out the data to be output */
  ...
  *size += R7KHDRSIZE_Position;
  ...
  if (status == MB_SUCCESS) {
    ...
    index += 4;
    mb_put_binary_double(false, position->latitude, &buffer[index]);
    index += 8;
    mb_put_binary_double(false, position->longitude, &buffer[index]);
    index += 8;
...
/* print out the data to be output */
  ...
  *size += R7KHDRSIZE_MotionOverGround;
  ...
  if (status == MB_SUCCESS) {
    ...
    motion->reserved = (mb_u_char)buffer[index];
    index++;
    mb_put_binary_short(false, motion->n, &buffer[index]);
    index += 2;
    mb_put_binary_float(false, motion->frequency, &buffer[index]);
    index += 4;

    if (motion->bitfield & 1) {
      for (int i = 0; i < motion->n; i++) {
        mb_put_binary_float(false, motion->x[i], &buffer[index]);
        index += 4;
      }
      for (int i = 0; i < motion->n; i++) {
        mb_put_binary_float(false, motion->y[i], &buffer[index]);
        index += 4;
      }
      for (int i = 0; i < motion->n; i++) {
        mb_put_binary_float(false, motion->z[i], &buffer[index]);
        index += 4;
      }
    }
    if (motion->bitfield & 2) {
      for (int i = 0; i < motion->n; i++) {
        mb_put_binary_float(false, motion->xa[i], &buffer[index]);
        index += 4;
      }
      for (int i = 0; i < motion->n; i++) {
        mb_put_binary_float(false, motion->ya[i], &buffer[index]);
        index += 4;
      }
      for (int i = 0; i < motion->n; i++) {
        mb_put_binary_float(false, motion->za[i], &buffer[index]);
        index += 4;
      }
    }
...
/* print out the data to be output */
  ...
  *size += R7KRDTSIZE_SoundVelocityProfile * svp->n;
  ...
  if (status == MB_SUCCESS) {
    ...
    svp->reserved1 = (mb_u_char)buffer[index];
    index++;
    mb_put_binary_short(false, svp->reserved2, &buffer[index]);
    index += 2;
    mb_put_binary_double(false, svp->latitude, &buffer[index]);
    index += 8;
    mb_put_binary_double(false, svp->longitude, &buffer[index]);
    index += 8;
    mb_put_binary_int(false, svp->n, &buffer[index]);
    index += 4;

    for (int i = 0; i < svp->n; i++) {
      mb_put_binary_float(false, svp->depth[i], &buffer[index]);
      index += 4;
      mb_put_binary_float(false, svp->sound_velocity[i], &buffer[index]);
      index += 4;
    }
...
/* print out the data to be output */
  ...
  *size += R7KHDRSIZE_Geodesy;
  ...
  if (status == MB_SUCCESS) {
    ...
    index += 8;
    mb_put_binary_double(false, geodesy->central_meriidan, &buffer[index]);
    index += 8;
    ...
    index += 8;
    mb_put_binary_int(false, geodesy->custum_identifier, &buffer[index]);
    index += 4;
    for (int i = 0; i < 50; i++) {
      geodesy->reserved3[i] = (mb_u_char)buffer[index];
      index++;
...
/* print out the data to be output */
  ...
  *size += surveyline->n * R7KRDTSIZE_SurveyLine;
  ...
  if (status == MB_SUCCESS) {
    ...
    for (int i = 0; i < surveyline->n; i++) {
      mb_put_binary_double(false, surveyline->latitude[i], &buffer[index]);
      index += 8;
      mb_put_binary_double(false, surveyline->longitude[i], &buffer[index]);
      index += 8;
    }
...
int mbr_reson7kr_wr_fsdwchannel(int verbose, int data_format, char *buffer, int *index, s7k_fsdwchannel *fsdwchannel,
  ...
  mb_put_binary_int(false, fsdwchannel->number_samples, &buffer[*index]);
  *index += 4;
  mb_put_binary_int(false, fsdwchannel->start_time, &buffer[*index]);
  *index += 4;
  mb_put_binary_int(false, fsdwchannel->sample_interval, &buffer[*index]);
  *index += 4;
  mb_put_binary_float(false, fsdwchannel->range, &buffer[*index]);
  *index += 4;
  mb_put_binary_float(false, fsdwchannel->voltage, &buffer[*index]);
  *index += 4;
  for (int i = 0; i < 16; i++) {
  ...
  if (status == MB_SUCCESS) {
    if (fsdwchannel->bytespersample == 1) {
      ...
      for (int i = 0; i < fsdwchannel->number_samples; i++) {
        /*srptr = (short *) &(buffer[*index]);
        urptr = (unsigned short *) &(buffer[*index]);*/
        mb_put_binary_short(false, shortptr[i], &buffer[*index]);
        *index += 2;
        /*ssptr = (short *) &(shortptr[i]);
        usptr = (unsigned short *) &(shortptr[i]);
        fprintf(stderr,"sample:%5d   raw:%6d %6d   swapped:%6d %6d\n",
      ...
      for (int i = 0; i < fsdwchannel->number_samples; i++) {
        /*srptr = (short *) &(buffer[*index]);
        urptr = (unsigned short *) &(buffer[*index]);*/
        mb_put_binary_short(false, shortptr[2 * i], &buffer[*index]);
        *index += 2;
        /*ssptr = (short *) &(shortptr[2*i]);
        usptr = (unsigned short *) &(shortptr[2*i]);
        fprintf(stderr,"sample:%5d   IMAGINARY: raw:%6d %6d   swapped:%6d %6d",
        ...
        srptr = (short *) &(buffer[*index]);
        urptr = (unsigned short *) &(buffer[*index]);*/
        mb_put_binary_short(false, shortptr[2 * i + 1], &buffer[*index]);
        *index += 2;
        /*ssptr = (short *) &(shortptr[2*i+1]);
        usptr = (unsigned short *) &(shortptr[2*i+1]);
        fprintf(stderr,"    REAL: raw:%6d %6d   swapped:%6d %6d\n",
...
int mbr_reson7kr_wr_fsdwssheader(int verbose, char *buffer, int *index, s7k_fsdwssheader *fsdwssheader, int *error) {
  ...
  /* extract the Edgetech sidescan header */
  mb_put_binary_short(false, fsdwssheader->subsystem, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwssheader->channelNum, &buffer[*index]);
  *index += 2;
  mb_put_binary_int(false, fsdwssheader->pingNum, &buffer[*index]);
  *index += 4;
  mb_put_binary_short(false, fsdwssheader->packetNum, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwssheader->trigSource, &buffer[*index]);
  *index += 2;
  mb_put_binary_int(false, fsdwssheader->samples, &buffer[*index]);
  *index += 4;
  mb_put_binary_int(false, fsdwssheader->sampleInterval, &buffer[*index]);
  *index += 4;
  mb_put_binary_int(false, fsdwssheader->startDepth, &buffer[*index]);
  *index += 4;
  mb_put_binary_short(false, fsdwssheader->weightingFactor, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwssheader->ADCGain, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwssheader->ADCMax, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwssheader->rangeSetting, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwssheader->pulseID, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwssheader->markNumber, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwssheader->dataFormat, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwssheader->reserved, &buffer[*index]);
  *index += 2;
  mb_put_binary_int(false, fsdwssheader->millisecondsToday, &buffer[*index]);
  *index += 4;
  mb_put_binary_short(false, fsdwssheader->year, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwssheader->day, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwssheader->hour, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwssheader->minute, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwssheader->second, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwssheader->heading, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwssheader->pitch, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwssheader->roll, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwssheader->heave, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwssheader->yaw, &buffer[*index]);
  *index += 2;
  mb_put_binary_int(false, fsdwssheader->depth, &buffer[*index]);
  *index += 4;
  mb_put_binary_short(false, fsdwssheader->temperature, &buffer[*index]);
  *index += 2;
  for (int i = 0; i < 2; i++) {
    buffer[*index] = fsdwssheader->reserved2[i];
    (*index)++;
  }
  mb_put_binary_int(false, fsdwssheader->longitude, &buffer[*index]);
  *index += 4;
  mb_put_binary_int(false, fsdwssheader->latitude, &buffer[*index]);
  *index += 4;
...
int mbr_reson7kr_wr_fsdwsegyheader(int verbose, char *buffer, int *index, s7k_fsdwsegyheader *fsdwsegyheader, int *error) {
  ...
  /* extract the Edgetech segy header */
  mb_put_binary_int(false, fsdwsegyheader->sequenceNumber, &buffer[*index]);
  *index += 4;
  mb_put_binary_int(false, fsdwsegyheader->startDepth, &buffer[*index]);
  *index += 4;
  mb_put_binary_int(false, fsdwsegyheader->pingNum, &buffer[*index]);
  *index += 4;
  mb_put_binary_int(false, fsdwsegyheader->channelNum, &buffer[*index]);
  *index += 4;
  for (int i = 0; i < 6; i++) {
    mb_put_binary_short(false, fsdwsegyheader->unused1[i], &buffer[*index]);
    *index += 2;
  }
  mb_put_binary_short(false, fsdwsegyheader->traceIDCode, &buffer[*index]);
  *index += 2;
  for (int i = 0; i < 2; i++) {
    mb_put_binary_short(false, fsdwsegyheader->unused2[i], &buffer[*index]);
    *index += 2;
  }
  mb_put_binary_short(false, fsdwsegyheader->dataFormat, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwsegyheader->NMEAantennaeR, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwsegyheader->NMEAantennaeO, &buffer[*index]);
  *index += 2;
  for (int i = 0; i < 32; i++) {
    buffer[*index] = fsdwsegyheader->RS232[i];
    (*index)++;
  }
  mb_put_binary_int(false, fsdwsegyheader->sourceCoordX, &buffer[*index]);
  *index += 4;
  mb_put_binary_int(false, fsdwsegyheader->sourceCoordY, &buffer[*index]);
  *index += 4;
  mb_put_binary_int(false, fsdwsegyheader->groupCoordX, &buffer[*index]);
  *index += 4;
  mb_put_binary_int(false, fsdwsegyheader->groupCoordY, &buffer[*index]);
  *index += 4;
  mb_put_binary_short(false, fsdwsegyheader->coordUnits, &buffer[*index]);
  *index += 2;
  for (int i = 0; i < 24; i++) {
    buffer[*index] = fsdwsegyheader->annotation[i];
    (*index)++;
  }
  mb_put_binary_short(false, fsdwsegyheader->samples, &buffer[*index]);
  *index += 2;
  mb_put_binary_int(false, fsdwsegyheader->sampleInterval, &buffer[*index]);
  *index += 4;
  mb_put_binary_short(false, fsdwsegyheader->ADCGain, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwsegyheader->pulsePower, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwsegyheader->correlated, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwsegyheader->startFreq, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwsegyheader->endFreq, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwsegyheader->sweepLength, &buffer[*index]);
  *index += 2;
  for (int i = 0; i < 4; i++) {
    mb_put_binary_short(false, fsdwsegyheader->unused7[i], &buffer[*index]);
    *index += 2;
  }
  mb_put_binary_short(false, fsdwsegyheader->aliasFreq, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwsegyheader->pulseID, &buffer[*index]);
  *index += 2;
  for (int i = 0; i < 6; i++) {
    mb_put_binary_short(false, fsdwsegyheader->unused8[i], &buffer[*index]);
    *index += 2;
  }
  mb_put_binary_short(false, fsdwsegyheader->year, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwsegyheader->day, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwsegyheader->hour, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwsegyheader->minute, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwsegyheader->second, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwsegyheader->timeBasis, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwsegyheader->weightingFactor, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwsegyheader->unused9, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwsegyheader->heading, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwsegyheader->pitch, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwsegyheader->roll, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwsegyheader->temperature, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwsegyheader->heaveCompensation, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwsegyheader->trigSource, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwsegyheader->markNumber, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwsegyheader->NMEAHour, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwsegyheader->NMEAMinutes, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwsegyheader->NMEASeconds, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwsegyheader->NMEACourse, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwsegyheader->NMEASpeed, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwsegyheader->NMEADay, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwsegyheader->NMEAYear, &buffer[*index]);
  *index += 2;
  mb_put_binary_int(false, fsdwsegyheader->millisecondsToday, &buffer[*index]);
  *index += 4;
  mb_put_binary_short(false, fsdwsegyheader->ADCMax, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwsegyheader->calConst, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwsegyheader->vehicleID, &buffer[*index]);
  *index += 2;
  for (int i = 0; i < 6; i++) {
    buffer[*index] = fsdwsegyheader->softwareVersion[i];
    (*index)++;
  }
  mb_put_binary_int(false, fsdwsegyheader->sphericalCorrection, &buffer[*index]);
  *index += 4;
  mb_put_binary_short(false, fsdwsegyheader->packetNum, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwsegyheader->ADCDecimation, &buffer[*index]);
  *index += 2;
  mb_put_binary_short(false, fsdwsegyheader->decimation, &buffer[*index]);
  *index += 2;
  for (int i = 0; i < 7; i++) {
    mb_put_binary_short(false, fsdwsegyheader->unuseda[i], &buffer[*index]);
    *index += 2;
  }
...
/* print out the data to be output */
  ...
  *size += R7KHDRSIZE_FSDWsidescan;
  ...
  if (status == MB_SUCCESS) {
    ...
    /* insert the data */
    index = header->Offset + 4;
    mb_put_binary_int(false, fsdwsslo->msec_timestamp, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, fsdwsslo->ping_number, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, fsdwsslo->number_channels, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, fsdwsslo->total_bytes, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, fsdwsslo->data_format, &buffer[index]);
    index += 4;
    index += 12;
    for (int i = 0; i < 2; i++) {
      fsdwchannel = &(fsdwsslo->channel[i]);
...
/* print out the data to be output */
  ...
  *size += R7KHDRSIZE_FSDWsidescan;
  ...
  if (status == MB_SUCCESS) {
    ...
    /* insert the data */
    index = header->Offset + 4;
    mb_put_binary_int(false, fsdwsshi->msec_timestamp, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, fsdwsshi->ping_number, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, fsdwsshi->number_channels, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, fsdwsshi->total_bytes, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, fsdwsshi->data_format, &buffer[index]);
    index += 4;
    index += 12;
    for (int i = 0; i < 2; i++) {
      fsdwchannel = &(fsdwsshi->channel[i]);
...
/* print out the data to be output */
  ...
  *size += R7KHDRSIZE_FSDWsubbottom;
  ...
  if (status == MB_SUCCESS) {
    ...
    /* insert the data */
    index = header->Offset + 4;
    mb_put_binary_int(false, fsdwsb->msec_timestamp, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, fsdwsb->ping_number, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, fsdwsb->number_channels, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, fsdwsb->total_bytes, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, fsdwsb->data_format, &buffer[index]);
    index += 4;
    index += 12;
    fsdwchannel = &(fsdwsb->channel);
...
/* print out the data to be output */
  ...
  *size += bluefin->number_frames * bluefin->frame_size;
  ...
  if (status == MB_SUCCESS) {
    ...
    /* insert the data */
    index = header->Offset + 4;
    mb_put_binary_int(false, bluefin->msec_timestamp, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, bluefin->number_frames, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, bluefin->frame_size, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, bluefin->data_format, &buffer[index]);
    index += 4;
    for (int i = 0; i < 16; i++) {
    ...
    if (bluefin->data_format == R7KRECID_BluefinNav) {
      for (int i = 0; i < bluefin->number_frames; i++) {
        mb_put_binary_int(false, bluefin->nav[i].packet_size, &buffer[index]);
        index += 4;
        mb_put_binary_short(false, bluefin->nav[i].version, &buffer[index]);
        index += 2;
        mb_put_binary_short(false, bluefin->nav[i].offset, &buffer[index]);
        index += 2;
        mb_put_binary_int(false, bluefin->nav[i].data_type, &buffer[index]);
        index += 4;
        mb_put_binary_int(false, bluefin->nav[i].data_size, &buffer[index]);
        index += 4;
        mb_put_binary_short(false, bluefin->nav[i].s7kTime.Year, &buffer[index]);
        index += 2;
        mb_put_binary_short(false, bluefin->nav[i].s7kTime.Day, &buffer[index]);
        index += 2;
        mb_put_binary_float(false, bluefin->nav[i].s7kTime.Seconds, &buffer[index]);
        index += 4;
        buffer[index] = bluefin->nav[i].s7kTime.Hours;
        (index)++;
        buffer[index] = bluefin->nav[i].s7kTime.Minutes;
        (index)++;
        mb_put_binary_int(false, bluefin->nav[i].checksum, &buffer[index]);
        index += 4;
        mb_put_binary_short(false, bluefin->nav[i].timedelay, &buffer[index]);
        index += 2;
        mb_put_binary_int(false, bluefin->nav[i].quality, &buffer[index]);
        index += 4;
        mb_put_binary_double(false, bluefin->nav[i].latitude, &buffer[index]);
        index += 8;
        mb_put_binary_double(false, bluefin->nav[i].longitude, &buffer[index]);
        index += 8;
        mb_put_binary_float(false, bluefin->nav[i].speed, &buffer[index]);
        index += 4;
        mb_put_binary_double(false, bluefin->nav[i].depth, &buffer[index]);
        index += 8;
        mb_put_binary_double(false, bluefin->nav[i].altitude, &buffer[index]);
        index += 8;
        mb_put_binary_float(false, bluefin->nav[i].roll, &buffer[index]);
        index += 4;
        mb_put_binary_float(false, bluefin->nav[i].pitch, &buffer[index]);
        index += 4;
        mb_put_binary_float(false, bluefin->nav[i].yaw, &buffer[index]);
        index += 4;
        mb_put_binary_float(false, bluefin->nav[i].northing_rate, &buffer[index]);
        index += 4;
        mb_put_binary_float(false, bluefin->nav[i].easting_rate, &buffer[index]);
        index += 4;
        mb_put_binary_float(false, bluefin->nav[i].depth_rate, &buffer[index]);
        index += 4;
        mb_put_binary_float(false, bluefin->nav[i].altitude_rate, &buffer[index]);
        index += 4;
        mb_put_binary_float(false, bluefin->nav[i].roll_rate, &buffer[index]);
        index += 4;
        mb_put_binary_float(false, bluefin->nav[i].pitch_rate, &buffer[index]);
        index += 4;
        mb_put_binary_float(false, bluefin->nav[i].yaw_rate, &buffer[index]);
        index += 4;
        mb_put_binary_double(false, bluefin->nav[i].position_time, &buffer[index]);
        index += 8;
        mb_put_binary_double(false, bluefin->nav[i].depth_time, &buffer[index]);
        index += 8;
      }
    }
    else if (bluefin->data_format == R7KRECID_BluefinEnvironmental) {
      for (int i = 0; i < bluefin->number_frames; i++) {
        mb_put_binary_int(false, bluefin->environmental[i].packet_size, &buffer[index]);
        index += 4;
        mb_put_binary_short(false, bluefin->environmental[i].version, &buffer[index]);
        index += 2;
        mb_put_binary_short(false, bluefin->environmental[i].offset, &buffer[index]);
        index += 2;
        mb_put_binary_int(false, bluefin->environmental[i].data_type, &buffer[index]);
        index += 4;
        mb_put_binary_int(false, bluefin->environmental[i].data_size, &buffer[index]);
        index += 4;
        mb_put_binary_short(false, bluefin->environmental[i].s7kTime.Year, &buffer[index]);
        index += 2;
        mb_put_binary_short(false, bluefin->environmental[i].s7kTime.Day, &buffer[index]);
        index += 2;
        mb_put_binary_float(false, bluefin->environmental[i].s7kTime.Seconds, &buffer[index]);
        index += 4;
        buffer[index] = bluefin->environmental[i].s7kTime.Hours;
        (index)++;
        buffer[index] = bluefin->environmental[i].s7kTime.Minutes;
        (index)++;
        mb_put_binary_int(false, bluefin->environmental[i].checksum, &buffer[index]);
        index += 4;
        mb_put_binary_short(false, bluefin->environmental[i].reserved1, &buffer[index]);
        index += 2;
        mb_put_binary_int(false, bluefin->environmental[i].quality, &buffer[index]);
        index += 4;
        mb_put_binary_float(false, bluefin->environmental[i].sound_speed, &buffer[index]);
        index += 4;
        mb_put_binary_float(false, bluefin->environmental[i].conductivity, &buffer[index]);
        index += 4;
        mb_put_binary_float(false, bluefin->environmental[i].temperature, &buffer[index]);
        index += 4;
        mb_put_binary_float(false, bluefin->environmental[i].pressure, &buffer[index]);
        index += 4;
        mb_put_binary_float(false, bluefin->environmental[i].salinity, &buffer[index]);
        index += 4;
        mb_put_binary_double(false, bluefin->environmental[i].ctd_time, &buffer[index]);
        index += 8;
        mb_put_binary_double(false, bluefin->environmental[i].temperature_time, &buffer[index]);
        index += 8;
        mb_put_binary_double(false, bluefin->environmental[i].surface_pressure, &buffer[index]);
        index += 8;
        mb_put_binary_int(false, bluefin->environmental[i].temperature_counts, &buffer[index]);
        index += 4;
        mb_put_binary_float(false, bluefin->environmental[i].conductivity_frequency, &buffer[index]);
        index += 4;
        mb_put_binary_int(false, bluefin->environmental[i].pressure_counts, &buffer[index]);
        index += 4;
        mb_put_binary_float(false, bluefin->environmental[i].pressure_comp_voltage, &buffer[index]);
        index += 4;
        mb_put_binary_int(false, bluefin->environmental[i].sensor_time_sec, &buffer[index]);
        index += 4;
        mb_put_binary_int(false, bluefin->environmental[i].sensor_time_nsec, &buffer[index]);
        index += 4;
        mb_put_binary_short(false, bluefin->environmental[i].sensor1, &buffer[index]);
        index += 2;
        mb_put_binary_short(false, bluefin->environmental[i].sensor2, &buffer[index]);
        index += 2;
        mb_put_binary_short(false, bluefin->environmental[i].sensor3, &buffer[index]);
        index += 2;
        mb_put_binary_short(false, bluefin->environmental[i].sensor4, &buffer[index]);
        index += 2;
        mb_put_binary_short(false, bluefin->environmental[i].sensor5, &buffer[index]);
        index += 2;
        mb_put_binary_short(false, bluefin->environmental[i].sensor6, &buffer[index]);
        index += 2;
        mb_put_binary_short(false, bluefin->environmental[i].sensor7, &buffer[index]);
        index += 2;
        mb_put_binary_short(false, bluefin->environmental[i].sensor8, &buffer[index]);
        index += 2;
        for (int j = 0; j < 8; j++) {
...
/* print out the data to be output */
  ...
  *size += R7KHDRSIZE_7kVolatileSonarSettings;
  ...
  if (status == MB_SUCCESS) {
    ...
    /* insert the data */
    index = header->Offset + 4;
    mb_put_binary_long(false, volatilesettings->serial_number, &buffer[index]);
    index += 8;
    mb_put_binary_int(false, volatilesettings->ping_number, &buffer[index]);
    index += 4;
    mb_put_binary_short(false, volatilesettings->multi_ping, &buffer[index]);
    index += 2;
    mb_put_binary_float(false, volatilesettings->frequency, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, volatilesettings->sample_rate, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, volatilesettings->receiver_bandwidth, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, volatilesettings->pulse_width, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, volatilesettings->pulse_type, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, volatilesettings->pulse_envelope, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, volatilesettings->pulse_envelope_par, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, volatilesettings->pulse_reserved, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, volatilesettings->max_ping_rate, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, volatilesettings->ping_period, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, volatilesettings->range_selection, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, volatilesettings->power_selection, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, volatilesettings->gain_selection, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, volatilesettings->control_flags, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, volatilesettings->projector_magic_no, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, volatilesettings->steering_vertical, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, volatilesettings->steering_horizontal, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, volatilesettings->beamwidth_vertical, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, volatilesettings->beamwidth_horizontal, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, volatilesettings->focal_point, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, volatilesettings->projector_weighting, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, volatilesettings->projector_weighting_par, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, volatilesettings->transmit_flags, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, volatilesettings->hydrophone_magic_no, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, volatilesettings->receive_weighting, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, volatilesettings->receive_weighting_par, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, volatilesettings->receive_flags, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, volatilesettings->receive_width, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, volatilesettings->range_minimum, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, volatilesettings->range_maximum, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, volatilesettings->depth_minimum, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, volatilesettings->depth_maximum, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, volatilesettings->absorption, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, volatilesettings->sound_velocity, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, volatilesettings->spreading, &buffer[index]);
    index += 4;
    mb_put_binary_short(false, volatilesettings->reserved, &buffer[index]);
    index += 2;
...
/* print out the data to be output */
  ...
  *size += v2firmwarehardwareconfiguration->info_length;
  ...
  if (status == MB_SUCCESS) {
    ...
    /* insert the data */
    index = header->Offset + 4;
    mb_put_binary_int(false, v2firmwarehardwareconfiguration->device_count, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, v2firmwarehardwareconfiguration->info_length, &buffer[index]);
    index += 4;
...
/* print out the data to be output */
  ...
  *size += calibration->number_channels * 8;
  ...
  if (status == MB_SUCCESS) {
    ...
    /* insert the data */
    index = header->Offset + 4;
    mb_put_binary_long(false, calibration->serial_number, &buffer[index]);
    index += 8;
    mb_put_binary_short(false, calibration->number_channels, &buffer[index]);
    index += 2;

    /* insert the data */
    for (int i = 0; i < calibration->number_channels; i++) {
      mb_put_binary_float(false, calibration->gain[i], &buffer[index]);
      index += 4;
    }
    for (int i = 0; i < calibration->number_channels; i++) {
      mb_put_binary_float(false, calibration->phase[i], &buffer[index]);
      index += 4;
    }
...
/* print out the data to be output */
  ...
  if (status == MB_SUCCESS) {
    ...
    if (bathymetry->optionaldata == MB_YES) {
      ...
      index += 4;
      mb_put_binary_float(false, bathymetry->vehicle_height, &buffer[index]);
      index += 4;
      for (int i = 0; i < bathymetry->number_beams; i++) {
...
/* print out the data to be output */
  ...
  *size += 2 * backscatter->number_samples * backscatter->sample_size;
  ...
  if (status == MB_SUCCESS) {
    ...
    /* insert the data */
    index = header->Offset + 4;
    mb_put_binary_long(false, backscatter->serial_number, &buffer[index]);
    index += 8;
    mb_put_binary_int(false, backscatter->ping_number, &buffer[index]);
    index += 4;
    mb_put_binary_short(false, backscatter->multi_ping, &buffer[index]);
    index += 2;
    mb_put_binary_float(false, backscatter->beam_position, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, backscatter->control_flags, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, backscatter->number_samples, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, backscatter->port_beamwidth_x, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, backscatter->port_beamwidth_y, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, backscatter->stbd_beamwidth_x, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, backscatter->stbd_beamwidth_y, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, backscatter->port_steering_x, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, backscatter->port_steering_y, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, backscatter->stbd_steering_x, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, backscatter->stbd_steering_y, &buffer[index]);
    index += 4;
    mb_put_binary_short(false, backscatter->number_beams, &buffer[index]);
    index += 2;
    mb_put_binary_short(false, backscatter->current_beam, &buffer[index]);
    index += 2;
    ...
    if (header->OffsetToOptionalData > 0) {
      index = header->OffsetToOptionalData;
      backscatter->optionaldata = MB_YES;
      mb_put_binary_float(false, backscatter->frequency, &buffer[index]);
      index += 4;
      mb_put_binary_double(false, backscatter->latitude, &buffer[index]);
      index += 8;
      mb_put_binary_double(false, backscatter->longitude, &buffer[index]);
      index += 8;
      mb_put_binary_float(false, backscatter->heading, &buffer[index]);
      index += 4;
      mb_put_binary_float(false, backscatter->altitude, &buffer[index]);
      index += 4;
    }
    else {
      backscatter->optionaldata = MB_NO;
...
/* print out the data to be output */
  ...
  *size += R7KHDRSIZE_7kBeamData;
  ...
  if (status == MB_SUCCESS) {
    ...
    /* insert the data */
    index = header->Offset + 4;
    mb_put_binary_long(false, beam->serial_number, &buffer[index]);
    index += 8;
    mb_put_binary_int(false, beam->ping_number, &buffer[index]);
    index += 4;
    mb_put_binary_short(false, beam->multi_ping, &buffer[index]);
    index += 2;
    mb_put_binary_short(false, beam->number_beams, &buffer[index]);
    index += 2;
    mb_put_binary_short(false, beam->reserved, &buffer[index]);
    index += 2;
    mb_put_binary_int(false, beam->number_samples, &buffer[index]);
    index += 4;
    buffer[index] = beam->record_subset_flag;
    index++;
    buffer[index] = beam->row_column_flag;
    index++;
    mb_put_binary_short(false, beam->sample_header_id, &buffer[index]);
    index += 2;
    mb_put_binary_int(false, beam->sample_type, &buffer[index]);
    index += 4;
    for (int i = 0; i < beam->number_beams; i++) {
      snippet = &beam->snippets[i];
      mb_put_binary_short(false, snippet->beam_number, &buffer[index]);
      index += 2;
      mb_put_binary_int(false, snippet->begin_sample, &buffer[index]);
      index += 4;
      mb_put_binary_int(false, snippet->end_sample, &buffer[index]);
      index += 4;
    }
...
/* print out the data to be output */
  ...
  *size += image->width * image->height * image->color_depth;
  ...
  if (status == MB_SUCCESS) {
    ...
    index += 2;
    mb_put_binary_short(false, image->width_height_flag, &buffer[index]);
    index += 2;
...
/* print out the data to be output */
  ...
  *size += R7KHDRSIZE_7kV2PingMotion;
  ...
  if (status == MB_SUCCESS) {
    ...
    /* insert the data */
    index = header->Offset + 4;
    mb_put_binary_long(false, v2pingmotion->serial_number, &buffer[index]);
    index += 8;
    mb_put_binary_int(false, v2pingmotion->ping_number, &buffer[index]);
    index += 4;
    mb_put_binary_short(false, v2pingmotion->multi_ping, &buffer[index]);
    index += 2;
    mb_put_binary_int(false, v2pingmotion->n, &buffer[index]);
    index += 4;
    mb_put_binary_short(false, v2pingmotion->flags, &buffer[index]);
    index += 2;
    mb_put_binary_int(false, v2pingmotion->error_flags, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, v2pingmotion->frequency, &buffer[index]);
    index += 4;
    if (v2pingmotion->flags & 1) {
      mb_put_binary_float(false, v2pingmotion->pitch, &buffer[index]);
      index += 4;
    }
    if (v2pingmotion->flags & 2) {
      for (int i = 0; i < v2pingmotion->n; i++) {
        mb_put_binary_float(false, v2pingmotion->roll[i], &buffer[index]);
        index += 4;
      }
    }
    if (v2pingmotion->flags & 4) {
      for (int i = 0; i < v2pingmotion->n; i++) {
        mb_put_binary_float(false, v2pingmotion->heading[i], &buffer[index]);
        index += 4;
      }
    }
    if (v2pingmotion->flags & 8) {
      for (int i = 0; i < v2pingmotion->n; i++) {
        mb_put_binary_float(false, v2pingmotion->heave[i], &buffer[index]);
        index += 4;
      }
    }
...
/* print out the data to be output */
  ...
  *size += v2detectionsetup->number_beams * v2detectionsetup->data_field_size;
  ...
  if (status == MB_SUCCESS) {
    ...
    /* insert the data */
    index = header->Offset + 4;
    mb_put_binary_long(false, v2detectionsetup->serial_number, &buffer[index]);
    index += 8;
    mb_put_binary_int(false, v2detectionsetup->ping_number, &buffer[index]);
    index += 4;
    mb_put_binary_short(false, v2detectionsetup->multi_ping, &buffer[index]);
    index += 2;
    mb_put_binary_int(false, v2detectionsetup->number_beams, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, v2detectionsetup->data_field_size, &buffer[index]);
    index += 4;
    buffer[index] = v2detectionsetup->detection_algorithm;
    index++;
    mb_put_binary_int(false, v2detectionsetup->detection_flags, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, v2detectionsetup->minimum_depth, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, v2detectionsetup->maximum_depth, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, v2detectionsetup->minimum_range, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, v2detectionsetup->maximum_range, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, v2detectionsetup->minimum_nadir_search, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, v2detectionsetup->maximum_nadir_search, &buffer[index]);
    index += 4;
    buffer[index] = v2detectionsetup->automatic_filter_window;
    index++;
    mb_put_binary_float(false, v2detectionsetup->applied_roll, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, v2detectionsetup->depth_gate_tilt, &buffer[index]);
    index += 4;
    for (int i = 0; i < 14; i++) {
      mb_put_binary_float(false, v2detectionsetup->reserved[i], &buffer[index]);
      index += 4;
    }
    for (int i = 0; i < v2detectionsetup->number_beams; i++) {
      mb_put_binary_short(false, v2detectionsetup->beam_descriptor[i], &buffer[index]);
      index += 2;
      mb_put_binary_float(false, v2detectionsetup->detection_point[i], &buffer[index]);
      index += 4;
      mb_put_binary_int(false, v2detectionsetup->flags[i], &buffer[index]);
      index += 4;
      mb_put_binary_int(false, v2detectionsetup->auto_limits_min_sample[i], &buffer[index]);
      index += 4;
      mb_put_binary_int(false, v2detectionsetup->auto_limits_max_sample[i], &buffer[index]);
      index += 4;
      mb_put_binary_int(false, v2detectionsetup->user_limits_min_sample[i], &buffer[index]);
      index += 4;
      mb_put_binary_int(false, v2detectionsetup->user_limits_max_sample[i], &buffer[index]);
      index += 4;
      mb_put_binary_int(false, v2detectionsetup->quality[i], &buffer[index]);
      index += 4;
      if (v2detectionsetup->data_field_size >= R7KRDTSIZE_7kV2DetectionSetup + 4) {
        mb_put_binary_int(false, v2detectionsetup->uncertainty[i], &buffer[index]);
        index += 4;
      }
    }
...
/* print out the data to be output */
  ...
  *size += 2 * sizeof(short) * v2beamformed->number_beams * v2beamformed->number_samples;
  ...
  if (status == MB_SUCCESS) {
    ...
    /* insert the data */
    index = header->Offset + 4;
    mb_put_binary_long(false, v2beamformed->serial_number, &buffer[index]);
    index += 8;
    mb_put_binary_int(false, v2beamformed->ping_number, &buffer[index]);
    index += 4;
    mb_put_binary_short(false, v2beamformed->multi_ping, &buffer[index]);
    index += 2;
    mb_put_binary_short(false, v2beamformed->number_beams, &buffer[index]);
    index += 2;
    mb_put_binary_int(false, v2beamformed->number_samples, &buffer[index]);
    index += 4;
    for (int i = 0; i < 32; i++) {
    ...
    for (int i = 0; i < v2beamformed->number_beams; i++) {
      ...
      for (int j = 0; j < v2beamformed->number_samples; j++) {
        mb_put_binary_short(false, v2amplitudephase->amplitude[j], &buffer[index]);
        index += 2;
        mb_put_binary_short(false, v2amplitudephase->phase[j], &buffer[index]);
        index += 2;
      }
    }
...
/* print out the data to be output */
  ...
  *size += R7KHDRSIZE_7kV2BITEData;
  ...
  if (status == MB_SUCCESS) {
    ...
    /* insert the data */
    index = header->Offset + 4;
    mb_put_binary_short(false, v2bite->number_reports, &buffer[index]);
    index += 2;
    for (int i = 0; i < v2bite->number_reports; i++) {
      report = &(v2bite->reports[i]);
      ...
      index++;
      mb_put_binary_float(false, report->frequency, &buffer[index]);
      index += 4;
      mb_put_binary_short(false, report->enumerator, &buffer[index]);
      index += 2;
      ...
      index++;
      mb_put_binary_short(false, report->number_bite, &buffer[index]);
      index += 2;
      for (int j = 0; j < 32; j++) {
      ...
      for (int j = 0; j < report->number_bite; j++) {
        ...
        mb_put_binary_short(false, bitefield->reserved, &buffer[index]);
        index += 2;
        for (int k = 0; k < 64; k++) {
...
/* print out the data to be output */
  ...
  if (status == MB_SUCCESS) {
    ...
    /* insert the data */
    index = header->Offset + 4;
    mb_put_binary_long(false, v2detection->serial_number, &buffer[index]);
    index += 8;
    mb_put_binary_int(false, v2detection->ping_number, &buffer[index]);
    index += 4;
    mb_put_binary_short(false, v2detection->multi_ping, &buffer[index]);
    index += 2;
    mb_put_binary_int(false, v2detection->number_beams, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, v2detection->data_field_size, &buffer[index]);
    index += 4;
    mb_put_binary_long(false, v2detection->corrections, &buffer[index]);
    index += 8;
    buffer[index] = v2detection->detection_algorithm;
    index++;
    mb_put_binary_int(false, v2detection->flags, &buffer[index]);
    index += 4;
    for (int i = 0; i < 64; i++) {
    ...
    /* insert the data */
    for (int i = 0; i < v2detection->number_beams; i++) {
      mb_put_binary_float(false, v2detection->range[i], &buffer[index]);
      index += 4;
      mb_put_binary_float(false, v2detection->angle_x[i], &buffer[index]);
      index += 4;
      mb_put_binary_float(false, v2detection->angle_y[i], &buffer[index]);
      index += 4;
      mb_put_binary_float(false, v2detection->range_error[i], &buffer[index]);
      index += 4;
      mb_put_binary_float(false, v2detection->angle_x_error[i], &buffer[index]);
      index += 4;
      mb_put_binary_float(false, v2detection->angle_y_error[i], &buffer[index]);
      index += 4;
      if (v2detection->data_field_size > 24)
...
/* print out the data to be output */
  ...
  if (status == MB_SUCCESS) {
    ...
    /* insert the data */
    index = header->Offset + 4;
    mb_put_binary_long(false, v2rawdetection->serial_number, &buffer[index]);
    index += 8;
    mb_put_binary_int(false, v2rawdetection->ping_number, &buffer[index]);
    index += 4;
    mb_put_binary_short(false, v2rawdetection->multi_ping, &buffer[index]);
    index += 2;
    mb_put_binary_int(false, v2rawdetection->number_beams, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, v2rawdetection->data_field_size, &buffer[index]);
    index += 4;
    buffer[index] = v2rawdetection->detection_algorithm;
    index++;
    mb_put_binary_int(false, v2rawdetection->detection_flags, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, v2rawdetection->sampling_rate, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, v2rawdetection->tx_angle, &buffer[index]);
    index += 4;
    for (int i = 0; i < 64; i++) {
    ...
    /* insert the data */
    for (int i = 0; i < v2rawdetection->number_beams; i++) {
      mb_put_binary_short(false, v2rawdetection->beam_descriptor[i], &buffer[index]);
      index += 2;
      mb_put_binary_float(false, v2rawdetection->detection_point[i], &buffer[index]);
      index += 4;
      mb_put_binary_float(false, v2rawdetection->rx_angle[i], &buffer[index]);
      index += 4;
      mb_put_binary_int(false, v2rawdetection->flags[i], &buffer[index]);
      index += 4;
      mb_put_binary_int(false, v2rawdetection->quality[i], &buffer[index]);
      index += 4;
      mb_put_binary_float(false, v2rawdetection->uncertainty[i], &buffer[index]);
      index += 4;
      if (v2rawdetection->data_field_size > 22)
...
/* print out the data to be output */
  ...
  if (status == MB_SUCCESS) {
    ...
    /* insert the data */
    index = header->Offset + 4;
    mb_put_binary_long(false, v2snippet->serial_number, &buffer[index]);
    index += 8;
    mb_put_binary_int(false, v2snippet->ping_number, &buffer[index]);
    index += 4;
    mb_put_binary_short(false, v2snippet->multi_ping, &buffer[index]);
    index += 2;
    mb_put_binary_short(false, v2snippet->number_beams, &buffer[index]);
    index += 2;
    ...
    for (int i = 0; i < v2snippet->number_beams; i++) {
      ...
      /* extract snippettimeseries data */
      mb_put_binary_short(false, snippettimeseries->beam_number, &buffer[index]);
      index += 2;
      mb_put_binary_int(false, snippettimeseries->begin_sample, &buffer[index]);
      index += 4;
      mb_put_binary_int(false, snippettimeseries->detect_sample, &buffer[index]);
      index += 4;
      mb_put_binary_int(false, snippettimeseries->end_sample, &buffer[index]);
      index += 4;
    }
    ...
    for (int i = 0; i < v2snippet->number_beams; i++) {
      snippettimeseries = &(v2snippet->snippettimeseries[i]);
      for (int j = 0; j < (snippettimeseries->end_sample - snippettimeseries->begin_sample + 1); j++) {
        mb_put_binary_short(false, snippettimeseries->amplitude[j], &buffer[index]);
        index += 2;
      }
    }
...
/* print out the data to be output */
  ...
  if (status == MB_SUCCESS) {
    ...
    /* insert the data */
    index = header->Offset + 4;
    mb_put_binary_long(false, calibratedsnippet->serial_number, &buffer[index]);
    index += 8;
    mb_put_binary_int(false, calibratedsnippet->ping_number, &buffer[index]);
    index += 4;
    mb_put_binary_short(false, calibratedsnippet->multi_ping, &buffer[index]);
    index += 2;
    mb_put_binary_short(false, calibratedsnippet->number_beams, &buffer[index]);
    index += 2;
    buffer[index] = calibratedsnippet->error_flag;
    index++;
    mb_put_binary_int(false, calibratedsnippet->control_flags, &buffer[index]);
    index += 4;
    for (int i = 0; i < 28; i++) {
    ...
    for (int i = 0; i < calibratedsnippet->number_beams; i++) {
      snippettimeseries = &(calibratedsnippet->calibratedsnippettimeseries[i]);
      for (int j = 0; j < (snippettimeseries->end_sample - snippettimeseries->begin_sample + 1); j++) {
        mb_put_binary_float(false, snippettimeseries->amplitude[j], &buffer[index]);
        index += 4;
      }
    }
...
/* print out the data to be output */
  ...
  *size += R7KHDRSIZE_7kInstallationParameters;
  ...
  if (status == MB_SUCCESS) {
    ...
    /* insert the data */
    index = header->Offset + 4;
    mb_put_binary_float(false, installation->frequency, &buffer[index]);
    index += 4;
    mb_put_binary_short(false, installation->firmware_version_len, &buffer[index]);
    index += 2;
    for (int i = 0; i < 128; i++) {
      buffer[index] = installation->firmware_version[i];
      index++;
    }
    mb_put_binary_short(false, installation->software_version_len, &buffer[index]);
    index += 2;
    for (int i = 0; i < 128; i++) {
      buffer[index] = installation->software_version[i];
      index++;
    }
    mb_put_binary_short(false, installation->s7k_version_len, &buffer[index]);
    index += 2;
    for (int i = 0; i < 128; i++) {
      buffer[index] = installation->s7k_version[i];
      index++;
    }
    mb_put_binary_short(false, installation->protocal_version_len, &buffer[index]);
    index += 2;
    for (int i = 0; i < 128; i++) {
      buffer[index] = installation->protocal_version[i];
      index++;
    }
    mb_put_binary_float(false, installation->transmit_x, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, installation->transmit_y, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, installation->transmit_z, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, installation->transmit_roll, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, installation->transmit_pitch, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, installation->transmit_heading, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, installation->receive_x, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, installation->receive_y, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, installation->receive_z, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, installation->receive_roll, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, installation->receive_pitch, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, installation->receive_heading, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, installation->motion_x, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, installation->motion_y, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, installation->motion_z, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, installation->motion_roll, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, installation->motion_pitch, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, installation->motion_heading, &buffer[index]);
    index += 4;
    mb_put_binary_short(false, installation->motion_time_delay, &buffer[index]);
    index += 2;
    mb_put_binary_float(false, installation->position_x, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, installation->position_y, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, installation->position_z, &buffer[index]);
    index += 4;
    mb_put_binary_short(false, installation->position_time_delay, &buffer[index]);
    index += 2;
    mb_put_binary_float(false, installation->waterline_z, &buffer[index]);
    index += 4;
...
/* print out the data to be output */
  ...
  *size += R7KHDRSIZE_7kFileHeader + R7KRDTSIZE_7kFileHeader;
  ...
  if (status == MB_SUCCESS) {
    ...
    index += 4;
    mb_put_binary_int(false, fileheader->number_subsystems, &buffer[index]);
    index += 4;
    for (int i = 0; i < 64; i++) {
...
/* print out the data to be output */
  ...
  *size += R7KHDRSIZE_7kRemoteControlSonarSettings;
  ...
  if (status == MB_SUCCESS) {
    ...
    /* insert the data */
    index = header->Offset + 4;
    mb_put_binary_long(false, remotecontrolsettings->serial_number, &buffer[index]);
    index += 8;
    mb_put_binary_int(false, remotecontrolsettings->ping_number, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, remotecontrolsettings->frequency, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, remotecontrolsettings->sample_rate, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, remotecontrolsettings->receiver_bandwidth, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, remotecontrolsettings->pulse_width, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, remotecontrolsettings->pulse_type, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, remotecontrolsettings->pulse_envelope, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, remotecontrolsettings->pulse_envelope_par, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, remotecontrolsettings->pulse_reserved, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, remotecontrolsettings->max_ping_rate, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, remotecontrolsettings->ping_period, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, remotecontrolsettings->range_selection, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, remotecontrolsettings->power_selection, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, remotecontrolsettings->gain_selection, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, remotecontrolsettings->control_flags, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, remotecontrolsettings->projector_magic_no, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, remotecontrolsettings->steering_vertical, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, remotecontrolsettings->steering_horizontal, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, remotecontrolsettings->beamwidth_vertical, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, remotecontrolsettings->beamwidth_horizontal, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, remotecontrolsettings->focal_point, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, remotecontrolsettings->projector_weighting, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, remotecontrolsettings->projector_weighting_par, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, remotecontrolsettings->transmit_flags, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, remotecontrolsettings->hydrophone_magic_no, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, remotecontrolsettings->receive_weighting, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, remotecontrolsettings->receive_weighting_par, &buffer[index]);
    index += 4;
    mb_put_binary_int(false, remotecontrolsettings->receive_flags, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, remotecontrolsettings->range_minimum, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, remotecontrolsettings->range_maximum, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, remotecontrolsettings->depth_minimum, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, remotecontrolsettings->depth_maximum, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, remotecontrolsettings->absorption, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, remotecontrolsettings->sound_velocity, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, remotecontrolsettings->spreading, &buffer[index]);
    index += 4;
    mb_put_binary_short(false, remotecontrolsettings->reserved, &buffer[index]);
    index += 2;
    mb_put_binary_float(false, remotecontrolsettings->tx_offset_x, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, remotecontrolsettings->tx_offset_y, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, remotecontrolsettings->tx_offset_z, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, remotecontrolsettings->head_tilt_x, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, remotecontrolsettings->head_tilt_y, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, remotecontrolsettings->head_tilt_z, &buffer[index]);
    index += 4;
    mb_put_binary_short(false, remotecontrolsettings->ping_on_off, &buffer[index]);
    index += 2;
    buffer[index] = remotecontrolsettings->data_sample_types;
    index++;
    buffer[index] = remotecontrolsettings->projector_orientation;
    index++;
    mb_put_binary_short(false, remotecontrolsettings->beam_angle_mode, &buffer[index]);
    index += 2;
    mb_put_binary_short(false, remotecontrolsettings->r7kcenter_mode, &buffer[index]);
    index += 2;
    mb_put_binary_float(false, remotecontrolsettings->gate_depth_min, &buffer[index]);
    index += 4;
    mb_put_binary_float(false, remotecontrolsettings->gate_depth_max, &buffer[index]);
    index += 4;
    for (int i = 0; i < 35; i++) {
      mb_put_binary_short(false, remotecontrolsettings->reserved2[i], &buffer[index]);
      index += 2;
    }
...
/* print out the data to be output */
  ...
  *size += R7KHDRSIZE_7kRoll;
  ...
  if (status == MB_SUCCESS) {
    ...
    /* insert the data */
    index = header->Offset + 4;
    mb_put_binary_float(false, roll->roll, &buffer[index]);
    index += 4;
...
/* print out the data to be output */
  ...
  *size += R7KHDRSIZE_7kPitch;
  ...
  if (status == MB_SUCCESS) {
    ...
    /* insert the data */
    index = header->Offset + 4;
    mb_put_binary_float(false, pitch->pitch, &buffer[index]);
    index += 4;
