 ...
 *	$Id: mbr_mbldeoih.c,v 5.1 2000-12-10 20:26:50 caress Exp $
 *
...
int mbr_info_mbldeoih(int verbose, 
			...
			int *error)
{
	static char res_id[]="$Id: mbr_mbldeoih.c,v 5.1 2000-12-10 20:26:50 caress Exp $";
	...
	*altitude = &mbsys_ldeoih_altitude; 
