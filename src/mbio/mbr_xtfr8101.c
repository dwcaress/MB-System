	...
	*error = MB_ERROR_NO_ERROR;
	...
	if (*fileheaderread == MB_NO) {
		...
		if (read_len == MBF_XTFR8101_FILEHEADERLEN) {
			...
			*fileheaderread = MB_YES;
			...
			index += 16;
			mb_get_binary_short(false, &line[index], (short int *)&(fileheader->SonarType));
			index += 2;
			for (int i = 0; i < 64; i++)
			...
			index += 64;
			mb_get_binary_short(false, &line[index], (short int *)&(fileheader->NavUnits));
			index += 2;
			mb_get_binary_short(false, &line[index], (short int *)&(fileheader->NumberOfSonarChannels));
			index += 2;
			mb_get_binary_short(false, &line[index], (short int *)&(fileheader->NumberOfBathymetryChannels));
			index += 2;
			mb_get_binary_short(false, &line[index], (short int *)&(fileheader->Reserved1));
			index += 2;
			mb_get_binary_short(false, &line[index], (short int *)&(fileheader->Reserved2));
			index += 2;
			mb_get_binary_short(false, &line[index], (short int *)&(fileheader->Reserved3));
			index += 2;
			mb_get_binary_short(false, &line[index], (short int *)&(fileheader->Reserved4));
			index += 2;
			mb_get_binary_short(false, &line[index], (short int *)&(fileheader->Reserved5));
			index += 2;
			mb_get_binary_short(false, &line[index], (short int *)&(fileheader->Reserved6));
			index += 2;
			for (int i = 0; i < 12; i++)
			...
			index += 10;
			mb_get_binary_int(false, &line[index], (int *)&(fileheader->NavigationLatency));
			index += 4;
			mb_get_binary_float(false, &line[index], &(fileheader->OriginY));
			index += 4;
			mb_get_binary_float(false, &line[index], &(fileheader->OriginX));
			index += 4;
			mb_get_binary_float(false, &line[index], &(fileheader->NavOffsetY));
			index += 4;
			mb_get_binary_float(false, &line[index], &(fileheader->NavOffsetX));
			index += 4;
			mb_get_binary_float(false, &line[index], &(fileheader->NavOffsetZ));
			index += 4;
			mb_get_binary_float(false, &line[index], &(fileheader->NavOffsetYaw));
			index += 4;
			mb_get_binary_float(false, &line[index], &(fileheader->MRUOffsetY));
			index += 4;
			mb_get_binary_float(false, &line[index], &(fileheader->MRUOffsetX));
			index += 4;
			mb_get_binary_float(false, &line[index], &(fileheader->MRUOffsetZ));
			index += 4;
			mb_get_binary_float(false, &line[index], &(fileheader->MRUOffsetYaw));
			index += 4;
			mb_get_binary_float(false, &line[index], &(fileheader->MRUOffsetPitch));
			index += 4;
			mb_get_binary_float(false, &line[index], &(fileheader->MRUOffsetRoll));
			index += 4;
			for (ichan = 0; ichan < 6; ichan++) {
				...
				index++;
				mb_get_binary_short(false, &line[index], (short int *)&(fileheader->chaninfo[ichan].CorrectionFlags));
				index += 2;
				mb_get_binary_short(false, &line[index], (short int *)&(fileheader->chaninfo[ichan].UniPolar));
				index += 2;
				mb_get_binary_short(false, &line[index], (short int *)&(fileheader->chaninfo[ichan].BytesPerSample));
				index += 2;
				mb_get_binary_int(false, &line[index], (int *)&(fileheader->chaninfo[ichan].SamplesPerChannel));
				index += 4;
				for (int i = 0; i < 16; i++)
					fileheader->chaninfo[ichan].ChannelName[i] = line[index + i];
				index += 16;
				mb_get_binary_float(false, &line[index], &(fileheader->chaninfo[ichan].VoltScale));
				index += 4;
				mb_get_binary_float(false, &line[index], &(fileheader->chaninfo[ichan].Frequency));
				index += 4;
				mb_get_binary_float(false, &line[index], &(fileheader->chaninfo[ichan].HorizBeamAngle));
				index += 4;
				mb_get_binary_float(false, &line[index], &(fileheader->chaninfo[ichan].TiltAngle));
				index += 4;
				mb_get_binary_float(false, &line[index], &(fileheader->chaninfo[ichan].BeamWidth));
				index += 4;
				mb_get_binary_float(false, &line[index], &(fileheader->chaninfo[ichan].OffsetX));
				index += 4;
				mb_get_binary_float(false, &line[index], &(fileheader->chaninfo[ichan].OffsetY));
				index += 4;
				mb_get_binary_float(false, &line[index], &(fileheader->chaninfo[ichan].OffsetZ));
				index += 4;
				mb_get_binary_float(false, &line[index], &(fileheader->chaninfo[ichan].OffsetYaw));
				index += 4;
				mb_get_binary_float(false, &line[index], &(fileheader->chaninfo[ichan].OffsetPitch));
				index += 4;
				mb_get_binary_float(false, &line[index], &(fileheader->chaninfo[ichan].OffsetRoll));
				index += 4;
				for (int i = 0; i < 56; i++)
	...
	while (status == MB_SUCCESS && done == MB_NO) {
		...
		if (read_len == 12) {
			...
			index++;
			mb_get_binary_short(false, &line[index], (short int *)&(packetheader.NumChansToFollow));
			index += 2;
			mb_get_binary_short(false, &line[index], (short int *)&(packetheader.Reserved1[0]));
			index += 2;
			mb_get_binary_short(false, &line[index], (short int *)&(packetheader.Reserved1[1]));
			index += 2;
			mb_get_binary_int(false, &line[index], (int *)&(packetheader.NumBytesThisRecord));
			index += 4;
		...
		if (status == MB_SUCCESS && packetheader.HeaderType == XTF_DATA_ATTITUDE && packetheader.NumBytesThisRecord == 64) {
			...
			if (read_len == 50) {
				...
				int index = 0;
				for (int i = 0; i < 4; i++) {
					mb_get_binary_int(false, &line[index], (int *)&(attitudeheader->Reserved2[i]));
					index += 4;
				}
				mb_get_binary_float(false, &line[index], &(attitudeheader->Pitch));
				index += 4;
				mb_get_binary_float(false, &line[index], &(attitudeheader->Roll));
				index += 4;
				mb_get_binary_float(false, &line[index], &(attitudeheader->Heave));
				index += 4;
				mb_get_binary_float(false, &line[index], &(attitudeheader->Yaw));
				index += 4;
				mb_get_binary_int(false, &line[index], (int *)&(attitudeheader->TimeTag));
				index += 4;
				mb_get_binary_float(false, &line[index], &(attitudeheader->Heading));
				index += 4;
				for (int i = 0; i < 10; i++) {
		...
		/* read rest of sidescan packet */
			...
			if (read_len == 242) {
				int index = 0;
				mb_get_binary_short(false, &line[index], (short int *)&(sidescanheader->Year));
				index += 2;
				...
				index++;
				mb_get_binary_short(false, &line[index], (short int *)&(sidescanheader->JulianDay));
				index += 2;
				mb_get_binary_short(false, &line[index], (short int *)&(sidescanheader->CurrentLineID));
				index += 2;
				mb_get_binary_short(false, &line[index], (short int *)&(sidescanheader->EventNumber));
				index += 2;
				mb_get_binary_int(false, &line[index], (int *)&(sidescanheader->PingNumber));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->SoundVelocity));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->OceanTide));
				index += 4;
				mb_get_binary_int(false, &line[index], (int *)&(sidescanheader->Reserved2));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->ConductivityFreq));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->TemperatureFreq));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->PressureFreq));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->PressureTemp));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->Conductivity));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->WaterTemperature));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->Pressure));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->ComputedSoundVelocity));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->MagX));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->MagY));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->MagZ));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->AuxVal1));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->AuxVal2));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->AuxVal3));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->AuxVal4));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->AuxVal5));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->AuxVal6));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->SpeedLog));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->Turbidity));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->ShipSpeed));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->ShipGyro));
				index += 4;
				mb_get_binary_double(false, &line[index], &(sidescanheader->ShipYcoordinate));
				index += 8;
				mb_get_binary_double(false, &line[index], &(sidescanheader->ShipXcoordinate));
				index += 8;
				mb_get_binary_short(false, &line[index], (short int *)&(sidescanheader->ShipAltitude));
				index += 2;
				mb_get_binary_short(false, &line[index], (short int *)&(sidescanheader->ShipDepth));
				index += 2;
				...
				index++;
				mb_get_binary_float(false, &line[index], &(sidescanheader->SensorSpeed));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->KP));
				index += 4;
				mb_get_binary_double(false, &line[index], &(sidescanheader->SensorYcoordinate));
				index += 8;
				mb_get_binary_double(false, &line[index], &(sidescanheader->SensorXcoordinate));
				index += 8;
				mb_get_binary_short(false, &line[index], &(sidescanheader->Reserved6));
				index += 2;
				mb_get_binary_short(false, &line[index], &(sidescanheader->RangeToSensor));
				index += 2;
				mb_get_binary_short(false, &line[index], &(sidescanheader->BearingToSensor));
				index += 2;
				mb_get_binary_short(false, &line[index], &(sidescanheader->CableOut));
				index += 2;
				mb_get_binary_float(false, &line[index], &(sidescanheader->Layback));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->CableTension));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->SensorDepth));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->SensorPrimaryAltitude));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->SensorAuxAltitude));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->SensorPitch));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->SensorRoll));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->SensorHeading));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->Heave));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->Yaw));
				index += 4;
				mb_get_binary_int(false, &line[index], &(sidescanheader->AttitudeTimeTag));
				index += 4;
				mb_get_binary_float(false, &line[index], &(sidescanheader->DOT));
				index += 4;
				for (int i = 0; i < 20; i++) {
			...
			if (status == MB_SUCCESS && read_len == 64) {
				int index = 0;
				mb_get_binary_short(false, &line[index], (short int *)&(pingchanportheader->ChannelNumber));
				index += 2;
				mb_get_binary_short(false, &line[index], (short int *)&(pingchanportheader->DownsampleMethod));
				index += 2;
				mb_get_binary_float(false, &line[index], &(pingchanportheader->SlantRange));
				index += 4;
				mb_get_binary_float(false, &line[index], &(pingchanportheader->GroundRange));
				index += 4;
				mb_get_binary_float(false, &line[index], &(pingchanportheader->TimeDelay));
				index += 4;
				mb_get_binary_float(false, &line[index], &(pingchanportheader->TimeDuration));
				index += 4;
				mb_get_binary_float(false, &line[index], &(pingchanportheader->SecondsPerPing));
				index += 4;
				mb_get_binary_short(false, &line[index], (short int *)&(pingchanportheader->ProcessingFlags));
				index += 2;
				mb_get_binary_short(false, &line[index], (short int *)&(pingchanportheader->Frequency));
				index += 2;
				mb_get_binary_short(false, &line[index], (short int *)&(pingchanportheader->InitialGainCode));
				index += 2;
				mb_get_binary_short(false, &line[index], (short int *)&(pingchanportheader->GainCode));
				index += 2;
				mb_get_binary_short(false, &line[index], (short int *)&(pingchanportheader->BandWidth));
				index += 2;
				mb_get_binary_int(false, &line[index], (int *)&(pingchanportheader->ContactNumber));
				index += 4;
				mb_get_binary_short(false, &line[index], (short int *)&(pingchanportheader->ContactClassification));
				index += 2;
				pingchanportheader->ContactSubNumber = (mb_u_char)line[index];
				index++;
				pingchanportheader->ContactType = (mb_u_char)line[index];
				index++;
				mb_get_binary_int(false, &line[index], (int *)&(pingchanportheader->NumSamples));
				index += 4;
				mb_get_binary_short(false, &line[index], (short int *)&(pingchanportheader->Reserved));
				index += 2;
				mb_get_binary_float(false, &line[index], &(pingchanportheader->ContactTimeOffTrack));
				index += 4;
				pingchanportheader->ContactCloseNumber = (mb_u_char)line[index];
				index++;
				pingchanportheader->Reserved2 = (mb_u_char)line[index];
				index++;
				mb_get_binary_float(false, &line[index], &(pingchanportheader->FixedVSOP));
				index += 4;
				for (int i = 0; i < 6; i++) {
			...
			if (status == MB_SUCCESS && read_len == read_bytes) {
				if (fileheader->chaninfo[pingchanportheader->ChannelNumber].BytesPerSample == 1) {
					...
					int index = 0;
					for (int i = 0; i < pingchanportheader->NumSamples; i++) {
						mb_get_binary_short(false, &line[index], (short *)&(data->ssrawport[i]));
						index += 2;
					}
				}
			}
			...
			if (status == MB_SUCCESS && read_len == 64) {
				int index = 0;
				mb_get_binary_short(false, &line[index], (short int *)&(pingchanstbdheader->ChannelNumber));
				index += 2;
				mb_get_binary_short(false, &line[index], (short int *)&(pingchanstbdheader->DownsampleMethod));
				index += 2;
				mb_get_binary_float(false, &line[index], &(pingchanstbdheader->SlantRange));
				index += 4;
				mb_get_binary_float(false, &line[index], &(pingchanstbdheader->GroundRange));
				index += 4;
				mb_get_binary_float(false, &line[index], &(pingchanstbdheader->TimeDelay));
				index += 4;
				mb_get_binary_float(false, &line[index], &(pingchanstbdheader->TimeDuration));
				index += 4;
				mb_get_binary_float(false, &line[index], &(pingchanstbdheader->SecondsPerPing));
				index += 4;
				mb_get_binary_short(false, &line[index], (short int *)&(pingchanstbdheader->ProcessingFlags));
				index += 2;
				mb_get_binary_short(false, &line[index], (short int *)&(pingchanstbdheader->Frequency));
				index += 2;
				mb_get_binary_short(false, &line[index], (short int *)&(pingchanstbdheader->InitialGainCode));
				index += 2;
				mb_get_binary_short(false, &line[index], (short int *)&(pingchanstbdheader->GainCode));
				index += 2;
				mb_get_binary_short(false, &line[index], (short int *)&(pingchanstbdheader->BandWidth));
				index += 2;
				mb_get_binary_int(false, &line[index], (int *)&(pingchanstbdheader->ContactNumber));
				index += 4;
				mb_get_binary_short(false, &line[index], (short int *)&(pingchanstbdheader->ContactClassification));
				index += 2;
				pingchanstbdheader->ContactSubNumber = (mb_u_char)line[index];
				index++;
				pingchanstbdheader->ContactType = (mb_u_char)line[index];
				index++;
				mb_get_binary_int(false, &line[index], (int *)&(pingchanstbdheader->NumSamples));
				index += 4;
				mb_get_binary_short(false, &line[index], (short int *)&(pingchanstbdheader->Reserved));
				index += 2;
				mb_get_binary_float(false, &line[index], &(pingchanstbdheader->ContactTimeOffTrack));
				index += 4;
				pingchanstbdheader->ContactCloseNumber = (mb_u_char)line[index];
				index++;
				pingchanstbdheader->Reserved2 = (mb_u_char)line[index];
				index++;
				mb_get_binary_float(false, &line[index], &(pingchanstbdheader->FixedVSOP));
				index += 4;
				for (int i = 0; i < 6; i++) {
			...
			if (status == MB_SUCCESS && read_len == read_bytes) {
				if (fileheader->chaninfo[pingchanstbdheader->ChannelNumber].BytesPerSample == 1) {
					...
					int index = 0;
					for (int i = 0; i < pingchanstbdheader->NumSamples; i++) {
						mb_get_binary_short(false, &line[index], (short *)&(data->ssrawstbd[i]));
						index += 2;
					}
				}
			}
		...
		/* read rest of bathymetry packet */
			...
			if (read_len == 242) {
				...
				mb_get_binary_short(false, &line[index], (short int *)&(bathheader->Year));
				index += 2;
				...
				index++;
				mb_get_binary_short(false, &line[index], (short int *)&(bathheader->JulianDay));
				index += 2;
				mb_get_binary_short(false, &line[index], (short int *)&(bathheader->CurrentLineID));
				index += 2;
				mb_get_binary_short(false, &line[index], (short int *)&(bathheader->EventNumber));
				index += 2;
				mb_get_binary_int(false, &line[index], (int *)&(bathheader->PingNumber));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->SoundVelocity));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->OceanTide));
				index += 4;
				mb_get_binary_int(false, &line[index], (int *)&(bathheader->Reserved2));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->ConductivityFreq));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->TemperatureFreq));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->PressureFreq));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->PressureTemp));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->Conductivity));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->WaterTemperature));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->Pressure));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->ComputedSoundVelocity));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->MagX));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->MagY));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->MagZ));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->AuxVal1));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->AuxVal2));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->AuxVal3));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->AuxVal4));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->AuxVal5));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->AuxVal6));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->SpeedLog));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->Turbidity));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->ShipSpeed));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->ShipGyro));
				index += 4;
				mb_get_binary_double(false, &line[index], &(bathheader->ShipYcoordinate));
				index += 8;
				mb_get_binary_double(false, &line[index], &(bathheader->ShipXcoordinate));
				index += 8;
				mb_get_binary_short(false, &line[index], (short int *)&(bathheader->ShipAltitude));
				index += 2;
				mb_get_binary_short(false, &line[index], (short int *)&(bathheader->ShipDepth));
				index += 2;
				...
				index++;
				mb_get_binary_float(false, &line[index], &(bathheader->SensorSpeed));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->KP));
				index += 4;
				mb_get_binary_double(false, &line[index], &(bathheader->SensorYcoordinate));
				index += 8;
				mb_get_binary_double(false, &line[index], &(bathheader->SensorXcoordinate));
				index += 8;
				mb_get_binary_short(false, &line[index], &(bathheader->Reserved6));
				index += 2;
				mb_get_binary_short(false, &line[index], &(bathheader->RangeToSensor));
				index += 2;
				mb_get_binary_short(false, &line[index], &(bathheader->BearingToSensor));
				index += 2;
				mb_get_binary_short(false, &line[index], &(bathheader->CableOut));
				index += 2;
				mb_get_binary_float(false, &line[index], &(bathheader->Layback));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->CableTension));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->SensorDepth));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->SensorPrimaryAltitude));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->SensorAuxAltitude));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->SensorPitch));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->SensorRoll));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->SensorHeading));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->Heave));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->Yaw));
				index += 4;
				mb_get_binary_int(false, &line[index], &(bathheader->AttitudeTimeTag));
				index += 4;
				mb_get_binary_float(false, &line[index], &(bathheader->DOT));
				index += 4;
				for (int i = 0; i < 20; i++) {
				...
				if (read_len == bathheader->packetheader.NumBytesThisRecord - 242 - 14) {
					/* check synch value */
					mb_get_binary_int(false, &line[0], (int *)&(synch));
					if (synch != 65535) {
						status = MB_FAILURE;
						*error = MB_ERROR_UNINTELLIGIBLE;
						done = MB_YES;
					...
					/* handle RESON_PACKETID_RT_VERY_OLD */
						...
						index++;
						mb_get_binary_int(false, &line[index], (int *)&(reson8100rit->Seconds));
						index += 4;
						mb_get_binary_int(false, &line[index], (int *)&(reson8100rit->Millisecs));
						index += 4;
						mb_get_binary_short(false, &line[index], (short int *)&(reson8100rit->latency));
						index += 2;
						reson8100rit->ping_number = 0;
						reson8100rit->sonar_id = 0;
						reson8100rit->sonar_model = 0;
						reson8100rit->frequency = 0;
						mb_get_binary_short(false, &line[index], (short int *)&(reson8100rit->velocity));
						index += 2;
						mb_get_binary_short(false, &line[index], (short int *)&(reson8100rit->sample_rate));
						index += 2;
						reson8100rit->pulse_width = (unsigned short)(mb_u_char)line[index];
						index++;
						mb_get_binary_short(false, &line[index], (short int *)&(reson8100rit->ping_rate));
						index += 2;
						mb_get_binary_short(false, &line[index], (short int *)&(reson8100rit->range_set));
						index += 2;
						mb_get_binary_short(false, &line[index], (short int *)&(reson8100rit->power));
						index += 2;
						mb_get_binary_short(false, &line[index], (short int *)&(reson8100rit->gain));
						index += 2;
						...
						mb_get_binary_short(false, &line[index], (short int *)&(reson8100rit->beam_count));
						index += 2;
						for (int i = 0; i < reson8100rit->beam_count; i++) {
							mb_get_binary_short(false, &line[index], (short int *)&(reson8100rit->range[i]));
					...
					/* handle RESON_PACKETID_RIT */
						...
						mb_get_binary_int(false, &line[index], (int *)&(reson8100rit->ping_number));
						index += 4;

						mb_get_binary_int(false, &line[index], (int *)&(reson8100rit->sonar_id));
						index += 4;

						mb_get_binary_short(false, &line[index], (short int *)&(reson8100rit->sonar_model));
						index += 2;

						mb_get_binary_short(false, &line[index], (short int *)&(reson8100rit->frequency));
						index += 2;
						...
						mb_get_binary_short(false, &line[index], (short int *)&(reson8100rit->pulse_width));
						index += 2;
						...
						mb_get_binary_short(false, &line[index], (short int *)&(reson8100rit->beam_width_num));
						index += 2;

						mb_get_binary_short(false, &line[index], (short int *)&(reson8100rit->beam_width_denom));
						index += 2;

						mb_get_binary_short(false, &line[index], (short int *)&(reson8100rit->projector_angle));
						index += 2;

						mb_get_binary_short(false, &line[index], (short int *)&(reson8100rit->min_range));
						index += 2;

						mb_get_binary_short(false, &line[index], (short int *)&(reson8100rit->max_range));
						index += 2;

						mb_get_binary_short(false, &line[index], (short int *)&(reson8100rit->min_depth));
						index += 2;

						mb_get_binary_short(false, &line[index], (short int *)&(reson8100rit->max_depth));
						index += 2;
						...
						mb_get_binary_short(false, &line[index], (short int *)&(reson8100rit->temperature));
						index += 2;
						...
						for (int i = 0; i < reson8100rit->beam_count; i++) {
							mb_get_binary_short(false, &line[index], (short int *)&(reson8100rit->intensity[i]));
							index += 2;
						}
					}
					else {
