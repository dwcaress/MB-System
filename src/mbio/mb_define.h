...
/* If built with CMake then the version is encoded in a symbol named MB_PACKAGE_VERSION
   else if built with Autotools then the version is set by defines in a file mbio/mb_config.h
