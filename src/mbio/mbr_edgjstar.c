...
int mbr_rt_edgjstar(int verbose, void *mbio_ptr, void *store_ptr, int *error) {
	...
	while (done == MB_NO) {
		...
		if ((read_status = fread(buffer, MBSYS_JSTAR_MESSAGE_SIZE, 1, mb_io_ptr->mbfp)) == 1) {
			...
			index = 0;
			mb_get_binary_short(false, &buffer[index], &(message.start_marker));
			index += 2;
			message.version = (mb_u_char)buffer[index];
			index++;
			message.session = (mb_u_char)buffer[index];
			index++;
			mb_get_binary_short(false, &buffer[index], &(message.type));
			index += 2;
			...
			index++;
			mb_get_binary_short(false, &buffer[index], &(message.reserved));
			index += 2;
			mb_get_binary_int(false, &buffer[index], &(message.size));
			index += 4;
		...
		/* if subbottom data and sonar trace 80 proceed to get data */
			...
			if ((read_status = fread(buffer, MBSYS_JSTAR_SBPHEADER_SIZE, 1, mb_io_ptr->mbfp)) == 1) {
				...
				mb_get_binary_int(false, &buffer[72], &testx1);
				mb_get_binary_int(false, &buffer[76], &testy1);
				mb_get_binary_int(false, &buffer[80], &testx2);
				mb_get_binary_int(false, &buffer[84], &testy2);
				...
				index = 0;
				mb_get_binary_int(false, &buffer[index], &(sbp->pingTime));
				index += 4;
				mb_get_binary_int(false, &buffer[index], &(sbp->startDepth));
				index += 4;
				mb_get_binary_int(false, &buffer[index], &(sbp->pingNum));
				index += 4;
				for (int i = 0; i < 2; i++) {
					mb_get_binary_short(false, &buffer[index], &(sbp->reserved1[i]));
					index += 2;
				}
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->lsb1));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->lsb2));
				index += 2;
				for (int i = 0; i < 3; i++) {
					mb_get_binary_short(false, &buffer[index], &(sbp->reserved2[i]));
					index += 2;
				}
				mb_get_binary_short(false, &buffer[index], &(sbp->traceIDCode));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->validityFlag));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->reserved3));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->dataFormat));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->NMEAantennaeR));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->NMEAantennaeO));
				index += 2;
				for (int i = 0; i < 2; i++) {
					mb_get_binary_short(false, &buffer[index], &(sbp->reserved4[i]));
					index += 2;
				}
				mb_get_binary_float(false, &buffer[index], &(sbp->kmOfPipe));
				index += 4;
				for (int i = 0; i < 16; i++) {
					mb_get_binary_short(false, &buffer[index], &(sbp->reserved5[i]));
					index += 2;
				}
				mb_get_binary_int(false, &buffer[index], &(sbp->coordX));
				index += 4;
				mb_get_binary_int(false, &buffer[index], &(sbp->coordY));
				index += 4;
				mb_get_binary_short(false, &buffer[index], &(sbp->coordUnits));
				index += 2;
				for (int i = 0; i < 24; i++) {
					sbp->annotation[i] = buffer[index];
					index++;
				}
				mb_get_binary_short(false, &buffer[index], &(sbp->samples));
				index += 2;
				mb_get_binary_int(false, &buffer[index], &(sbp->sampleInterval));
				index += 4;
				mb_get_binary_short(false, &buffer[index], &(sbp->ADCGain));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->pulsePower));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->reserved6));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->startFreq));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->endFreq));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->sweepLength));
				index += 2;
				mb_get_binary_int(false, &buffer[index], &(sbp->pressure));
				index += 4;
				mb_get_binary_int(false, &buffer[index], &(sbp->sonarDepth));
				index += 4;
				mb_get_binary_short(false, &buffer[index], &(sbp->sampleFreq));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->pulseID));
				index += 2;
				mb_get_binary_int(false, &buffer[index], &(sbp->sonarAltitude));
				index += 4;
				mb_get_binary_float(false, &buffer[index], &(sbp->soundspeed));
				index += 4;
				mb_get_binary_float(false, &buffer[index], &(sbp->mixerFrequency));
				index += 4;
				mb_get_binary_short(false, &buffer[index], &(sbp->year));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->day));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->hour));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->minute));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->second));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->timeBasis));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->weightingFactor));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->numberPulses));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->heading));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->pitch));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->roll));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->reserved8));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->reserved9));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->triggerSource));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->markNumber));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->NMEAHour));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->NMEAMinutes));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->NMEASeconds));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->NMEACourse));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->NMEASpeed));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->NMEADay));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->NMEAYear));
				index += 2;
				mb_get_binary_int(false, &buffer[index], &(sbp->millisecondsToday));
				index += 4;
				mb_get_binary_short(false, &buffer[index], &(sbp->ADCMax));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->reserved10));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->reserved11));
				index += 2;
				for (int i = 0; i < 6; i++) {
					sbp->softwareVersion[i] = buffer[index];
					index++;
				}
				mb_get_binary_int(false, &buffer[index], &(sbp->sphericalCorrection));
				index += 4;
				mb_get_binary_short(false, &buffer[index], &(sbp->packetNum));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->ADCDecimation));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->reserved12));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->temperature));
				index += 2;
				mb_get_binary_float(false, &buffer[index], &(sbp->layback));
				index += 4;
				mb_get_binary_int(false, &buffer[index], &(sbp->reserved13));
				index += 4;
				mb_get_binary_short(false, &buffer[index], &(sbp->cableOut));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(sbp->reserved14));
				index += 2;
		...
		/* if sidescan data and sonar trace 80 proceed to get data */
			...
			if ((read_status = fread(buffer, MBSYS_JSTAR_SBPHEADER_SIZE, 1, mb_io_ptr->mbfp)) == 1) {
				...
				index = 0;
				mb_get_binary_int(false, &buffer[index], &(ss->pingTime));
				index += 4;
				mb_get_binary_int(false, &buffer[index], &(ss->startDepth));
				index += 4;
				mb_get_binary_int(false, &buffer[index], &(ss->pingNum));
				index += 4;
				for (int i = 0; i < 2; i++) {
					mb_get_binary_short(false, &buffer[index], &(ss->reserved1[i]));
					index += 2;
				}
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->lsb1));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->lsb2));
				index += 2;
				for (int i = 0; i < 3; i++) {
					mb_get_binary_short(false, &buffer[index], &(ss->reserved2[i]));
					index += 2;
				}
				mb_get_binary_short(false, &buffer[index], &(ss->traceIDCode));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->validityFlag));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->reserved3));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->dataFormat));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->NMEAantennaeR));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->NMEAantennaeO));
				index += 2;
				for (int i = 0; i < 2; i++) {
					mb_get_binary_short(false, &buffer[index], &(ss->reserved4[i]));
					index += 2;
				}
				mb_get_binary_float(false, &buffer[index], &(ss->kmOfPipe));
				index += 4;
				for (int i = 0; i < 16; i++) {
					mb_get_binary_short(false, &buffer[index], &(ss->reserved5[i]));
					index += 2;
				}
				mb_get_binary_int(false, &buffer[index], &(ss->coordX));
				index += 4;
				mb_get_binary_int(false, &buffer[index], &(ss->coordY));
				index += 4;
				mb_get_binary_short(false, &buffer[index], &(ss->coordUnits));
				index += 2;
				for (int i = 0; i < 24; i++) {
					ss->annotation[i] = buffer[index];
					index++;
				}
				mb_get_binary_short(false, &buffer[index], &(ss->samples));
				index += 2;
				mb_get_binary_int(false, &buffer[index], &(ss->sampleInterval));
				index += 4;
				mb_get_binary_short(false, &buffer[index], &(ss->ADCGain));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->pulsePower));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->reserved6));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->startFreq));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->endFreq));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->sweepLength));
				index += 2;
				mb_get_binary_int(false, &buffer[index], &(ss->pressure));
				index += 4;
				mb_get_binary_int(false, &buffer[index], &(ss->sonarDepth));
				index += 4;
				mb_get_binary_short(false, &buffer[index], &(ss->sampleFreq));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->pulseID));
				index += 2;
				mb_get_binary_int(false, &buffer[index], &(ss->sonarAltitude));
				index += 4;
				mb_get_binary_float(false, &buffer[index], &(ss->soundspeed));
				index += 4;
				mb_get_binary_float(false, &buffer[index], &(ss->mixerFrequency));
				index += 4;
				mb_get_binary_short(false, &buffer[index], &(ss->year));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->day));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->hour));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->minute));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->second));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->timeBasis));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->weightingFactor));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->numberPulses));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->heading));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->pitch));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->roll));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->reserved8));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->reserved9));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->triggerSource));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->markNumber));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->NMEAHour));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->NMEAMinutes));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->NMEASeconds));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->NMEACourse));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->NMEASpeed));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->NMEADay));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->NMEAYear));
				index += 2;
				mb_get_binary_int(false, &buffer[index], &(ss->millisecondsToday));
				index += 4;
				mb_get_binary_short(false, &buffer[index], &(ss->ADCMax));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->reserved10));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->reserved11));
				index += 2;
				for (int i = 0; i < 6; i++) {
					ss->softwareVersion[i] = buffer[index];
					index++;
				}
				mb_get_binary_int(false, &buffer[index], &(ss->sphericalCorrection));
				index += 4;
				mb_get_binary_short(false, &buffer[index], &(ss->packetNum));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->ADCDecimation));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->reserved12));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->temperature));
				index += 2;
				mb_get_binary_float(false, &buffer[index], &(ss->layback));
				index += 4;
				mb_get_binary_int(false, &buffer[index], &(ss->reserved13));
				index += 4;
				mb_get_binary_short(false, &buffer[index], &(ss->cableOut));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ss->reserved14));
				index += 2;
		...
		/* if subbottom data and sonar trace 82 proceed to get data
			...
			if ((read_status = fread(buffer, MBSYS_JSTAR_SSOLDHEADER_SIZE, 1, mb_io_ptr->mbfp)) == 1) {
				index = 0;
				mb_get_binary_short(false, &buffer[index], &(ssold_tmp.subsystem));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ssold_tmp.channelNum));
				index += 2;
				mb_get_binary_int(false, &buffer[index], &(ssold_tmp.pingNum));
				index += 4;
				mb_get_binary_short(false, &buffer[index], &(ssold_tmp.packetNum));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ssold_tmp.trigSource));
				index += 2;
				mb_get_binary_int(false, &buffer[index], &(ssold_tmp.samples));
				index += 4;
				mb_get_binary_int(false, &buffer[index], &(ssold_tmp.sampleInterval));
				index += 4;
				mb_get_binary_int(false, &buffer[index], &(ssold_tmp.startDepth));
				index += 4;
				mb_get_binary_short(false, &buffer[index], &(ssold_tmp.weightingFactor));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ssold_tmp.ADCGain));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ssold_tmp.ADCMax));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ssold_tmp.rangeSetting));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ssold_tmp.pulseID));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ssold_tmp.markNumber));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ssold_tmp.dataFormat));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ssold_tmp.reserved));
				index += 2;
				mb_get_binary_int(false, &buffer[index], &(ssold_tmp.millisecondsToday));
				index += 4;
				mb_get_binary_short(false, &buffer[index], &(ssold_tmp.year));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ssold_tmp.day));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ssold_tmp.hour));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ssold_tmp.minute));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ssold_tmp.second));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ssold_tmp.heading));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ssold_tmp.pitch));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ssold_tmp.roll));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ssold_tmp.heave));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(ssold_tmp.yaw));
				index += 2;
				mb_get_binary_int(false, &buffer[index], &(ssold_tmp.depth));
				index += 4;
				mb_get_binary_short(false, &buffer[index], &(ssold_tmp.temperature));
				index += 2;
				for (int i = 0; i < 10; i++) {
		...
		/* system info record */
			...
			if ((read_status = fread(buffer, message.size, 1, mb_io_ptr->mbfp)) == 1) {
				index = 0;
				mb_get_binary_int(false, &buffer[index], &(sysinfo->system_type));
				index += 4;
				mb_get_binary_int(false, &buffer[index], &(sysinfo->reserved1));
				index += 4;
				mb_get_binary_int(false, &buffer[index], &(sysinfo->version));
				index += 4;
				mb_get_binary_int(false, &buffer[index], &(sysinfo->reserved2));
				index += 4;
				mb_get_binary_int(false, &buffer[index], &(sysinfo->platformserialnumber));
				index += 4;
		...
		/* file timestamp record */
			...
			if ((read_status = fread(buffer, message.size, 1, mb_io_ptr->mbfp)) == 1) {
				index = 0;
				mb_get_binary_int(false, &buffer[index], &(filetimestamp->seconds));
				index += 4;
				mb_get_binary_int(false, &buffer[index], &(filetimestamp->milliseconds));
				index += 4;
		...
		/* if nmea data read it, parse it, and and store values for interpolation */
			...
			if ((read_status = fread(buffer, message.size, 1, mb_io_ptr->mbfp)) == 1) {
				index = 0;
				mb_get_binary_int(false, &buffer[index], &(nmea->seconds));
				index += 4;
				mb_get_binary_int(false, &buffer[index], &(nmea->milliseconds));
				index += 4;
		...
		/* if pitchroll data read it */
			...
			if ((read_status = fread(buffer, message.size, 1, mb_io_ptr->mbfp)) == 1) {
				index = 0;
				mb_get_binary_int(false, &buffer[index], &(pitchroll->seconds));
				index += 4;
				mb_get_binary_int(false, &buffer[index], &(pitchroll->milliseconds));
				index += 4;
				...
				index++;
				mb_get_binary_short(false, &buffer[index], &(pitchroll->accelerationx));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(pitchroll->accelerationy));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(pitchroll->accelerationz));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(pitchroll->gyroratex));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(pitchroll->gyroratey));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(pitchroll->gyroratez));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(pitchroll->pitch));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(pitchroll->roll));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(pitchroll->temperature));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(pitchroll->deviceinfo));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(pitchroll->heave));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(pitchroll->heading));
				index += 2;
				mb_get_binary_int(false, &buffer[index], &(pitchroll->datavalidflags));
				index += 4;
				mb_get_binary_int(false, &buffer[index], &(pitchroll->reserve2));
				index += 4;
		...
		/* if pressure data read it */
			...
			if ((read_status = fread(buffer, message.size, 1, mb_io_ptr->mbfp)) == 1) {
				index = 0;
				mb_get_binary_int(false, &buffer[index], &(pressure->seconds));
				index += 4;
				mb_get_binary_int(false, &buffer[index], &(pressure->milliseconds));
				index += 4;
				...
				index++;
				mb_get_binary_int(false, &buffer[index], &(pressure->pressure));
				index += 4;
				mb_get_binary_int(false, &buffer[index], &(pressure->salinity));
				index += 4;
				mb_get_binary_int(false, &buffer[index], &(pressure->datavalidflags));
				index += 4;
				mb_get_binary_int(false, &buffer[index], &(pressure->conductivity));
				index += 4;
				mb_get_binary_int(false, &buffer[index], &(pressure->soundspeed));
				index += 4;
				for (int i = 0; i < 10; i++) {
					mb_get_binary_int(false, &buffer[index], &(pressure->reserve2[i]));
					index += 4;
				}
#ifdef MBF_EDGJSTAR_DEBUG
		...
		/* if dvl data read it */
			...
			if ((read_status = fread(buffer, message.size, 1, mb_io_ptr->mbfp)) == 1) {
				index = 0;
				mb_get_binary_int(false, &buffer[index], &(dvl->seconds));
				index += 4;
				mb_get_binary_int(false, &buffer[index], &(dvl->milliseconds));
				index += 4;
				...
				index++;
				mb_get_binary_int(false, &buffer[index], &(dvl->datavalidflags));
				index += 4;
				mb_get_binary_int(false, &buffer[index], &(dvl->beam1range));
				index += 4;
				mb_get_binary_int(false, &buffer[index], &(dvl->beam2range));
				index += 4;
				mb_get_binary_int(false, &buffer[index], &(dvl->beam3range));
				index += 4;
				mb_get_binary_int(false, &buffer[index], &(dvl->beam4range));
				index += 4;
				mb_get_binary_short(false, &buffer[index], &(dvl->velocitybottomx));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(dvl->velocitybottomy));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(dvl->velocitybottomz));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(dvl->velocitywaterx));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(dvl->velocitywatery));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(dvl->velocitywaterz));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(dvl->depth));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(dvl->pitch));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(dvl->roll));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(dvl->heading));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(dvl->salinity));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(dvl->temperature));
				index += 2;
				mb_get_binary_short(false, &buffer[index], &(dvl->soundspeed));
				index += 2;
				for (int i = 0; i < 7; i++) {
					mb_get_binary_short(false, &buffer[index], &(dvl->reserve2[i]));
					index += 2;
				}
