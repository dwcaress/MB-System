/*--------------------------------------------------------------------
 *    The MB-system:	mbr_sbsiolsi.c	3.00	2/2/93
 *	$Id: mbr_sbsiolsi.c,v 3.0 1993-05-14 22:57:44 sohara Exp $
 *
 *    Copyright (c) 1993 by 
...
int	*error;
{
 static char res_id[]="$Id: mbr_sbsiolsi.c,v 3.0 1993-05-14 22:57:44 sohara Exp $";
