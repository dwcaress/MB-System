 ...
 *	$Id: mbsys_reson.c,v 4.0 1994-10-21 12:35:00 caress Exp $
 *
 *    Copyright (c) 1994 by 
...
int	*error;
{
 static char res_id[]="$Id: mbsys_reson.c,v 4.0 1994-10-21 12:35:00 caress Exp $";
...
/*--------------------------------------------------------------------*/
int mbsys_reson_ttimes(verbose,mbio_ptr,store_ptr,kind,
