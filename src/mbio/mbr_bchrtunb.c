 ...
 *	$Id: mbr_bchrtunb.c,v 5.8 2005/11/05 00:48:04 caress Exp $
 *
...
{
	static char res_id[]="$Id: mbr_bchrtunb.c,v 5.8 2005/11/05 00:48:04 caress Exp $";
...
/*--------------------------------------------------------------------*/
int mbr_bchrtunb_wr_data(int verbose, void *mbio_ptr, char *data_ptr, int *error)
{
