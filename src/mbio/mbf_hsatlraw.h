/*--------------------------------------------------------------------
 *    The MB-system:	mbf_hsatlraw.h	3.00	1/20/93
 *	$Id: mbf_hsatlraw.h,v 3.0 1993-05-14 22:50:34 sohara Exp $
 *
 *    Copyright (c) 1993 by 
 ...
 * to store multibeam data read from the MBF_HSATLRAW format (MBIO id 7).  
 *
 * Author:	D. W. Caress
