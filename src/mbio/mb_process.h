...
#define MBP_AMPCORR_NORMALSTD 3
...
int mb_pr_update_ampcorr(int verbose, char *file, int mbp_ampcorr_mode, char *mbp_ampcorrfile, int mbp_ampcorr_type,
                         int mbp_ampcorr_symmetry, double mbp_ampcorr_angle, int mbp_ampcorr_slope, int mbp_ampcorr_area, char *mbp_ampcorr_topofile,
                         int *error);
int mb_pr_update_sscorr(int verbose, char *file, int mbp_sscorr_mode, char *mbp_sscorrfile, int mbp_sscorr_type,
                        int mbp_sscorr_symmetry, double mbp_sscorr_angle, int mbp_sscorr_slope, int mbp_sscorr_area, char *mbp_sscorr_topofile,
                        int *error);
