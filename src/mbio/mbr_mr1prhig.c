 ...
 *	$Id: mbr_mr1prhig.c,v 5.6 2003-04-17 21:05:23 caress Exp $
 *
...
int mbr_register_mr1prhig(int verbose, void *mbio_ptr, 
		int *error);
...
{
	static char res_id[]="$Id: mbr_mr1prhig.c,v 5.6 2003-04-17 21:05:23 caress Exp $";
...
/*--------------------------------------------------------------------*/
int mbr_mr1prhig_wr_data(int verbose, void *mbio_ptr, char *data_ptr, int *error)
{
