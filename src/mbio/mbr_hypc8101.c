 ...
 *	$Id: mbr_hypc8101.c,v 5.1 2001-01-22 07:43:34 caress Exp $
 *
...
int mbr_info_hypc8101(int verbose, 
			...
			int *error)
{
	static char res_id[]="$Id: mbr_hypc8101.c,v 5.1 2001-01-22 07:43:34 caress Exp $";
	...
	*format_alloc = &mbr_alm_hypc8101;
	*format_free = &mbr_dem_hypc8101; 
	*store_alloc = &mbsys_reson_alloc; 
	*store_free = &mbsys_reson_deall; 
	*read_ping = &mbr_rt_hypc8101; 
	*write_ping = &mbr_wt_hypc8101; 
