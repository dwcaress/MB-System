 ...
 *	$Id: mbr_sbsiocen.c,v 5.1 2001-01-22 07:43:34 caress Exp $
 *
...
int mbr_info_sbsiocen(int verbose, 
			...
			int *error)
{
	static char res_id[]="$Id: mbr_sbsiocen.c,v 5.1 2001-01-22 07:43:34 caress Exp $";
