/*--------------------------------------------------------------------
 *    The MB-system:	mbr_sbsiocen.c	3.00	2/2/93
 *	$Id: mbr_sbsiocen.c,v 3.0 1993-05-14 22:57:19 sohara Exp $
 *
 *    Copyright (c) 1993 by 
...
int	*error;
{
 static char res_id[]="$Id: mbr_sbsiocen.c,v 3.0 1993-05-14 22:57:19 sohara Exp $";
