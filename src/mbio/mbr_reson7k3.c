...
int mbr_reson7kr_rd_pantilt(int verbose, char *buffer, void *store_ptr, int *error);
int mbr_reson7kr_rd_sonarinstallationids(int verbose, char *buffer, void *store_ptr, int *error);
int mbr_reson7kr_rd_sonarpipeenvironment(int verbose, char *buffer, void *store_ptr, int *error);
int mbr_reson7kr_rd_contact_output(int verbose, char *buffer, void *store_ptr, int *error);
int mbr_reson7kr_rd_sonarsettings(int verbose, char *buffer, void *store_ptr, int *error);
...
int mbr_reson7kr_rd_sidescanint verbose, char *buffer, void *store_ptr, int *error);
int mbr_reson7kr_rd_watercolumn(int verbose, char *buffer, void *store_ptr, int *error);
...
int mbr_reson7kr_rd_adaptivegate(int verbose, char *buffer, void *store_ptr, int *error);
...
int mbr_reson7kr_rd_vernierprocessingdataraw(int verbose, char *buffer, void *store_ptr, int *error);
int mbr_reson7kr_rd_bite(int verbose, char *buffer, void *store_ptr, int *error);
int mbr_reson7kr_rd_v37kcenterversion(int verbose, char *buffer, void *store_ptr, int *error);
...
int mbr_reson7kr_rd_snippet(int verbose, char *buffer, void *store_ptr, int *error);
int mbr_reson7kr_rd_vernierprocessingdatafiltered(int verbose, char *buffer, void *store_ptr, int *error);
int mbr_reson7kr_rd_installation(int verbose, char *buffer, void *store_ptr, int *error);
int mbr_reson7kr_rd_bitesummary(int verbose, char *buffer, void *store_ptr, int *error);
int mbr_reson7kr_rd_compressedbeamformedmagnitude(int verbose, char *buffer, void *store_ptr, int *error);
int mbr_reson7kr_rd_compressedwatercolumn(int verbose, char *buffer, void *store_ptr, int *error);
int mbr_reson7kr_rd_segmentedrawdetection(int verbose, char *buffer, void *store_ptr, int *error);
int mbr_reson7kr_rd_calibratedbeam(int verbose, char *buffer, void *store_ptr, int *error);
int mbr_reson7kr_rd_systemeventmessage(int verbose, char *buffer, void *store_ptr, int *error);
int mbr_reson7kr_rd_rdrrecordingstatus(int verbose, char *buffer, void *store_ptr, int *error);
int mbr_reson7kr_rd_subscriptions(int verbose, char *buffer, void *store_ptr, int *error);
int mbr_reson7kr_rd_rdrstoragerecording(int verbose, char *buffer, void *store_ptr, int *error);
int mbr_reson7kr_rd_calibrationstatus(int verbose, char *buffer, void *store_ptr, int *error);
int mbr_reson7kr_rd_calibratedsidescan(int verbose, char *buffer, void *store_ptr, int *error);
int mbr_reson7kr_rd_snippetbackscatteringstrength(int verbose, char *buffer, void *store_ptr, int *error);
int mbr_reson7kr_rd_mb2status(int verbose, char *buffer, void *store_ptr, int *error);
int mbr_reson7kr_rd_fileheader(int verbose, char *buffer, void *store_ptr, int *error);
int mbr_reson7kr_rd_filecatalogrecord(int verbose, char *buffer, void *store_ptr, int *error);
int mbr_reson7kr_rd_timemessage(int verbose, char *buffer, void *store_ptr, int *error);
int mbr_reson7kr_rd_remotecontrol(int verbose, char *buffer, void *store_ptr, int *error);
int mbr_reson7kr_rd_remotecontrolacknowledge(int verbose, char *buffer, void *store_ptr, int *error);
int mbr_reson7kr_rd_remotecontrolnotacknowledge(int verbose, char *buffer, void *store_ptr, int *error);
int mbr_reson7kr_rd_remotecontrolsettings(int verbose, char *buffer, void *store_ptr, int *error);
int mbr_reson7kr_rd_commonsystemsettings(int verbose, char *buffer, void *store_ptr, int *error);
int mbr_reson7kr_rd_svfiltering(int verbose, char *buffer, void *store_ptr, int *error);
int mbr_reson7kr_rd_systemlockstatus(int verbose, char *buffer, void *store_ptr, int *error);
...
int mbr_reson7kr_wr_pantilt(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error);
int mbr_reson7kr_wr_sonarinstallationids(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error);
int mbr_reson7kr_wr_sonarpipeenvironment(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error);
int mbr_reson7kr_wr_contactoutput(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error);
int mbr_reson7kr_wr_sonarsettings(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size,
                                          int *error);
...
int mbr_reson7kr_wr_sidescan(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error);
int mbr_reson7kr_wr_watercolumn(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error);
...
int mbr_reson7kr_wr_adaptivegate(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error);
...
int mbr_reson7kr_wr_vernierprocessingdataraw(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error);
int mbr_reson7kr_wr_bite(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error);
int mbr_reson7kr_wr_v37kcenterversion(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error);
...
int mbr_reson7kr_wr_vernierprocessingdatafiltered(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, 
                                            int *error);
int mbr_reson7kr_wr_installation(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error);
int mbr_reson7kr_wr_bitesummary(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error);
int mbr_reson7kr_wr_compressedbeamformedmagnitude(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error);
int mbr_reson7kr_wr_compressedwatercolumn(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error);
int mbr_reson7kr_wr_segmentedrawdetection(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error);
int mbr_reson7kr_wr_calibratedbeam(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error);
int mbr_reson7kr_wr_systemeventmessage(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error);
int mbr_reson7kr_wr_rdrrecordingstatus(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error);
int mbr_reson7kr_wr_subscriptions(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error);
int mbr_reson7kr_wr_rdrstoragerecording(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error);
int mbr_reson7kr_wr_calibrationstatus(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error);
int mbr_reson7kr_wr_calibratedsidescan(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error);
int mbr_reson7kr_wr_snippetbackscatteringstrength(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error);
int mbr_reson7kr_wr_mb2status(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error);
int mbr_reson7kr_wr_fileheader(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error);
int mbr_reson7kr_wr_filecatalogrecord(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error);
int mbr_reson7kr_wr_timemessage(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error);
int mbr_reson7kr_wr_remotecontrol(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error);
int mbr_reson7kr_wr_remotecontrolacknowledge(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error);
int mbr_reson7kr_wr_remotecontrolnotacknowledge(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error);
int mbr_reson7kr_wr_remotecontrolsettings(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size,
                                          int *error);
int mbr_reson7kr_wr_commonsystemsettings(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error);
int mbr_reson7kr_wr_svfiltering(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error);
int mbr_reson7kr_wr_systemlockstatus(int verbose, int *bufferalloc, char **bufferptr, void *store_ptr, int *size, int *error);
