 ...
 *	$Id: mbsys_mstiff.c,v 4.1 2000-09-30 06:32:52 caress Exp $
 *
...
/*--------------------------------------------------------------------*/
int mbsys_mstiff_alloc(verbose,mbio_ptr,store_ptr,error)
int	verbose;
char	*mbio_ptr;
char	**store_ptr;
int	*error;
{
 static char res_id[]="$Id: mbsys_mstiff.c,v 4.1 2000-09-30 06:32:52 caress Exp $";
...
/*--------------------------------------------------------------------*/
int mbsys_mstiff_deall(verbose,mbio_ptr,store_ptr,error)
int	verbose;
char	*mbio_ptr;
char	**store_ptr;
int	*error;
...
/*--------------------------------------------------------------------*/
int mbsys_mstiff_extract(verbose,mbio_ptr,store_ptr,kind,
...
/*--------------------------------------------------------------------*/
int mbsys_mstiff_insert(verbose,mbio_ptr,store_ptr,
		time_i,time_d,navlon,navlat,speed,heading,
		nbath,namp,nss,
		beamflag,bath,amp,
		bathacrosstrack,bathalongtrack,
...
/*--------------------------------------------------------------------*/
int mbsys_mstiff_ttimes(verbose,mbio_ptr,store_ptr,kind,nbeams,
...
/*--------------------------------------------------------------------*/
int mbsys_mstiff_altitude(verbose,mbio_ptr,store_ptr,
...
/*--------------------------------------------------------------------*/
int mbsys_mstiff_extract_nav(verbose,mbio_ptr,store_ptr,kind,
...
/*--------------------------------------------------------------------*/
int mbsys_mstiff_insert_nav(verbose,mbio_ptr,store_ptr,
		time_i,time_d,navlon,navlat,speed,heading,draft, 
		roll,pitch,heave,error)
int	verbose;
char	*mbio_ptr;
...
/*--------------------------------------------------------------------*/
int mbsys_mstiff_copy(verbose,mbio_ptr,store_ptr,copy_ptr,error)
int	verbose;
char	*mbio_ptr;
char	*store_ptr;
char	*copy_ptr;
