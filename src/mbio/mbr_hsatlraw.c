 ...
 *	$Id: mbr_hsatlraw.c,v 5.1 2001-01-22 07:43:34 caress Exp $
 *
...
int mbr_info_hsatlraw(int verbose, 
			...
			int *error)
{
	static char res_id[]="$Id: mbr_hsatlraw.c,v 5.1 2001-01-22 07:43:34 caress Exp $";
	...
	*format_alloc = &mbr_alm_hsatlraw;
	*format_free = &mbr_dem_hsatlraw; 
	*store_alloc = &mbsys_hsds_alloc; 
	*store_free = &mbsys_hsds_deall; 
	*read_ping = &mbr_rt_hsatlraw; 
	*write_ping = &mbr_wt_hsatlraw; 
	...
	*extract_svp = &mbsys_hsds_extract_svp; 
	*insert_svp = &mbsys_hsds_insert_svp; 
