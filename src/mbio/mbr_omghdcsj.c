			...
			int *error)
{
	...
	*format_alloc = &mbr_alm_omghdcsj;
	*format_free = &mbr_dem_omghdcsj; 
	*store_alloc = &mbsys_hdcs_alloc; 
	*store_free = &mbsys_hdcs_deall; 
	*read_ping = &mbr_rt_omghdcsj; 
	*write_ping = &mbr_wt_omghdcsj; 
	*extract = &mbsys_hdcs_extract; 
