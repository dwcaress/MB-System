 ...
 *	$Id: mbsys_mr1.c,v 4.16 1998-10-05 17:46:15 caress Exp $
 *
 ...
 *   mbsys_mr1_extract_nav - extract navigation data from
 *                          mbsys_mr1_struct structure
 *   mbsys_mr1_insert_nav - insert navigation data into
 *                          mbsys_mr1_struct structure
...
int	*error;
{
 static char res_id[]="$Id: mbsys_mr1.c,v 4.16 1998-10-05 17:46:15 caress Exp $";
...
/*--------------------------------------------------------------------*/
int mbsys_mr1_altitude(verbose,mbio_ptr,store_ptr,
...
int	*error;
{
	char	*function_name = "mbsys_mr1_altitude";
	int	status = MB_SUCCESS;
	struct mb_io_struct *mb_io_ptr;
	struct mbsys_mr1_struct *store;
	int	beam_center;
...
/*--------------------------------------------------------------------*/
int mbsys_mr1_extract_nav(verbose,mbio_ptr,store_ptr,kind,
		time_i,time_d,navlon,navlat,speed,heading,
...
/*--------------------------------------------------------------------*/
int mbsys_mr1_insert_nav(verbose,mbio_ptr,store_ptr,
		time_i,time_d,navlon,navlat,speed,heading,
		roll,pitch,heave,error)
int	verbose;
char	*mbio_ptr;
