			...
			int *error)
{
	...
	*format_alloc = &mbr_alm_sb2120xs;
	*format_free = &mbr_dem_sb2120xs; 
	*store_alloc = &mbsys_sb2120_alloc; 
	*store_free = &mbsys_sb2120_deall; 
	*read_ping = &mbr_rt_sb2120xs; 
	*write_ping = &mbr_wt_sb2120xs; 
	*extract = &mbsys_sb2120_extract; 
