...
int mbnavedit_clear_screen(void) {
  ...
  (*fillRectangle)(mbnavedit_xgid, 0, 0, plot_width,
		   NUMBER_PLOTS_MAX * plot_height, WHITE,
		   SOLID_LINE);
...
int mbnavedit_action_set_interval(int xx, int yy, int which) {
  ...
  if (nplot > 0 && number_plots > 0) {
	...
	xx = mbnavplot[0].ixmax;
      ...
      for (int i = 0; i < number_plots; i++) {
	(*drawLine)(mbnavedit_xgid, interval_bound1,
		    mbnavplot[i].iymin,
		    interval_bound1,
		    mbnavplot[i].iymax,
		    RED, DASH_LINE);
	...
	xx = mbnavplot[0].ixmax;
      ...
      /* plot line on all plots */
      for (int i = 0; i < number_plots; i++) {
	(*drawLine)(mbnavedit_xgid, interval_bound2,
		    mbnavplot[i].iymin,
		    interval_bound2, mbnavplot[i].iymax,
		    RED, DASH_LINE);
      }
    }
...
int mbnavedit_plot_all(void) {
  ...
  if (nplot > 0) {
    ...
    for (int iplot = 0; iplot < number_plots; iplot++) {
      ...
      (*drawString)(mbnavedit_xgid, center_x - swidth / 2,
	...
	fpx = center_x + 2 * margin_x - fpdx;
      ...
      (*fillRectangle)(mbnavedit_xgid, fpx, fpy, fpdx, fpdy,
		       LIGHTGREY, SOLID_LINE);
			
      (*drawRectangle)(mbnavedit_xgid, fpx, fpy, fpdx, fpdy,
		       BLACK, SOLID_LINE);

      sprintf(string, "0 ");
      (*justifyString)(mbnavedit_xgid, string, &swidth,
		       &sascent, &sdescent);

      (*drawString)(mbnavedit_xgid,
	...
	/* draw tickmarks */
	(*drawLine)(mbnavedit_xgid, ix,
		    mbnavplot[iplot].iymin, ix,
	...
	(*justifyString)(mbnavedit_xgid, string,
	...
	strcpy(yformat, "%6.2f");
      ...
      (*drawString)(mbnavedit_xgid,
		    (int)(mbnavplot[iplot].ixmin - swidth -
			  0.03 * margin_x),
		    (int)(mbnavplot[iplot].iymax +
			  0.5 * sascent), string,
		    BLACK, SOLID_LINE);
...
int mbnavedit_plot_tint(int iplot) {
  ...
  if (plot_tint_org) {
    ...
    for (int i = current_id + 1; i < current_id + nplot; i++) {
      ...
      (*drawLine)(mbnavedit_xgid, tint_x1, tint_y1,
  ...
  for (int i = current_id; i < current_id + nplot; i++) {
    ...
    if (ping[i].tint_select)
      (*drawRectangle)(mbnavedit_xgid, ping[i].tint_x - 2,
		       ping[i].tint_y - 2, 4, 4,
		       RED, SOLID_LINE);
      ...
      (*fillRectangle)(mbnavedit_xgid, ping[i].tint_x - 2,
		       ping[i].tint_y - 2, 4, 4,
		       BLACK, SOLID_LINE);
  }
...
int mbnavedit_plot_lon(int iplot) {
  ...
  if (plot_lon_org) {
    ...
    for (int i = current_id + 1; i < current_id + nplot; i++) {
      ...
      (*drawLine)(mbnavedit_xgid, lon_x1, lon_y1,
		  lon_x2, lon_y2, GREEN,
		  SOLID_LINE);
      lon_x1 = lon_x2;
      lon_y1 = lon_y2;
  ...
  for (int i = current_id; i < current_id + nplot; i++) {
    ...
    ping[i].lon_y = iymin + yscale * (ping[i].lon - ymin);
    if (ping[i].lon_select)
      (*drawRectangle)(mbnavedit_xgid, ping[i].lon_x - 2,
		       ping[i].lon_y - 2, 4, 4,
		       RED, SOLID_LINE);
      ...
      (*fillRectangle)(mbnavedit_xgid, ping[i].lon_x - 2,
		       ping[i].lon_y - 2, 4, 4,
		       BLACK, SOLID_LINE);
  }
...
int mbnavedit_plot_lat(int iplot) {
  ...
  if (plot_lat_org) {
    ...
    for (int i = current_id + 1; i < current_id + nplot; i++) {
      ...
      (*drawLine)(mbnavedit_xgid, lat_x1, lat_y1, lat_x2,
  ...
  if (model_mode != MODEL_MODE_OFF && plot_lat_dr) {
    ...
    for (int i = current_id + 1; i < current_id + nplot; i++) {
      ...
      (*drawLine)(mbnavedit_xgid, lat_x1, lat_y1,
		  lat_x2, lat_y2, BLUE,
		  SOLID_LINE);
      lat_x1 = lat_x2;
      lat_y1 = lat_y2;
  ...
  for (int i = current_id; i < current_id + nplot; i++) {
    ...
    if (ping[i].lonlat_flag)
      (*drawRectangle)(mbnavedit_xgid, ping[i].lat_x - 2,
		       ping[i].lat_y - 2, 4, 4,
		       ORANGE, SOLID_LINE);
  }
  ...
  for (int i = current_id; i < current_id + nplot; i++) {
    ...
    if (ping[i].lat_select)
      ...
      (*fillRectangle)(mbnavedit_xgid, ping[i].lat_x - 2,
		       ping[i].lat_y - 2, 4, 4,
		       BLACK, SOLID_LINE);
  }
...
int mbnavedit_plot_speed(int iplot) {
  ...
  if (plot_speed_org) {
    ...
    for (int i = current_id + 1; i < current_id + nplot; i++) {
      ...
      (*drawLine)(mbnavedit_xgid, speed_x1, speed_y1,
  ...
  for (int i = current_id; i < current_id + nplot; i++) {
    ...
    if (ping[i].speed_select)
      (*drawRectangle)(mbnavedit_xgid, ping[i].speed_x - 2,
      ...
      (*fillRectangle)(mbnavedit_xgid, ping[i].speed_x - 2,
		       ping[i].speed_y - 2, 4, 4,
		       BLACK, SOLID_LINE);
  }
...
int mbnavedit_plot_heading(int iplot) {
  ...
  if (plot_heading_org) {
    ...
    for (int i = current_id + 1; i < current_id + nplot; i++) {
      ...
      (*drawLine)(mbnavedit_xgid, heading_x1, heading_y1,
  ...
  for (int i = current_id; i < current_id + nplot; i++) {
    ...
    if (ping[i].heading_select)
      (*drawRectangle)(mbnavedit_xgid, ping[i].heading_x - 2,
      ...
      (*fillRectangle)(mbnavedit_xgid, ping[i].heading_x - 2,
		       ping[i].heading_y - 2, 4, 4,
		       BLACK,
		       SOLID_LINE);
  }
...
int mbnavedit_plot_draft(int iplot) {
  ...
  if (plot_draft_org) {
    ...
    for (int i = current_id + 1; i < current_id + nplot; i++) {
      ...
      (*drawLine)(mbnavedit_xgid, draft_x1, draft_y1, draft_x2, draft_y2,
		  GREEN, SOLID_LINE);
      draft_x1 = draft_x2;
      draft_y1 = draft_y2;
    }
  ...
  for (int i = current_id; i < current_id + nplot; i++) {
    ...
    if (ping[i].draft_select)
      (*drawRectangle)(mbnavedit_xgid, ping[i].draft_x - 2, ping[i].draft_y - 2,
		       4, 4, RED, SOLID_LINE);
    else if (ping[i].draft != ping[i].draft_org)
      (*drawRectangle)(mbnavedit_xgid, ping[i].draft_x - 2,
		       ping[i].draft_y - 2,
		       4, 4, PURPLE, SOLID_LINE);
    else
      (*fillRectangle)(mbnavedit_xgid, ping[i].draft_x - 2,
...
int mbnavedit_plot_roll(int iplot) {
  ...
  if (plot_roll) {
    ...
    for (int i = current_id + 1; i < current_id + nplot; i++) {
      ...
      (*drawLine)(mbnavedit_xgid, roll_x1, roll_y1, roll_x2, roll_y2,
		  GREEN, SOLID_LINE);
      roll_x1 = roll_x2;
      roll_y1 = roll_y2;
    }
...
int mbnavedit_plot_pitch(int iplot) {
  ...
  if (plot_pitch) {
    ...
    for (int i = current_id + 1; i < current_id + nplot; i++) {
      ...
      (*drawLine)(mbnavedit_xgid, pitch_x1, pitch_y1, pitch_x2, pitch_y2,
		  GREEN, SOLID_LINE);
      pitch_x1 = pitch_x2;
      pitch_y1 = pitch_y2;
    }
...
int mbnavedit_plot_heave(int iplot) {
  ...
  if (plot_heave) {
    ...
    for (int i = current_id + 1; i < current_id + nplot; i++) {
      ...
      (*drawLine)(mbnavedit_xgid, heave_x1, heave_y1, heave_x2, heave_y2,
		  GREEN, SOLID_LINE);
      heave_x1 = heave_x2;
      heave_y1 = heave_y2;
    }
...
int mbnavedit_plot_tint_value(int iplot, int iping) {
  ...
  (*drawRectangle)(mbnavedit_xgid, ping[iping].tint_x - 2,
		   ping[iping].tint_y - 2, 4, 4, WHITE,
		   SOLID_LINE);
  (*fillRectangle)(mbnavedit_xgid, ping[iping].tint_x - 2,
		   ping[iping].tint_y - 2, 4, 4, WHITE,
		   SOLID_LINE);
...
int mbnavedit_plot_lon_value(int iplot, int iping) {
  ...
  (*drawRectangle)(mbnavedit_xgid, ping[iping].lon_x - 2,
		   ping[iping].lon_y - 2, 4, 4, WHITE,
		   SOLID_LINE);
  (*fillRectangle)(mbnavedit_xgid, ping[iping].lon_x - 2,
		   ping[iping].lon_y - 2, 4, 4, WHITE,
		   SOLID_LINE);
...
int mbnavedit_plot_lat_value(int iplot, int iping) {
  ...
  (*drawRectangle)(mbnavedit_xgid, ping[iping].lat_x - 2,
		   ping[iping].lat_y - 2, 4, 4, WHITE,
		   SOLID_LINE);
  (*fillRectangle)(mbnavedit_xgid, ping[iping].lat_x - 2,
		   ping[iping].lat_y - 2, 4, 4, WHITE,
		   SOLID_LINE);
...
int mbnavedit_plot_speed_value(int iplot, int iping) {
  ...
  (*drawRectangle)(mbnavedit_xgid, ping[iping].speed_x - 2,
		   ping[iping].speed_y - 2, 4, 4, WHITE,
		   SOLID_LINE);
  (*fillRectangle)(mbnavedit_xgid, ping[iping].speed_x - 2,
		   ping[iping].speed_y - 2, 4, 4, WHITE,
		   SOLID_LINE);
...
int mbnavedit_plot_heading_value(int iplot, int iping) {
  ...
  (*drawRectangle)(mbnavedit_xgid, ping[iping].heading_x - 2,
		   ping[iping].heading_y - 2, 4, 4, WHITE,
		   SOLID_LINE);
  (*fillRectangle)(mbnavedit_xgid, ping[iping].heading_x - 2,
		   ping[iping].heading_y - 2, 4, 4, WHITE,
		   SOLID_LINE);
...
int mbnavedit_plot_draft_value(int iplot, int iping) {
  ...
  (*drawRectangle)(mbnavedit_xgid, ping[iping].draft_x - 2,
		   ping[iping].draft_y - 2, 4, 4, WHITE,
		   SOLID_LINE);
  (*fillRectangle)(mbnavedit_xgid, ping[iping].draft_x - 2,
		   ping[iping].draft_y - 2, 4, 4, WHITE,
		   SOLID_LINE);
