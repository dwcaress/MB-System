...
Widget CreatemainWindow(Widget parent) {
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard, (char *)"End", XmRXmString, 0, &argok);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard, (char *)"Start", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNfontList,
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard, (char *)"Interpolate Repeats", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard, (char *)"Unflag", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard, (char *)"Flag", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(pulldownMenu_controls, (char *)"Time Stepping", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNfontList,
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(pulldownMenu_controls, (char *)"Nav Modeling", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNfontList,
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(pulldownMenu_controls, (char *)"Time Interpolation", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNfontList,
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(pulldownMenu_controls, (char *)"Delete Bad Times", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNfontList,
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(pulldownMenu_controls, (char *)"Position Offset", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNfontList,
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard, (char *)"Show Original Data", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard, (char *)"Sonar Depth Plot", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard, (char *)"Use Solution", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard, (char *)"Show Dead Reckoning", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard, (char *)"Time Interval Plot", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard, (char *)"Next Buffer", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNfontList,
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard, (char *)"Done", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNfontList,
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard, (char *)"Forward", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNfontList,
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard, (char *)"Reverse", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNfontList,
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard, (char *)"Quit", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNfontList,
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard, (char *)"About", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNfontList,
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard, (char *)"Roll, Pitch, and Heave Plots", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNfontList,
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard, (char *)"Pick Zoom", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard, (char *)"Show All", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard, (char *)"Revert", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard, (char *)"Interpolate", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard, (char *)"", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(radioBox, (char *)"Pick", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(radioBox, (char *)"Select", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(radioBox, (char *)"Deselect", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(radioBox, (char *)"Select All", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNfontList,
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(radioBox, (char *)"Deselect All", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNfontList,
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard, (char *)"Use Course-Made-Good", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNfontList,
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard, (char *)"Show Course-Made-Good", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard, (char *)"Use Speed-Made-Good", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNfontList,
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard, (char *)"Show Speed-Made-Good", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard, (char *)"Speed Plot", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard, (char *)"Heading Plot", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard, (char *)"Latitude Plot", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard, (char *)"Longitude Plot", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_about, (char *)"Interactive Navigation Editor", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_about, (char *)"MBnavedit", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_fileselection, (char *)"Output Mode:", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(radioBox_output, (char *)"Output Edited Data", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNfontList,
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(radioBox_output, (char *)"Browse Only", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNfontList,
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_fileselection, (char *)"", XmRXmString, 0, &argok);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(xmDialogShell_timestepping, (char *)"Time Stepping", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNdialogTitle, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNautoUnmanage, False);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_timestepping, (char *)"Dismiss", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_timestepping, (char *)"500", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_timestepping, (char *)"Time Step (sec):  1", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_timestepping, (char *)" ", XmRXmString, 0, &argok);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_timestepping, (char *)"TIme Span Shown (sec):  1", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_END);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(xmDialogShell_modeling, (char *)"Navigation Modeling", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNdialogTitle, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNautoUnmanage, False);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_modeling, (char *)"Apply", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_modeling, (char *)"Acceleration:", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_END);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_modeling, (char *)"Speed Deviation:", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_END);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_modeling, (char *)"Inversion Penalty Weighting:", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_modeling, (char *)"Dismiss", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNx, 190);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_modeling, (char *)"Dead Reckoning Latitude Drift (deg/hr)", XmRXmString, 0,
		                            &argok);
		XtSetArg(args[ac], XmNtitleString, tmp0);
		if (argok)
			ac++;
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_modeling, (char *)"Dead Reckoning Longitude Drift (deg/hr)", XmRXmString, 0,
		                            &argok);
		XtSetArg(args[ac], XmNtitleString, tmp0);
		if (argok)
			ac++;
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_modeling, (char *)"Navigation Modeling Mode:", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(radioBox_modeling, (char *)"Off", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(radioBox_modeling, (char *)"Gaussian Mean", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNwidth, 135);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(radioBox_modeling, (char *)"Dead Reckoning", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(radioBox_modeling, (char *)"Inversion", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNwidth, 93);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_useprevious,
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_useprevious, (char *)"No", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNx, 290);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_useprevious, (char *)"Yes", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNx, 110);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_timeinterpolation,
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_timeinterpolation, (char *)"Dismiss", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNx, 160);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_timeinterpolation, (char *)"Apply", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNx, 20);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_deletebadtimetag,
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_deletebadtimetag, (char *)"Dismiss", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNx, 160);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(bulletinBoard_deletebadtimetag, (char *)"Apply", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNx, 20);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(xmDialogShell_offset, (char *)"Position Offset", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNdialogTitle, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNresizePolicy, XmRESIZE_GROW);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(form_offset, (char *)"Dismiss", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNx, 210);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(form_offset, (char *)"Apply", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(form_offset, (char *)"Latitude Offset (degrees):", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_END);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(form_offset, (char *)"Longitude Offset (degrees):", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNalignment, XmALIGNMENT_END);
