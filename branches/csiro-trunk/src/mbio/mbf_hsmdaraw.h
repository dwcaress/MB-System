...
#define HEADER_ADJUST                                                                                                            \
	12 /* magic offset to subract from scslng to                                                                                 \
...
double mbf_hsmdaraw_beamangle[] = {0.000,  4.395,  8.740,  12.991, 17.095, 21.028, 24.769, 28.295, 31.597, 34.684,
