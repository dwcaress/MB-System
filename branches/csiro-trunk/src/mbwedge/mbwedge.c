...
#define	MBWEDGE_MAIN	1
#include "../../include/mb_define.h"
#include "../../include/mb_status.h"
#include "mbwedge.h"

Widget Createwindow_mbwedge(Widget parent);
...
int main( int argc, char **argv)
{
    ...
    ac = 0;
    XtSetArg(args[ac], XmNtitle, "MBwedge"); ac++;
    XtSetArg(args[ac], XmNiconName, "MBwedge"); ac++;
    XtSetArg(args[ac], XmNallowShellResize, False); ac++;
    XtSetArg(args[ac], XmNdeleteResponse, XmDESTROY); ac++;
    XtSetArg(args[ac], XmNx, 38); ac++;
    XtSetArg(args[ac], XmNy, 22); ac++;
    XtSetArg(args[ac], XmNwidth, 1117); ac++;
    XtSetArg(args[ac], XmNheight, 823); ac++;
    ...
    window_mbwedge = (Widget)Createwindow_mbwedge(topLevelShell);
    XtManageChild(window_mbwedge);
    XtPopup(XtParent(window_mbwedge), XtGrabNone);
    ...
    do_mbwedge_init(argc_save,argv);
