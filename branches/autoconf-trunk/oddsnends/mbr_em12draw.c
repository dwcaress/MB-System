 ...
 *	$Id: mbr_em12draw.c,v 5.2 2001-01-22 07:43:34 caress Exp $
 *
...
int mbr_info_em12draw(int verbose, 
			int *system, 
			int *beams_bath_max, 
			int *beams_amp_max, 
			int *pixels_ss_max, 
...
int mbr_info_em12draw(int verbose, 
			...
			int *error)
{
	static char res_id[]="$Id: mbr_em12draw.c,v 5.2 2001-01-22 07:43:34 caress Exp $";
	...
	*format_alloc = &mbr_alm_em12draw;
	*format_free = &mbr_dem_em12draw; 
	*store_alloc = &mbsys_simrad_alloc; 
	*store_free = &mbsys_simrad_deall; 
	*read_ping = &mbr_rt_em12draw; 
	*write_ping = &mbr_wt_em12draw; 
