 ...
 *	$Id: mbr_em121raw.c,v 4.10 1999-03-31 18:11:35 caress Exp $
 *
 *    Copyright (c) 1994 by 
...
int	*error;
{
	static char res_id[]="$Id: mbr_em121raw.c,v 4.10 1999-03-31 18:11:35 caress Exp $";
...
int	*error;
{
	...
	if (status == MB_SUCCESS
		...
		depthscale = 0.01 * data->depth_res;
		dacrscale  = 0.01 * data->across_res;
		daloscale  = 0.01 * data->along_res;
		reflscale  = 0.5;
		if (data->ss_mode == 3)
			ss_spacing = 0.3;
