 ...
 *	$Id: mbr_em12sraw.c,v 4.2 1996-08-26 18:33:50 caress Exp $
 *
 *    Copyright (c) 1994 by 
...
int	*error;
{
	static char res_id[]="$Id: mbr_em12sraw.c,v 4.2 1996-08-26 18:33:50 caress Exp $";
...
/*--------------------------------------------------------------------*/
int mbr_dem_em12sraw(verbose,mbio_ptr,error)
int	verbose;
char	*mbio_ptr;
int	*error;
{
...
/*--------------------------------------------------------------------*/
int mbr_zero_em12sraw(verbose,data_ptr,error)
int	verbose;
char	*data_ptr;
int	*error;
{
...
/*--------------------------------------------------------------------*/
int mbr_rt_em12sraw(verbose,mbio_ptr,store_ptr,error)
int	verbose;
char	*mbio_ptr;
char	*store_ptr;
int	*error;
...
/*--------------------------------------------------------------------*/
int mbr_wt_em12sraw(verbose,mbio_ptr,store_ptr,error)
int	verbose;
char	*mbio_ptr;
char	*store_ptr;
int	*error;
...
/*--------------------------------------------------------------------*/
int mbr_em12sraw_rd_data(verbose,mbio_ptr,error)
int	verbose;
char	*mbio_ptr;
int	*error;
{
...
/*--------------------------------------------------------------------*/
int mbr_em12sraw_rd_start(verbose,mbfp,data,error)
int	verbose;
FILE	*mbfp;
struct mbf_em12sraw_struct *data;
int	*error;
...
/*--------------------------------------------------------------------*/
int mbr_em12sraw_rd_stop(verbose,mbfp,data,error)
int	verbose;
FILE	*mbfp;
struct mbf_em12sraw_struct *data;
int	*error;
...
/*--------------------------------------------------------------------*/
int mbr_em12sraw_rd_parameter(verbose,mbfp,data,error)
int	verbose;
FILE	*mbfp;
struct mbf_em12sraw_struct *data;
int	*error;
...
/*--------------------------------------------------------------------*/
int mbr_em12sraw_rd_pos(verbose,mbfp,data,error)
int	verbose;
FILE	*mbfp;
struct mbf_em12sraw_struct *data;
int	*error;
...
/*--------------------------------------------------------------------*/
int mbr_em12sraw_rd_bath(verbose,mbfp,data,error)
int	verbose;
FILE	*mbfp;
struct mbf_em12sraw_struct *data;
int	*error;
...
/*--------------------------------------------------------------------*/
int mbr_em12sraw_rd_ss(verbose,mbfp,data,first,more,error)
int	verbose;
FILE	*mbfp;
struct mbf_em12sraw_struct *data;
int	first;
...
/*--------------------------------------------------------------------*/
int mbr_em12sraw_wr_data(verbose,mbio_ptr,data_ptr,error)
int	verbose;
char	*mbio_ptr;
char	*data_ptr;
int	*error;
...
/*--------------------------------------------------------------------*/
int mbr_em12sraw_wr_start(verbose,mbfp,data_ptr,error)
int	verbose;
FILE	*mbfp;
char	*data_ptr;
int	*error;
...
/*--------------------------------------------------------------------*/
int mbr_em12sraw_wr_stop(verbose,mbfp,data_ptr,error)
int	verbose;
FILE	*mbfp;
char	*data_ptr;
int	*error;
...
/*--------------------------------------------------------------------*/
int mbr_em12sraw_wr_parameter(verbose,mbfp,data_ptr,error)
int	verbose;
FILE	*mbfp;
char	*data_ptr;
int	*error;
...
/*--------------------------------------------------------------------*/
int mbr_em12sraw_wr_pos(verbose,mbfp,data_ptr,error)
int	verbose;
FILE	*mbfp;
char	*data_ptr;
int	*error;
...
/*--------------------------------------------------------------------*/
int mbr_em12sraw_wr_svp(verbose,mbfp,data_ptr,error)
int	verbose;
FILE	*mbfp;
char	*data_ptr;
int	*error;
...
/*--------------------------------------------------------------------*/
int mbr_em12sraw_wr_bath(verbose,mbfp,data_ptr,error)
int	verbose;
FILE	*mbfp;
char	*data_ptr;
int	*error;
...
/*--------------------------------------------------------------------*/
int mbr_em12sraw_wr_ss(verbose,mbfp,data_ptr,error)
int	verbose;
FILE	*mbfp;
char	*data_ptr;
int	*error;
	...
	if (status == MB_SUCCESS)
		...
		*char_ptr = (char) num_beams;
		...
		for (i=datagram_start[datagram];i<=datagram_end[datagram];i++)
			{
			beam_ss = &data->ss[data->beam_start_sample[i]];
			beam_ssp = &data->ss[data->beam_start_sample[i]];
			for (j=0;j<data->beam_samples[i];j++)
				{
