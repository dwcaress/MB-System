 ...
 *	$Id: mbf_em12sraw.h,v 4.2 1996-08-26 18:33:50 caress Exp $
 *
 *    Copyright (c) 1994 by 
...
#define	MBF_EM12SRAW_MAXPIXELS	50*MBF_EM12SRAW_MAXBEAMS
...
struct mbf_em12sraw_struct
	...
	signed char	amp[MBF_EM12SRAW_MAXBEAMS];	    /* 0.5 dB */
	unsigned char	quality[MBF_EM12SRAW_MAXBEAMS];	    /* meters */
	signed char	heave[MBF_EM12SRAW_MAXBEAMS];	    /* 0.1 meters */
	...
	short int beam_start_sample[MBF_EM12SRAW_MAXBEAMS];
				/* start beam sample number among samples
					from entire ping */
	char	ss[MBF_EM12SRAW_MAXPIXELS];
	short int ssp[MBF_EM12SRAW_MAXPIXELS];
