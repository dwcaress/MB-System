/**********************************************************************
 *	XGRAPHICS
 * $Id: xgraphics.c,v 4.0 1994-03-05 23:54:35 caress Exp $
 ...
 * Revision 3.2  1993/08/17  00:33:37  caress
 * Changed:
...
char	*fontname;
{
static char rcs_id[]="$Id: xgraphics.c,v 4.0 1994-03-05 23:54:35 caress Exp $";
	/* local variables */
	...
	if (graphic->display_type == StaticGray)
		...
		/* now fill up rest of new colortable with 
			black for overlay 1 and red for overlay 2*/
		for (i=64;i<128;i++)
			{
			graphic->color[i].pixel = i;
