 ...
 *	$Id: mbf_em1000rw.h,v 4.0 1994-10-21 12:35:04 caress Exp $
 *
 *    Copyright (c) 1994 by 
...
struct mbf_em1000rw_struct
	...
	short int amp[MBF_EM1000RW_MAXBEAMS];		/* 0.5 dB */
	short int quality[MBF_EM1000RW_MAXBEAMS];	/* meters */
	short int heave[MBF_EM1000RW_MAXBEAMS];		/* 0.1 meters */
	...
	short int beam_start_sample[MBF_EM1000RW_MAXBEAMS];
				/* start beam sample number among samples
					from entire ping */
	short int ss[MBF_EM1000RW_MAXPIXELS];
