...
class MbctdlistTest(unittest.TestCase):

  def setUp(self):
    self.cmd = '../../src/utilities/mbctdlist'
  ...
  def testHelp(self):
    ...
    self.assertIn('all CTD records within swath data', output)
    self.assertIn('-Ddecimate', output)
