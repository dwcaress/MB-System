...
class MbdatalistTest(unittest.TestCase):

  def setUp(self):
    self.cmd = '../../src/utilities/mbdatalist'
  ...
  def testHelp(self):
    ...
    self.assertIn('mbdatalist parses recursive datalist files', output)
    self.assertIn('-Rw/e/s/n', output)
