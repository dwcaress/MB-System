...
class MbsvplistTest(unittest.TestCase):

  def setUp(self):
    self.cmd = '../../src/utilities/mbsvplist'
  ...
  def testHelp(self):
    ...
    self.assertIn('lists all water sound velocity', output)
    self.assertIn('usage:', output)
    self.assertIn('-Nmin_num_pairs', output)
  ...
  def testHelpVerbose2(self):
    ...
    self.assertIn('ssv_bounds_set:', output)
