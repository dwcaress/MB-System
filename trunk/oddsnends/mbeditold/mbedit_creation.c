...
Createwindow_mbedit(Widget parent)
{
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(radioBox_show_flagged, (char *)"On", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNwidth, 49); ac++;
        XtSetArg(args[ac], XmNheight, 28); ac++;
        XtSetArg(args[ac], XmNfontList, 
            BX_CONVERT(radioBox_show_flagged, (char *)"-*-helvetica-bold-r-*-*-*-140-75-75-*-*-iso8859-1", 
            XmRFontList, 0, &argok)); if (argok) ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(radioBox_show_flagged, (char *)"Off", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNwidth, 49); ac++;
        XtSetArg(args[ac], XmNheight, 28); ac++;
        ...
        toggleButton_show_flagged_off = XmCreateToggleButton(radioBox_show_flagged,
            (char *)"toggleButton_show_flagged_off",
            args, 
            ac);
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(controls_mbedit, (char *)"Show flagged profile:", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(setting_output, (char *)"Output Edited Data", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNfontList, 
        ...
        setting_output_toggle_output = XmCreateToggleButton(setting_output,
            (char *)"setting_output_toggle_output",
            args, 
            ac);
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(setting_output, (char *)"Output Edits Only", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_file, (char *)"Output file name:", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNx, 10); ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_about, (char *)"MBeditold", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNfontList, 
            BX_CONVERT(bulletinBoard_about, (char *)"-*-times-bold-r-*-*-*-240-*-*-*-*-iso8859-1", 
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_message, (char *)"MBeditold is loading data...", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING); ac++;
        XtSetArg(args[ac], XmNx, 10); ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_filters, (char *)"% Median Depth Threshold ", 
                XmRXmString, 0, &argok);
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_filters, (char *)"Beams from Center Threshold", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNtitleString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNvalue, 10); ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_filters, (char *)"Median Spike Filter", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING); ac++;
        XtSetArg(args[ac], XmNx, 10); ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_filters, (char *)"Wrong Side Filter", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING); ac++;
        XtSetArg(args[ac], XmNx, 10); ac++;
