...
extern void do_toggle_output_nav(Widget, XtPointer, XtPointer);
...
CreatemainWindow(Widget parent)
{
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard, (char *)"Controls", 
                XmRXmString, 0, &argok);
        ...
        pushButton_controls = XmCreatePushButton(bulletinBoard,
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard, (char *)"Use Dead Reckoning", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard, (char *)"Pick Time Interval", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNfontList, 
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard, (char *)"Show Entire Buffer", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNfontList, 
            BX_CONVERT(bulletinBoard, (char *)"-adobe-helvetica-bold-r-normal--14-140-75-75-p-82-iso8859-1", 
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard, (char *)"Revert Selection", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNfontList, 
            BX_CONVERT(bulletinBoard, (char *)"-adobe-helvetica-bold-r-normal--14-140-75-75-p-82-iso8859-1", 
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard, (char *)"Interpolate Selection", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNfontList, 
            BX_CONVERT(bulletinBoard, (char *)"-adobe-helvetica-bold-r-normal--14-140-75-75-p-82-iso8859-1", 
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_about, (char *)":::t\"Created by:\"\"David W. Caress    and    Dale N. Chayes\"", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNfontList, 
            BX_CONVERT(bulletinBoard_about, (char *)"-*-times-bold-r-*-*-*-140-*-*-*-*-iso8859-1", 
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_about, (char *)"One Obsolete Component of the", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNfontList, 
            BX_CONVERT(bulletinBoard_about, (char *)"-*-times-bold-r-*-*-*-140-*-*-*-*-iso8859-1", 
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_about, (char *)"MBnaveditold", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNfontList, 
            BX_CONVERT(bulletinBoard_about, (char *)"-*-times-bold-r-*-*-*-240-*-*-*-*-iso8859-1", 
    ...
    XtSetArg(args[ac], XmNx, 418); ac++;
    XtSetArg(args[ac], XmNy, 875); ac++;
    XtSetArg(args[ac], XmNwidth, 379); ac++;
    XtSetArg(args[ac], XmNheight, 86); ac++;
    ...
    XtSetArg(args[ac], XmNheight, 634); ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(radioBox_output, (char *)"Nav Only", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNfontList, 
            BX_CONVERT(radioBox_output, (char *)"-*-helvetica-bold-r-*-*-*-140-75-75-p-*-iso8859-1", 
            XmRFontList, 0, &argok)); if (argok) ac++;
        XtSetArg(args[ac], XmNwidth, 161); ac++;
        XtSetArg(args[ac], XmNheight, 28); ac++;
        toggleButton_output_nav = XmCreateToggleButton(radioBox_output,
            (char *)"toggleButton_output_nav",
            args, 
            ac);
        XtManageChild(toggleButton_output_nav);
    ...
    XtAddCallback(toggleButton_output_nav, XmNvalueChangedCallback, do_toggle_output_nav, (XtPointer)0);
    ...
    ac = 0;
    {
        ...
        XtSetArg(args[ac], XmNlistVisibleItemCount, 11); ac++;
    ...
    xmDialogShell_controls = XmCreateDialogShell(mainWindow,
        (char *)"xmDialogShell_controls",
        args, 
        ac);
    ...
    XtSetArg(args[ac], XmNwidth, 491); ac++;
    XtSetArg(args[ac], XmNheight, 350); ac++;
    bulletinBoard_controls = XtCreateWidget((char *)"bulletinBoard_controls",
        xmBulletinBoardWidgetClass,
        xmDialogShell_controls,
        args, 
        ac);
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_controls, (char *)"Dismiss", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNx, 190); ac++;
        XtSetArg(args[ac], XmNy, 290); ac++;
        ...
        XtSetArg(args[ac], XmNheight, 40); ac++;
        XtSetArg(args[ac], XmNfontList, 
            BX_CONVERT(bulletinBoard_controls, (char *)"-*-helvetica-bold-r-*-*-*-140-75-75-*-*-iso8859-1", 
            XmRFontList, 0, &argok)); if (argok) ac++;
    ...
    XtSetArg(args[ac], XmNheight, 20); ac++;
    separator3 = XmCreateSeparator(bulletinBoard_controls,
        (char *)"separator3",
        args, 
        ac);
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_controls, (char *)"DR Latitude Drift (deg/hr)", 
                XmRXmString, 0, &argok);
        ...
        XtSetArg(args[ac], XmNfontList, 
            BX_CONVERT(bulletinBoard_controls, (char *)"-*-helvetica-bold-r-*-*-*-140-75-75-*-*-iso8859-1", 
            XmRFontList, 0, &argok)); if (argok) ac++;
        scale_driftlat = XmCreateScale(bulletinBoard_controls,
            (char *)"scale_driftlat",
            args, 
            ac);
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_controls, (char *)"DR Longitude Drift (deg/hr)", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNtitleString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNminimum, -1000); ac++;
        XtSetArg(args[ac], XmNdecimalPoints, 5); ac++;
        ...
        XtSetArg(args[ac], XmNfontList, 
            BX_CONVERT(bulletinBoard_controls, (char *)"-*-helvetica-bold-r-*-*-*-140-75-75-*-*-iso8859-1", 
            XmRFontList, 0, &argok)); if (argok) ac++;
        scale_driftlon = XmCreateScale(bulletinBoard_controls,
            (char *)"scale_driftlon",
            args, 
            ac);
    ...
    XtSetArg(args[ac], XmNwidth, 470); ac++;
    XtSetArg(args[ac], XmNheight, 20); ac++;
    separator2 = XmCreateSeparator(bulletinBoard_controls,
        (char *)"separator2",
        args, 
        ac);
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_controls, (char *)"500", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING); ac++;
        XtSetArg(args[ac], XmNfontList, 
            BX_CONVERT(bulletinBoard_controls, (char *)"-*-helvetica-bold-r-*-*-*-120-75-75-p-*-iso8859-1", 
            XmRFontList, 0, &argok)); if (argok) ac++;
        XtSetArg(args[ac], XmNrecomputeSize, False); ac++;
        ...
        XtSetArg(args[ac], XmNheight, 30); ac++;
        label_timestep_2 = XmCreateLabel(bulletinBoard_controls,
    ...
    scale_timestep = XmCreateScale(bulletinBoard_controls,
        (char *)"scale_timestep",
        args, 
        ac);
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_controls, (char *)"Time Step (sec):  1", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        ...
        XtSetArg(args[ac], XmNwidth, 170); ac++;
        XtSetArg(args[ac], XmNheight, 30); ac++;
        label_timestep_1 = XmCreateLabel(bulletinBoard_controls,
    ...
    ac = 0;
    {
        ...
        XtSetArg(args[ac], XmNwidth, 40); ac++;
        XtSetArg(args[ac], XmNheight, 30); ac++;
        label_timespan_2 = XmCreateLabel(bulletinBoard_controls,
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_controls, (char *)" ", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNtitleString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNfontList, 
            BX_CONVERT(bulletinBoard_controls, (char *)"-*-helvetica-bold-r-*-*-*-120-75-75-p-*-iso8859-1", 
        ...
        XtSetArg(args[ac], XmNwidth, 260); ac++;
        XtSetArg(args[ac], XmNheight, 40); ac++;
        scale_timespan = XmCreateScale(bulletinBoard_controls,
            (char *)"scale_timespan",
            args, 
            ac);
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_controls, (char *)"TIme Span Shown (sec):  1", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNalignment, XmALIGNMENT_END); ac++;
        XtSetArg(args[ac], XmNfontList, 
        ...
        XtSetArg(args[ac], XmNwidth, 170); ac++;
        XtSetArg(args[ac], XmNheight, 30); ac++;
        label_timespan_1 = XmCreateLabel(bulletinBoard_controls,
