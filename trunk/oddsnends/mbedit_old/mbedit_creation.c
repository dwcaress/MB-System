...
Createwindow_mbedit(Widget parent)
{
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(controls_mbedit, "Go To", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(controls_mbedit, "Acrosstrack Plot width (m):  1", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(controls_mbedit, "Number of pings shown:   1", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNalignment, XmALIGNMENT_END); ac++;
        XtSetArg(args[ac], XmNx, 10); ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(controls_mbedit, "Number of pings to step: 1", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNalignment, XmALIGNMENT_END); ac++;
        XtSetArg(args[ac], XmNx, 10); ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(controls_mbedit, "X Axis Tick Interval (m): 1", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNalignment, XmALIGNMENT_END); ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(controls_mbedit, "5000", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNrecomputeSize, False); ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(controls_mbedit, "Y Axis Tick Interval (m): 1", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNalignment, XmALIGNMENT_END); ac++;
        XtSetArg(args[ac], XmNx, 530); ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(controls_mbedit, "1000", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNrecomputeSize, False); ac++;
        XtSetArg(args[ac], XmNx, 970); ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(controls_mbedit, "Data Buffer Size:            1", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNalignment, XmALIGNMENT_END); ac++;
        XtSetArg(args[ac], XmNx, 540); ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(controls_mbedit, "Buffer Retain Size:         1", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNalignment, XmALIGNMENT_END); ac++;
        XtSetArg(args[ac], XmNx, 530); ac++;
    ...
    XtSetArg(args[ac], XmNheight, 495); ac++;
    ...
    XtSetArg(args[ac], XmNdialogStyle, XmDIALOG_FULL_APPLICATION_MODAL); ac++;
    XtSetArg(args[ac], XmNresizePolicy, XmRESIZE_GROW); ac++;
    XtSetArg(args[ac], XmNx, 841); ac++;
    XtSetArg(args[ac], XmNy, 565); ac++;
    XtSetArg(args[ac], XmNwidth, 431); ac++;
    XtSetArg(args[ac], XmNheight, 133); ac++;
