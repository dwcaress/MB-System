...
CreatemainWindow(Widget parent)
{
    ...
    XtSetArg(args[ac], XmNwidth, 1130); ac++;
    ...
    ac = 0;
    {
        ...
        XtSetArg(args[ac], XmNfontList, 
            BX_CONVERT(bulletinBoard, "-*-helvetica-bold-r-*-*-*-140-75-75-*-*-iso8859-1", 
            XmRFontList, 0, &argok)); if (argok) ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard, "Revert Selection", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNfontList, 
            BX_CONVERT(bulletinBoard, "-adobe-helvetica-bold-r-normal--14-140-75-75-p-82-iso8859-1", 
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard, "Interpolate Selection", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNfontList, 
            BX_CONVERT(bulletinBoard, "-adobe-helvetica-bold-r-normal--14-140-75-75-p-82-iso8859-1", 
    ...
    ac = 0;
    {
        ...
        XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING); ac++;
        XtSetArg(args[ac], XmNfontList, 
            BX_CONVERT(radioBox, "-adobe-helvetica-bold-r-normal--14-140-75-75-p-82-iso8859-1", 
            XmRFontList, 0, &argok)); if (argok) ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard, "500", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING); ac++;
        XtSetArg(args[ac], XmNfontList, 
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard, "Time Step (sec):  1", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard, "TIme Span Shown (sec):  1", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNalignment, XmALIGNMENT_END); ac++;
        XtSetArg(args[ac], XmNfontList, 
    ...
    ac = 0;
    {
        ...
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNfontList, 
            BX_CONVERT(bulletinBoard_about, "-*-times-bold-r-*-*-*-200-*-*-*-*-iso8859-1", 
            XmRFontList, 0, &argok)); if (argok) ac++;
        XtSetArg(args[ac], XmNx, 10); ac++;
        XtSetArg(args[ac], XmNy, 60); ac++;
        XtSetArg(args[ac], XmNwidth, 450); ac++;
    ...
    ac = 0;
    {
        ...
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNfontList, 
            BX_CONVERT(bulletinBoard_about, "-*-times-bold-r-*-*-*-360-*-*-*-*-iso8859-1", 
            XmRFontList, 0, &argok)); if (argok) ac++;
        XtSetArg(args[ac], XmNx, 10); ac++;
        XtSetArg(args[ac], XmNy, 10); ac++;
        XtSetArg(args[ac], XmNwidth, 450); ac++;
