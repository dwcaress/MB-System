...
/*--------------------------------------------------------------------*/
int mbsys_sb_deall(int verbose, char *mbio_ptr, char **store_ptr, 
			int *error)
{
...
/*--------------------------------------------------------------------*/
int mbsys_sb_extract(int verbose, char *mbio_ptr, char *store_ptr, 
...
/*--------------------------------------------------------------------*/
int mbsys_sb_ttimes(int verbose, char *mbio_ptr, char *store_ptr,
	int *kind, int *nbeams,
...
/*--------------------------------------------------------------------*/
int mbsys_sb_insert_nav(int verbose, char *mbio_ptr, char *store_ptr,
...
/*--------------------------------------------------------------------*/
int mbsys_sb_copy(int verbose, char *mbio_ptr, 
