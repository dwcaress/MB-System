...
#define SWPLS_ID_PROCESSED_PING                                                                                                  \
	0x28 /* processed ping data (prior to                                                                                        \
	   January 2010) */
#define SWPLS_ID_PROCESSED_PING2                                                                                                 \
	0x52                            /* processed ping data (after                                                                \
	                          January 2010) */
...
int mbsys_swathplus_extract(int verbose, void *mbio_ptr, void *store_ptr, int *kind, int time_i[7], double *time_d,
...
int mbsys_swathplus_insert(int verbose, void *mbio_ptr, void *store_ptr, int kind, int time_i[7], double time_d, double navlon,
...
/*                        int *error); */
int mbsys_swathplus_extract_svp(int verbose, void *mbio_ptr, void *store_ptr, int *kind, int *nsvp, double *depth,
                                double *velocity, int *error);
int mbsys_swathplus_insert_svp(int verbose, void *mbio_ptr, void *store_ptr, int nsvp, double *depth, double *velocity,
                               int *error);
...
int mbsys_swathplus_blockheader_read(int verbose, void *mb_io_ptr, int *recordid, int *size, int *error);
...
int swpls_pr_echosounder(int verbose, FILE *fout, swpls_echosounder *sounder, int *error);
