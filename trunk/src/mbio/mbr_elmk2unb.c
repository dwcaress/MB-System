 ...
 *	$Id: mbr_elmk2unb.c,v 5.0 2000-12-01 22:48:41 caress Exp $
 *
...
int mbr_info_elmk2unb(int verbose, 
			...
			int *error)
{
	static char res_id[]="$Id: mbr_elmk2unb.c,v 5.0 2000-12-01 22:48:41 caress Exp $";
	...
	*format_alloc = &mbr_alm_elmk2unb;
	*format_free = &mbr_dem_elmk2unb; 
	*store_alloc = &mbsys_elacmk2_alloc; 
	*store_free = &mbsys_elacmk2_deall; 
	*read_ping = &mbr_rt_elmk2unb; 
	*write_ping = &mbr_wt_elmk2unb; 
	*extract = &mbsys_elacmk2_extract; 
	*insert = &mbsys_elacmk2_insert; 
	*extract_nav = &mbsys_elacmk2_extract_nav; 
	*insert_nav = &mbsys_elacmk2_insert_nav; 
	*altitude = &mbsys_elacmk2_altitude; 
	*insert_altitude = NULL; 
	*ttimes = &mbsys_elacmk2_ttimes; 
	*copyrecord = &mbsys_elacmk2_copy; 
