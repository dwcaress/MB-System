...
/*--------------------------------------------------------------------*/
int mbsys_singlebeam_alloc(verbose,mbio_ptr,store_ptr,error)
int	verbose;
char	*mbio_ptr;
char	**store_ptr;
int	*error;
...
/*--------------------------------------------------------------------*/
int mbsys_singlebeam_deall(verbose,mbio_ptr,store_ptr,error)
int	verbose;
char	*mbio_ptr;
char	**store_ptr;
int	*error;
...
/*--------------------------------------------------------------------*/
int mbsys_singlebeam_extract(verbose,mbio_ptr,store_ptr,kind,
...
/*--------------------------------------------------------------------*/
int mbsys_singlebeam_insert(verbose,mbio_ptr,store_ptr,
		time_i,time_d,navlon,navlat,speed,heading,
		nbath,namp,nss,
		beamflag,bath,amp,bathacrosstrack,bathalongtrack,
		ss,ssacrosstrack,ssalongtrack,
...
/*--------------------------------------------------------------------*/
int mbsys_singlebeam_ttimes(verbose,mbio_ptr,store_ptr,kind,nbeams,
...
/*--------------------------------------------------------------------*/
int mbsys_singlebeam_altitude(verbose,mbio_ptr,store_ptr,
...
/*--------------------------------------------------------------------*/
int mbsys_singlebeam_copy(verbose,mbio_ptr,store_ptr,copy_ptr,error)
int	verbose;
char	*mbio_ptr;
char	*store_ptr;
char	*copy_ptr;
