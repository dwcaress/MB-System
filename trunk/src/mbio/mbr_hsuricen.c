/*--------------------------------------------------------------------
 *    The MB-system:	mbr_hsuricen.c	3.00	2/2/93
 *	$Id: mbr_hsuricen.c,v 3.0 1993-05-14 22:56:29 sohara Exp $
 *
 *    Copyright (c) 1993 by 
...
int	*error;
{
 static char res_id[]="$Id: mbr_hsuricen.c,v 3.0 1993-05-14 22:56:29 sohara Exp $";
