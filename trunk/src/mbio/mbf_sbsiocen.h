/*--------------------------------------------------------------------
 *    The MB-system:	mbf_sbsiocen.h	3.00	1/20/93
 *	$Id: mbf_sbsiocen.h,v 3.0 1993-05-14 22:52:50 sohara Exp $
 *
 *    Copyright (c) 1993 by 
 ...
 * to store multibeam data read from the  MBF_SBSIOCEN format (MBIO id 2).  
 *
 * Author:	D. W. Caress
