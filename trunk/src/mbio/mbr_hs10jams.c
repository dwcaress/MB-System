...
int mbr_dem_hs10jams(int verbose, char *mbio_ptr, int *error);
int mbr_rt_hs10jams(int verbose, char *mbio_ptr, char *store_ptr, int *error);
int mbr_wt_hs10jams(int verbose, char *mbio_ptr, char *store_ptr, int *error);
			...
			int *error)
{
	...
	*format_alloc = &mbr_alm_hs10jams;
	*format_free = &mbr_dem_hs10jams; 
	*store_alloc = &mbsys_hs10_alloc; 
	*store_free = &mbsys_hs10_deall; 
	*read_ping = &mbr_rt_hs10jams; 
	*write_ping = &mbr_wt_hs10jams; 
	*extract = &mbsys_hs10_extract; 
