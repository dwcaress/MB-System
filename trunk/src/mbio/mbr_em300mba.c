 ...
 *	$Id: mbr_em300mba.c,v 5.25 2006-01-27 19:09:38 caress Exp $
 *
...
static char res_id[]="$Id: mbr_em300mba.c,v 5.25 2006-01-27 19:09:38 caress Exp $";
...
#endif
		status = mbr_em300mba_wr_bath(verbose,mbfp,swap,store,error);
...
#endif
		    status = mbr_em300mba_wr_ss(verbose,mbfp,swap,store,error);
		    }
#ifdef MBR_EM300MBA_DEBUG
