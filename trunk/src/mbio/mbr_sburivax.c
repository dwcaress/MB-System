 ...
 *	$Id: mbr_sburivax.c,v 5.1 2001-01-22 07:43:34 caress Exp $
 *
...
int mbr_info_sburivax(int verbose, 
			...
			int *error)
{
	static char res_id[]="$Id: mbr_sburivax.c,v 5.1 2001-01-22 07:43:34 caress Exp $";
	...
	*format_alloc = &mbr_alm_sburivax;
	*format_free = &mbr_dem_sburivax; 
	*store_alloc = &mbsys_sb_alloc; 
	*store_free = &mbsys_sb_deall; 
	*read_ping = &mbr_rt_sburivax; 
	*write_ping = &mbr_wt_sburivax; 
