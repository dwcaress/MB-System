 ...
 *	$Id: mbr_cbat9001.c,v 5.1 2001-01-22 07:43:34 caress Exp $
 *
...
int mbr_info_cbat9001(int verbose, 
			...
			int *error)
{
	static char res_id[]="$Id: mbr_cbat9001.c,v 5.1 2001-01-22 07:43:34 caress Exp $";
	...
	*format_alloc = &mbr_alm_cbat9001;
	*format_free = &mbr_dem_cbat9001; 
	*store_alloc = &mbsys_reson_alloc; 
	*store_free = &mbsys_reson_deall; 
	*read_ping = &mbr_rt_cbat9001; 
	*write_ping = &mbr_wt_cbat9001; 
