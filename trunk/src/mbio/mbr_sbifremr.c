 ...
 *	$Id: mbr_sbifremr.c,v 5.0 2000-12-01 22:48:41 caress Exp $
 *
...
int mbr_info_sbifremr(int verbose, 
			...
			int *error)
{
	static char res_id[]="$Id: mbr_sbifremr.c,v 5.0 2000-12-01 22:48:41 caress Exp $";
	...
	*format_alloc = &mbr_alm_sbifremr;
	*format_free = &mbr_dem_sbifremr; 
	*store_alloc = &mbsys_sb_alloc; 
	*store_free = &mbsys_sb_deall; 
	*read_ping = &mbr_rt_sbifremr; 
	*write_ping = &mbr_wt_sbifremr; 
