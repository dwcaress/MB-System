 ...
 *	$Id: mbr_sbsioswb.c,v 5.0 2000-12-01 22:48:41 caress Exp $
 *
...
int mbr_info_sbsioswb(int verbose, 
			...
			int *error)
{
	static char res_id[]="$Id: mbr_sbsioswb.c,v 5.0 2000-12-01 22:48:41 caress Exp $";
	...
	*format_alloc = &mbr_alm_sbsioswb;
	*format_free = &mbr_dem_sbsioswb; 
	*store_alloc = &mbsys_sb_alloc; 
	*store_free = &mbsys_sb_deall; 
	*read_ping = &mbr_rt_sbsioswb; 
	*write_ping = &mbr_wt_sbsioswb; 
