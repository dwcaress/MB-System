 ...
 *	$Id: mbf_elmk2xse.h,v 4.0 1999-08-08 04:14:35 caress Exp $
 *
 *    Copyright (c) 1999 by 
 ...
 *--------------------------------------------------------------------*/
/*
 * mbf_elmk2xse.h defines the data structures used by MBIO functions
 * to store multibeam data read from the MBF_ELMK2XSE format (MBIO id 94).  
 *
 * Author:	D. W. Caress
 * Date:	March 27, 1999
 *
 ...
 */
/*
 * Notes on the MBF_ELMK2XSE data format:
...
#define	MBF_ELMK2XSE_MAXBEAMS	126
#define	MBF_ELMK2XSE_MAXPIXELS	2000
#define	MBF_ELMK2XSE_MAXSVP	200
#define	MBF_ELMK2XSE_COMMENT_LENGTH	200
#define	MBF_ELMK2XSE_BUFFER_SIZE	10000
#define	MBF_ELMK2XSE_DESCRIPTION_LENGTH	64

/* frame and group id's */
#define MBF_ELMK2XSE_NONE_FRAME			0

#define MBF_ELMK2XSE_NAV_FRAME			1
#define MBF_ELMK2XSE_NAV_GROUP_GEN		1
#define MBF_ELMK2XSE_NAV_GROUP_POS		2
#define MBF_ELMK2XSE_NAV_GROUP_ACCURACY		3
#define MBF_ELMK2XSE_NAV_GROUP_MOTIONGT		4
#define MBF_ELMK2XSE_NAV_GROUP_MOTIONTW		5
#define MBF_ELMK2XSE_NAV_GROUP_TRACK		6

#define MBF_ELMK2XSE_SVP_FRAME			2
#define MBF_ELMK2XSE_SVP_GROUP_GEN		1
#define MBF_ELMK2XSE_SVP_GROUP_DEPTH		2
#define MBF_ELMK2XSE_SVP_GROUP_VELOCITY		3
#define MBF_ELMK2XSE_SVP_GROUP_CONDUCTIVITY	4
#define MBF_ELMK2XSE_SVP_GROUP_SALINITY		5
#define MBF_ELMK2XSE_SVP_GROUP_TEMP		6
#define MBF_ELMK2XSE_SVP_GROUP_PRESSURE		7
#define MBF_ELMK2XSE_SVP_GROUP_SSV		8

#define MBF_ELMK2XSE_TID_FRAME			3
#define MBF_ELMK2XSE_TID_GROUP_GEN		1
#define MBF_ELMK2XSE_TID_GROUP_POS		2
#define MBF_ELMK2XSE_TID_GROUP_TIME		3
#define MBF_ELMK2XSE_TID_GROUP_TIDE		4

#define MBF_ELMK2XSE_SHP_FRAME			4
#define MBF_ELMK2XSE_SHP_GROUP_GEN		1
#define MBF_ELMK2XSE_SHP_GROUP_ATTITUDE		2
#define MBF_ELMK2XSE_SHP_GROUP_POS		3
#define MBF_ELMK2XSE_SHP_GROUP_DYNAMICS		4
#define MBF_ELMK2XSE_SHP_GROUP_MOTION		5
#define MBF_ELMK2XSE_SHP_GROUP_GEOMETRY		6
#define MBF_ELMK2XSE_SHP_GROUP_DESCRIPTION	7
#define MBF_ELMK2XSE_SHP_GROUP_PARAMETER	8

#define MBF_ELMK2XSE_SSN_FRAME			5
#define MBF_ELMK2XSE_SSN_GROUP_GEN		1
#define MBF_ELMK2XSE_SSN_GROUP_AMPVSTT		2
#define MBF_ELMK2XSE_SSN_GROUP_PHASEVSTT	3
#define MBF_ELMK2XSE_SSN_GROUP_AMPVSLAT		4
#define MBF_ELMK2XSE_SSN_GROUP_PHASEVSLAT	5

#define MBF_ELMK2XSE_MBM_FRAME			6
#define MBF_ELMK2XSE_MBM_GROUP_GEN		1
#define MBF_ELMK2XSE_MBM_GROUP_BEAM		2
#define MBF_ELMK2XSE_MBM_GROUP_TT		3
#define MBF_ELMK2XSE_MBM_GROUP_QUALITY		4
#define MBF_ELMK2XSE_MBM_GROUP_AMP		5
#define MBF_ELMK2XSE_MBM_GROUP_DELAY		6
#define MBF_ELMK2XSE_MBM_GROUP_LATERAL		7
#define MBF_ELMK2XSE_MBM_GROUP_ALONG		8
#define MBF_ELMK2XSE_MBM_GROUP_DEPTH		9
#define MBF_ELMK2XSE_MBM_GROUP_ANGLE		10
#define MBF_ELMK2XSE_MBM_GROUP_HEAVE		11
#define MBF_ELMK2XSE_MBM_GROUP_ROLL		12
#define MBF_ELMK2XSE_MBM_GROUP_PITCH		13
#define MBF_ELMK2XSE_MBM_GROUP_GATES		14
#define MBF_ELMK2XSE_MBM_GROUP_NOISE		15
#define MBF_ELMK2XSE_MBM_GROUP_LENGTH		16
#define MBF_ELMK2XSE_MBM_GROUP_HITS		17

#define MBF_ELMK2XSE_COM_FRAME			99
#define MBF_ELMK2XSE_COM_GROUP_GEN		1

struct mbf_elmk2xse_beam_struct
	{
	double	    tt;
	double	    delay;
	double	    lateral;
...
struct mbf_elmk2xse_struct
	...
	double	svp_depth[MBF_ELMK2XSE_MAXSVP];		/* m */
	double	svp_velocity[MBF_ELMK2XSE_MAXSVP];	/* m/s */
	double	svp_conductivity[MBF_ELMK2XSE_MAXSVP];	/* mmho/cm */
	double	svp_salinity[MBF_ELMK2XSE_MAXSVP];	/* o/oo */
	double	svp_temperature[MBF_ELMK2XSE_MAXSVP];	/* degree celcius */
	double	svp_pressure[MBF_ELMK2XSE_MAXSVP];	/* bar */
	double	svp_ssv;				/* m/s */
	...
	char	nav_description[MBF_ELMK2XSE_DESCRIPTION_LENGTH];
	...
	struct mbf_elmk2xse_beam_struct beams[MBF_ELMK2XSE_MAXBEAMS];
