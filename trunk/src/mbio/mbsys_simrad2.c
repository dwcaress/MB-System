 ...
 *	$Id: mbsys_simrad2.c,v 4.0 1998-12-17 22:59:14 caress Exp $
 *
 *    Copyright (c) 1998 by 
...
/*--------------------------------------------------------------------*/
int mbsys_simrad2_alloc(verbose,mbio_ptr,store_ptr,error)
int	verbose;
char	*mbio_ptr;
char	**store_ptr;
int	*error;
{
 static char res_id[]="$Id: mbsys_simrad2.c,v 4.0 1998-12-17 22:59:14 caress Exp $";
...
/*--------------------------------------------------------------------*/
int mbsys_simrad2_survey_alloc(verbose,mbio_ptr,store_ptr,error)
int	verbose;
char	*mbio_ptr;
char	*store_ptr;
int	*error;
...
/*--------------------------------------------------------------------*/
int mbsys_simrad2_attitude_alloc(verbose,mbio_ptr,store_ptr,error)
int	verbose;
char	*mbio_ptr;
char	*store_ptr;
int	*error;
...
/*--------------------------------------------------------------------*/
int mbsys_simrad2_heading_alloc(verbose,mbio_ptr,store_ptr,error)
int	verbose;
char	*mbio_ptr;
char	*store_ptr;
int	*error;
...
/*--------------------------------------------------------------------*/
int mbsys_simrad2_deall(verbose,mbio_ptr,store_ptr,error)
int	verbose;
char	*mbio_ptr;
char	**store_ptr;
int	*error;
...
/*--------------------------------------------------------------------*/
int mbsys_simrad2_extract(verbose,mbio_ptr,store_ptr,kind,
...
/*--------------------------------------------------------------------*/
int mbsys_simrad2_insert(verbose,mbio_ptr,store_ptr,
		time_i,time_d,navlon,navlat,speed,heading,
		nbath,namp,nss,
		beamflag,bath,amp,
...
/*--------------------------------------------------------------------*/
int mbsys_simrad2_ttimes(verbose,mbio_ptr,store_ptr,kind,nbeams,
...
/*--------------------------------------------------------------------*/
int mbsys_simrad2_altitude(verbose,mbio_ptr,store_ptr,
...
/*--------------------------------------------------------------------*/
int mbsys_simrad2_copy(verbose,mbio_ptr,store_ptr,copy_ptr,error)
int	verbose;
char	*mbio_ptr;
char	*store_ptr;
char	*copy_ptr;
