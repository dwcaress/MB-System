/*--------------------------------------------------------------------
 *    The MB-system:	mbf_sbsiolsi.h	3.00	1/20/93
 *	$Id: mbf_sbsiolsi.h,v 3.0 1993-05-14 22:53:31 sohara Exp $
 *
 *    Copyright (c) 1993 by 
 ...
 * to store multibeam data read from the  MBF_SBSIOLSI format (MBIO id 3).  
 *
 * Author:	D. W. Caress
