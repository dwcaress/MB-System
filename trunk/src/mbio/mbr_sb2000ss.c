 ...
 *	$Id: mbr_sb2000ss.c,v 5.0 2000-12-01 22:48:41 caress Exp $
 *
...
int mbr_info_sb2000ss(int verbose, 
			...
			int *error)
{
	static char res_id[]="$Id: mbr_sb2000ss.c,v 5.0 2000-12-01 22:48:41 caress Exp $";
	...
	*altitude = &mbsys_sb2000_altitude; 
