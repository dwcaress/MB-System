 ...
 *	$Id: mbr_mbldeoih.c,v 5.3 2001-03-22 20:50:02 caress Exp $
 *
...
int mbr_register_mbldeoih(int verbose, char *mbio_ptr, 
		int *error);
...
/*--------------------------------------------------------------------*/
int mbr_register_mbldeoih(int verbose, char *mbio_ptr, int *error)
{
	static char res_id[]="$Id: mbr_mbldeoih.c,v 5.3 2001-03-22 20:50:02 caress Exp $";
