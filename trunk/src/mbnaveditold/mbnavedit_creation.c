...
CreatemainWindow(Widget parent)
{
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard, "Controls", 
                XmRXmString, 0, &argok);
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard, "Use Dead Reckoning", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
    ...
    XtSetArg(args[ac], XmNx, 287); ac++;
    XtSetArg(args[ac], XmNy, 183); ac++;
    XtSetArg(args[ac], XmNwidth, 481); ac++;
    XtSetArg(args[ac], XmNheight, 463); ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(radioBox_output, "Nav Only", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNfontList, 
            BX_CONVERT(radioBox_output, "-*-helvetica-bold-r-*-*-*-140-75-75-p-*-iso8859-1", 
            XmRFontList, 0, &argok)); if (argok) ac++;
        XtSetArg(args[ac], XmNwidth, 161); ac++;
        XtSetArg(args[ac], XmNheight, 28); ac++;
        toggleButton_output_nav = XmCreateToggleButton(radioBox_output,
            "toggleButton_output_nav",
            args, 
            ac);
    ...
    ac = 0;
    {
        ...
        XtSetArg(args[ac], XmNlistVisibleItemCount, 12); ac++;
    ...
    ac = 0;
    {
        ...
        XtSetArg(args[ac], XmNheight, 40); ac++;
        XtSetArg(args[ac], XmNfontList, 
            BX_CONVERT(bulletinBoard_controls, "-*-helvetica-bold-r-*-*-*-140-75-75-*-*-iso8859-1", 
            XmRFontList, 0, &argok)); if (argok) ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_controls, "DR Latitude Drift (deg/hr)", 
                XmRXmString, 0, &argok);
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_controls, "DR Longitude Drift (deg/hr)", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNtitleString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNminimum, -1000); ac++;
        XtSetArg(args[ac], XmNdecimalPoints, 5); ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_controls, "500", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING); ac++;
        XtSetArg(args[ac], XmNfontList, 
            BX_CONVERT(bulletinBoard_controls, "-*-helvetica-bold-r-*-*-*-120-75-75-p-*-iso8859-1", 
            XmRFontList, 0, &argok)); if (argok) ac++;
        XtSetArg(args[ac], XmNrecomputeSize, False); ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_controls, "Time Step (sec):  1", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_controls, " ", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNtitleString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNfontList, 
            BX_CONVERT(bulletinBoard_controls, "-*-helvetica-bold-r-*-*-*-120-75-75-p-*-iso8859-1", 
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_controls, "TIme Span Shown (sec):  1", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNalignment, XmALIGNMENT_END); ac++;
        XtSetArg(args[ac], XmNfontList, 
