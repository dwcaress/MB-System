...
MB3DViewCreate ( MB3DViewDataPtr class_in, Widget parent, String name, ArgList args_in, Cardinal ac_in)
{
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(class_in->mbview_radioBox_mouse, (char *)"Select Nav", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNshadowThickness, 2); ac++;
        XtSetArg(args[ac], XmNvisibleWhenOff, False); ac++;
    ...
    class_in->mbview_dialogShell_sitelist = XmCreateDialogShell(class_in->MB3DView,
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(class_in->mbview_dialogShell_sitelist, (char *)"MBview Site List", 
                XmRXmString, 0, &argok);
        ...
        XtSetArg(args[ac], XmNwidth, 506); ac++;
        XtSetArg(args[ac], XmNheight, 311); ac++;
        class_in->mbview_bulletinBoard_sitelist = XtCreateWidget((char *)"mbview_bulletinBoard_sitelist",
            xmBulletinBoardWidgetClass,
            class_in->mbview_dialogShell_sitelist,
            args, 
            ac);
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(class_in->mbview_bulletinBoard_sitelist, (char *)"Current Sites:", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNx, 10); ac++;
        XtSetArg(args[ac], XmNy, 10); ac++;
        ...
        XtSetArg(args[ac], XmNheight, 30); ac++;
        XtSetArg(args[ac], XmNfontList, 
            BX_CONVERT(class_in->mbview_bulletinBoard_sitelist, (char *)"-*-helvetica-bold-r-*-*-*-140-75-75-*-*-iso8859-1", 
            XmRFontList, 0, &argok)); if (argok) ac++;
        class_in->mbview_label_sitelist = XmCreateLabel(class_in->mbview_bulletinBoard_sitelist,
            (char *)"mbview_label_sitelist",
            args, 
            ac);
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(class_in->mbview_bulletinBoard_sitelist, (char *)"Dismiss", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(class_in->mbview_bulletinBoard_sitelist, (char *)"Apply", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        ...
        class_in->mbview_pushButton_sitelist_apply = XmCreatePushButton(class_in->mbview_bulletinBoard_sitelist,
            (char *)"mbview_pushButton_sitelist_apply",
            args, 
            ac);
