...
MB3DRouteListDataPtr MB3DRouteListCreate(MB3DRouteListDataPtr class_in, Widget parent, String name, ArgList args_in,
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(class_in->MB3DRouteList, (char *)"Route List:", XmRXmString, 0, &argok);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(class_in->MB3DRouteList, (char *)"Delete Selected Routes", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNx, 10);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(class_in->MB3DRouteList, (char *)"Dismiss", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
