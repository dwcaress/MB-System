...
MB3DNavListDataPtr MB3DNavListCreate(MB3DNavListDataPtr class_in, Widget parent, String name, ArgList args_in, Cardinal ac_in) {
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(class_in->MB3DNavList, (char *)"Navigation List:", XmRXmString, 0, &argok);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(class_in->MB3DNavList, (char *)"Delete Selected Navigation", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
		XtSetArg(args[ac], XmNx, 10);
	...
	ac = 0;
	{
		...
		tmp0 = (XmString)BX_CONVERT(class_in->MB3DNavList, (char *)"Dismiss", XmRXmString, 0, &argok);
		XtSetArg(args[ac], XmNlabelString, tmp0);
		if (argok)
			ac++;
