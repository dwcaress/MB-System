...
//rx_orientation.roll, rx_orientation.pitch, rx_orientation.heading, rx_steer, reference_heading);
									 ...
									 */
//									alpha = RTD * (beampitchr + v2rawdetection->tx_angle) + tx_align.pitch;
//									beta = 90.0 - RTD * (v2rawdetection->rx_angle[j] - beamrollr) + rx_align.roll;
...
//rx_orientation.roll, rx_orientation.pitch, rx_orientation.heading, rx_steer, reference_heading);
									 ...
									 * calculate beam angles the old way
									 */
//									alpha = RTD * (beampitchr + v2detection->angle_y[j] + pitchr
//										       + volatilesettings->steering_vertical) + tx_align.pitch;
//									beta = 90.0 - RTD * (v2detection->angle_x[j] - rollr) + rx_align.roll;
//									mb_rollpitch_to_takeoff(
//												verbose,
//												alpha, beta,
//												&theta2, &phi2,
...
//										       + volatilesettings->steering_vertical) + tx_align.pitch;
//									beta = 90.0 - RTD * (v2detection->angle_x[i] - beamrollr) + rx_align.roll;
//									mb_rollpitch_to_takeoff(
//										verbose,
//										alpha, beta,
//										&theta2, &phi2,
...
//											       + volatilesettings->steering_vertical) + tx_align.pitch;
//										beta = 90.0 - RTD * (beamgeometry->angle_acrosstrack[i] - beamrollr) + rx_align.roll;
//										mb_rollpitch_to_takeoff(
//											verbose,
//											alpha, beta,
//											&theta2, &phi2,
