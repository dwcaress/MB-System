...
#define GSF_RECORD_NAVIGATION_ERROR			    (unsigned)8
 ...
 * factors structure.
 */
#define GSF_MAX_PING_ARRAY_SUBRECORDS 18
...
#define GSF_SWATH_BATHY_SUBRECORD_DEPTH_ERROR_ARRAY	       (unsigned)11
#define GSF_SWATH_BATHY_SUBRECORD_ACROSS_TRACK_ERROR_ARRAY     (unsigned)12
#define GSF_SWATH_BATHY_SUBRECORD_ALONG_TRACK_ERROR_ARRAY      (unsigned)13
...
#define GSF_SWATH_BATHY_SUBRECORD_SASS_SPECIFIC 	    (unsigned)108
...
#define GSF_SWATH_BATHY_SUBRECORD_TYPEIII_SEABEAM_SPECIFIC  (unsigned)112
...
#define GSF_MAX_PROCESSING_PARAMETERS 64
...
#define GSF_MAX_SENSOR_PARAMETERS 32
...
int gsfIsStarboardPing(gsfRecords *data);
