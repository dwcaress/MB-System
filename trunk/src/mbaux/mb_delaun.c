	...
	int	*error)
{
	...
	if (verbose >= 2)
		...
		fprintf(stderr,"dbg2       p1:               %lu\n",(size_t)p1);
		fprintf(stderr,"dbg2       p2:               %lu\n",(size_t)p2);
		fprintf(stderr,"dbg2       ntri:             %d\n",*ntri);
		fprintf(stderr,"dbg2       iv1:              %lu\n",(size_t)iv1);
		fprintf(stderr,"dbg2       iv2:              %lu\n",(size_t)iv2);
		fprintf(stderr,"dbg2       iv3:              %lu\n",(size_t)iv3);
		fprintf(stderr,"dbg2       ct1:              %lu\n",(size_t)ct1);
		fprintf(stderr,"dbg2       ct2:              %lu\n",(size_t)ct2);
		fprintf(stderr,"dbg2       ct3:              %lu\n",(size_t)ct3);
		fprintf(stderr,"dbg2       cs1:              %lu\n",(size_t)cs1);
		fprintf(stderr,"dbg2       cs2:              %lu\n",(size_t)cs2);
		fprintf(stderr,"dbg2       cs3:              %lu\n",(size_t)cs3);
		fprintf(stderr,"dbg2       v1:               %lu\n",(size_t)v1);
		fprintf(stderr,"dbg2       v2:               %lu\n",(size_t)v2);
		fprintf(stderr,"dbg2       v3:               %lu\n",(size_t)v3);
		fprintf(stderr,"dbg2       istack:           %lu\n",(size_t)istack);
		fprintf(stderr,"dbg2       kv1:              %lu\n",(size_t)kv1);
		fprintf(stderr,"dbg2       kv2:              %lu\n",(size_t)kv2);
