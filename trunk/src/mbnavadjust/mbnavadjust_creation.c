...
CreatemainWindow(Widget parent)
{
    ...
    bulletinBoard_mbnavadjust = XmCreateBulletinBoard(mainWindow,
        (char *)"bulletinBoard_mbnavadjust",
        args, 
        ac);
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_mbnavadjust, (char *)"Data Files:", 
                XmRXmString, 0, &argok);
        ...
        XtSetArg(args[ac], XmNfontList, 
            BX_CONVERT(bulletinBoard_mbnavadjust, (char *)"-*-helvetica-bold-r-*-*-*-120-75-75-*-*-iso8859-1", 
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_mbnavadjust, (char *)"No Data Imported", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING); ac++;
    ...
    XtSetArg(args[ac], XmNheight, 116); ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_about, (char *)"Interactive Navigation Adjustment of Swath Bathymetry", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNfontList, 
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_about, (char *)"MBnavadjust", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNfontList, 
            BX_CONVERT(bulletinBoard_about, (char *)"-*-times-bold-r-*-*-*-240-*-*-*-*-iso8859-1", 
    ...
    XtSetArg(args[ac], XmNresizePolicy, XmRESIZE_ANY); ac++;
    XtSetArg(args[ac], XmNx, 1106); ac++;
    XtSetArg(args[ac], XmNy, 492); ac++;
    XtSetArg(args[ac], XmNwidth, 542); ac++;
    XtSetArg(args[ac], XmNheight, 86); ac++;
    ...
    XtSetArg(args[ac], XmNautoUnmanage, False); ac++;
    XtSetArg(args[ac], XmNresizePolicy, XmRESIZE_GROW); ac++;
    XtSetArg(args[ac], XmNx, 1090); ac++;
    XtSetArg(args[ac], XmNy, 366); ac++;
    XtSetArg(args[ac], XmNwidth, 573); ac++;
    XtSetArg(args[ac], XmNheight, 337); ac++;
    ...
    XtSetArg(args[ac], XmNfontList, 
        BX_CONVERT(bulletinBoard_controls, (char *)"-*-helvetica-bold-r-*-*-*-120-75-75-*-*-iso8859-1", 
        XmRFontList, 0, &argok)); if (argok) ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_controls, (char *)"Max # Soundings in Section:", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING); ac++;
        XtSetArg(args[ac], XmNx, 10); ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_controls, (char *)"Decimation:", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING); ac++;
        XtSetArg(args[ac], XmNx, 10); ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_controls, (char *)"Apply", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_controls, (char *)"Tick Interval (m):", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING); ac++;
        XtSetArg(args[ac], XmNx, 10); ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_controls, (char *)"Color Interval (m):", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING); ac++;
        XtSetArg(args[ac], XmNx, 10); ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_controls, (char *)"Contour Interval (m):", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING); ac++;
        XtSetArg(args[ac], XmNx, 10); ac++;
    ...
    ac = 0;
    {
        ...
        tmp0 = (XmString) BX_CONVERT(bulletinBoard_controls, (char *)"Max Section Length (km):", 
                XmRXmString, 0, &argok);
        XtSetArg(args[ac], XmNlabelString, tmp0); if (argok) ac++;
        XtSetArg(args[ac], XmNalignment, XmALIGNMENT_BEGINNING); ac++;
        XtSetArg(args[ac], XmNx, 10); ac++;
    ...
    ac = 0;
    {
        ...
        XtSetArg(args[ac], XmNautoUnmanage, False); ac++;
        XtSetArg(args[ac], XmNresizePolicy, XmRESIZE_GROW); ac++;
        XtSetArg(args[ac], XmNx, 1235); ac++;
        XtSetArg(args[ac], XmNy, 312); ac++;
        XtSetArg(args[ac], XmNwidth, 284); ac++;
        XtSetArg(args[ac], XmNheight, 446); ac++;
