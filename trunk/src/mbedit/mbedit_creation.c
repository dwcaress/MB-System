...
Createwindow_mbedit(Widget parent)
{
    ...
    XtSetArg(args[ac], XmNx, 345); ac++;
    XtSetArg(args[ac], XmNy, 588); ac++;
    XtSetArg(args[ac], XmNwidth, 496); ac++;
    XtSetArg(args[ac], XmNheight, 112); ac++;
